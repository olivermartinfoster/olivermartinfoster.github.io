require(['html-react-parser', 'semver', 'bowser', 'react-dom', 'libraries/mediaelement-and-player', 'libraries/rangeslider', 'handlebars', 'libraries/SCORM_API_wrapper', 'underscore', 'react'], function (HTMLReactParser, semver, Bowser, ReactDOM$1, mediaelementAndPlayer, rangeslider, Handlebars$1, pipwerks, _$1, React) { 'use strict';
  ...
  var AudioView = __AMD("extensions/adapt-globalAudio/js/AudioView", function (_Backbone$View) {
    ...
    _createClass(AudioView, [{
      ...
      value: function play() {
        ...
        var isFinished = this.audioTag.currentSeconds === this.audioTag.duration - 1;
      ...
      value: function onPlayPauseClick(event) {
        ...
        Adapt.globalAudio.resume(event.originalEvent).then(function () {
          console.log('ppclick attempting resumed');
          Adapt.trigger('media:stop', _this2);
          console.log('ppclick attempting play');

          _this2.togglePlayPause();

          console.log('ppclick attempting played');
          _this2.hasUserPaused = _this2.audioTag.isPaused;

          if (_this2.hasUserPaused && _this2.config._onPauseRewind) {
            _this2.rewind();
          }
        });
      }
  ...
  var GlobalAudio = function (_Backbone$Controller) {
    ...
    _createClass(GlobalAudio, [{
      ...
      key: "resume",
      value: function resume(event) {
        var _this2 = this;

        var AudioContext = window.AudioContext || window.webkitAudioContext;
        if (this.isResumed || !event.isTrusted || !AudioContext) return Promise.resolve();
        return this.audioContext.resume().then(function () {
          document.removeEventListener('click', _this2.resume);
          document.removeEventListener('touchend', _this2.resume);
          document.removeEventListener('touchstart', _this2.resume);
          window.removeEventListener('touchstart', _this2.resume);
