  ...
  Adapt = /*#__PURE__*/function (_Backbone$Model) {"use strict";_inherits(Adapt, _Backbone$Model);var _super = _createSuper(Adapt);function Adapt() {_classCallCheck(this, Adapt);return _super.apply(this, arguments);}_createClass(Adapt, [{ key: "initialize", value: function initialize()
...

      {
        ...
        $('html').toggleClass('disable-animation', disableAnimation === true);
          ...
          return Promise.resolve(this.wait.queue()).then(function ($await_21) {try {
...
function (Adapt, ModelEvent) {var
  ...
  AdaptModel = /*#__PURE__*/function (_Backbone$Model4) {"use strict";_inherits(AdaptModel, _Backbone$Model4);var _super8 = _createSuper(AdaptModel);function AdaptModel() {_classCallCheck(this, AdaptModel);return _super8.apply(this, arguments);}_createClass(AdaptModel, [{ key: "toJSON", value: function toJSON()
      ...
      {var _this30 = this;var set = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var setOnChildren = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var modifier = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
        ...
        // Clone any children
        this.hasManagedChildren && this.getChildren().each(function (child) {_newArrowCheck(this, _this30);
          if (!child.deepClone) {
...
function (Adapt, ContentObjectModel) {var
  ...
  MenuModel = /*#__PURE__*/function (_ContentObjectModel) {"use strict";_inherits(MenuModel, _ContentObjectModel);var _super10 = _createSuper(MenuModel);function MenuModel() {_classCallCheck(this, MenuModel);return _super10.apply(this, arguments);}_createClass(MenuModel, [{ key: "getTypeGroup",
      ...
      {var _this31 = this;
        var children = this.getAvailableChildModels();
        children.forEach(function (child) {_newArrowCheck(this, _this31);
          child.set('_isLocked', this.shouldLock(child));
...
function (Adapt, MenuModel) {var
  ...
  CourseModel = /*#__PURE__*/function (_MenuModel) {"use strict";_inherits(CourseModel, _MenuModel);var _super11 = _createSuper(CourseModel);function CourseModel() {_classCallCheck(this, CourseModel);return _super11.apply(this, arguments);}_createClass(CourseModel, [{ key: "getTypeGroup",
      ...
      {var _get2;
        Adapt.trigger('courseModel:dataLoading');for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {args[_key13] = arguments[_key13];}
  ...
  Data = /*#__PURE__*/function (_AdaptCollection) {"use strict";_inherits(Data, _AdaptCollection);var _super12 = _createSuper(Data);function Data() {_classCallCheck(this, Data);return _super12.apply(this, arguments);}_createClass(Data, [{ key: "model", value: function model(
...

      {
        ...
        this.on({
          ...
          return Promise.resolve(Adapt.build.whenReady()).then(function ($await_22) {try {
      ...
      newLanguage) {return new Promise(function ($return, $error) {var
          ...
          return Promise.resolve(this.loadManifestFiles(courseFolder)).then(function ($await_23) {try {
              return Promise.resolve(this.triggerDataLoaded()).then(function ($await_24) {try {
                  return Promise.resolve(this.triggerDataReady(newLanguage)).then(function ($await_25) {try {
      ...
      path) {var _this32 = this;
        return new Promise(function (resolve, reject) {var _this33 = this;_newArrowCheck(this, _this32);
          $.getJSON(path, function (data) {_newArrowCheck(this, _this33);
      ...
      languagePath) {return new Promise(function ($return, $error) {var _this34,
          ...
          course;_this34 = this;this.trigger('loading');this.reset();manifestPath = languagePath + 'language_data_manifest.js';var $Try_6_Post = function () {try {return Promise.resolve(Promise.all(manifest.map(function (filePath) {_newArrowCheck(this, _this34);return this.getJSON("".concat(languagePath).concat(filePath));}.bind(this)))).then(function ($await_26) {try {allFileData = $await_26;allModelData = allFileData.reduce(function (result, fileData) {_newArrowCheck(this, _this34);if (Array.isArray(fileData)) {result.push.apply(result, _toConsumableArray(fileData));} else if (fileData instanceof Object) {result.push(fileData);} else {Adapt.log.warnOnce("File data isn't an array or object: ".concat(fileData.__path__));}return result;}.bind(this), []);course = allModelData.find(function (modelData) {_newArrowCheck(this, _this34);return modelData._type === 'course';}.bind(this));
                  if (!course) {
                    return $error(new Error("Expected a model data with \"_type\": \"course\", none found."));
                  }
                  this.push(course);
                  // Add other models
                  allModelData.forEach(function (modelData) {_newArrowCheck(this, _this34);
                  ...
                  this.trigger('reset');
                  this.trigger('loaded');
                  return Promise.resolve(Adapt.wait.queue()).then(function ($await_27) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this);var $Try_6_Catch = function (err) {try {manifest = ['course.json', 'contentObjects.json', 'articles.json', 'blocks.json', 'components.json'];Adapt.log.warnOnce("Manifest path '".concat(manifestPath, " not found. Using traditional files: ").concat(manifest.join(', ')));return $Try_6_Post();} catch ($boundEx) {return $error($boundEx);}};try {return Promise.resolve(this.getJSON(manifestPath)).then(function ($await_28) {try {manifest = $await_28;return $Try_6_Post();} catch ($boundEx) {return $Try_6_Catch($boundEx);}}, $Try_6_Catch);} catch (err) {$Try_6_Catch(err)}}.bind(this));} }, { key: "triggerDataLoaded", value: function triggerDataLoaded() {return new Promise(function ($return, $error) {var _this35;_this35 = this;
          ...
          try {
            ...
            this.forEach(function (model) {_newArrowCheck(this, _this35);return model.setupModel && model.setupModel();}.bind(this));
            Adapt.trigger('app:dataLoaded');
          } catch (e) {
            Adapt.log.error('Error during app:dataLoading trigger', e);
          }
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_29) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "triggerDataReady", value: function triggerDataReady(


      newLanguage) {return new Promise(function ($return, $error) {var _this36;_this36 = this;
          if (newLanguage) {
            Adapt.trigger('app:languageChanged', newLanguage);
            _.defer(function () {_newArrowCheck(this, _this36);
              Adapt.startController.loadCourseData();
          ...
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_30) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "triggerInit", value: function triggerInit()
      ...
      {var _this37 = this;
        ...
        return new Promise(function (resolve) {_newArrowCheck(this, _this37);
          this.once('ready', resolve);
        }.bind(this));
      }
...
function (Adapt) {var
  ...
  RouterModel = /*#__PURE__*/function (_Backbone$Model5) {"use strict";_inherits(RouterModel, _Backbone$Model5);var _super13 = _createSuper(RouterModel);function RouterModel() {_classCallCheck(this, RouterModel);return _super13.apply(this, arguments);}_createClass(RouterModel, [{ key: "defaults", value: function defaults()
...
function (Adapt, RouterModel, CourseModel, ContentObjectModel, MenuModel) {var
  ...
  Router = /*#__PURE__*/function (_Backbone$Router) {"use strict";_inherits(Router, _Backbone$Router);var _super14 = _createSuper(Router);function Router() {_classCallCheck(this, Router);return _super14.apply(this, arguments);}_createClass(Router, [{ key: "routes", value: function routes()
      ...
      {var _this38 = this;
        ...
        filter(Boolean).join(' | ');
        this.listenToOnce(Adapt, 'contentObjectView:preRender', function () {_newArrowCheck(this, _this38);
      ...
      args) {var _this39 = this;
        args = args.filter(function (v) {_newArrowCheck(this, _this39);return v !== null;}.bind(this));
      ...
      {var _this40 = this;for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {args[_key14] = arguments[_key14];}
        args = args.filter(function (v) {_newArrowCheck(this, _this40);return v !== null;}.bind(this));
      ...
      pluginName, location, action) {return new Promise(function ($return, $error) {var
          ...
          filter(Boolean).join('');
          return Promise.resolve(this.updateLocation(pluginLocation, null, null, null)).then(function ($await_31) {try {
      ...
      id) {return new Promise(function ($return, $error) {var _this41,
          rootModel,
          model,
          ...
          ViewClass,
          isMenu;_this41 = this;rootModel = Adapt.router.rootModel;model = !id ? rootModel : Adapt.findById(id);if (!model) {// Bad id
          ...
          this.showLoading();return Promise.resolve(Adapt.remove()).then(function ($await_32) {try {isCourse = model instanceof CourseModel;type = isCourse ? 'menu' : model.get('_type');location = isCourse ? 'course' : "".concat(type, "-").concat(id);model.set('_isVisited', true);return Promise.resolve(this.updateLocation(location, type, id, model)).then(function ($await_33) {try {Adapt.once('contentObjectView:ready', function () {_newArrowCheck(this, _this41); // Allow navigation.
      ...
      currentLocation, type, id, currentModel) {return new Promise(function ($return, $error) {
          ...
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_34) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "setGlobalClasses", value: function setGlobalClasses()
      ...
      selector) {var $args = arguments;return new Promise(function ($return, $error) {var _this42, settings,
          ...
          shouldReplaceRoute;_this42 = this;settings = $args.length > 1 && $args[1] !== undefined ? $args[1] : {};currentModelId = selector.replace(/\./g, '');currentModel = Adapt.findById(currentModelId);if (!currentModel) return $return(); // Get current page to check whether this is the current page
          ...
          if (pageId === Adapt.location._currentId) {return Promise.resolve(Adapt.scrollTo(selector, settings)).then($return, $error);}shouldReplaceRoute = settings.replace || false;return Promise.resolve(new Promise(function (resolve) {var _this43 = this;_newArrowCheck(this, _this42);
            // If the element is on another page navigate and wait until pageView:ready is fired
            // Then scrollTo element
            Adapt.once('contentObjectView:ready', _.debounce(function () {return new Promise(function ($return, $error) {_newArrowCheck(this, _this43);
                this.model.set('_shouldNavigateFocus', true, { pluginName: 'adapt' });
                return Promise.resolve(Adapt.scrollTo(selector, settings)).then(function ($await_36) {try {
          ...
          }.bind(this))).then(function ($await_37) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "get", value: function get()
...
function (Adapt, AdaptCollection) {var
  ...
  AdaptSubsetCollection = /*#__PURE__*/function (_AdaptCollection2) {"use strict";_inherits(AdaptSubsetCollection, _AdaptCollection2);var _super15 = _createSuper(AdaptSubsetCollection);function AdaptSubsetCollection() {_classCallCheck(this, AdaptSubsetCollection);return _super15.apply(this, arguments);}_createClass(AdaptSubsetCollection, [{ key: "initialize", value: function initialize(
      ...
      {var _this44 = this;
        this.set(this.parent.filter(function (model) {_newArrowCheck(this, _this44);return model instanceof this.model;}.bind(this)));
...
function (Adapt, ContentObjectModel) {var
  ...
  PageModel = /*#__PURE__*/function (_ContentObjectModel2) {"use strict";_inherits(PageModel, _ContentObjectModel2);var _super16 = _createSuper(PageModel);function PageModel() {_classCallCheck(this, PageModel);return _super16.apply(this, arguments);}_createClass(PageModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  ArticleModel = /*#__PURE__*/function (_AdaptModel2) {"use strict";_inherits(ArticleModel, _AdaptModel2);var _super17 = _createSuper(ArticleModel);function ArticleModel() {_classCallCheck(this, ArticleModel);return _super17.apply(this, arguments);}_createClass(ArticleModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  BlockModel = /*#__PURE__*/function (_AdaptModel3) {"use strict";_inherits(BlockModel, _AdaptModel3);var _super18 = _createSuper(BlockModel);function BlockModel() {_classCallCheck(this, BlockModel);return _super18.apply(this, arguments);}_createClass(BlockModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  ComponentModel = /*#__PURE__*/function (_AdaptModel4) {"use strict";_inherits(ComponentModel, _AdaptModel4);var _super19 = _createSuper(ComponentModel);function ComponentModel() {_classCallCheck(this, ComponentModel);return _super19.apply(this, arguments);}_createClass(ComponentModel, [{ key: "getTypeGroup",
...
define('core/js/childEvent', [], function () {
  ...
  /**
                                               ...
                                               */var
  ChildEvent = /*#__PURE__*/function (_Backbone$Controller4) {"use strict";_inherits(ChildEvent, _Backbone$Controller4);var _super20 = _createSuper(ChildEvent);function ChildEvent() {_classCallCheck(this, ChildEvent);return _super20.apply(this, arguments);}_createClass(ChildEvent, [{ key: "initialize",
...
function (Adapt, ChildEvent) {var
  ...
  AdaptView = /*#__PURE__*/function (_Backbone$View) {"use strict";_inherits(AdaptView, _Backbone$View);var _super21 = _createSuper(AdaptView);function AdaptView() {_classCallCheck(this, AdaptView);return _super21.apply(this, arguments);}_createClass(AdaptView, [{ key: "attributes", value: function attributes()
      ...
      {var _this45 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this45);
      ...
      {var _this46 = this;
        ...
        this.$el.on('onscreen.adaptView', function (e, m) {_newArrowCheck(this, _this46);
      ...
      /**
         ...
         */ }, { key: "addChildren", value: function addChildren() {return new Promise(function ($return, $error) {var _this47,
          ...
          childView;_this47 = this;this.nthChild = this.nthChild || 0; // Check descendants first
          return Promise.resolve(this.addDescendants(false)).then(function ($await_38) {try {addedCount = $await_38;while (models = this.model.getAvailableChildModels(), event = this._getAddChildEvent(models[this.nthChild])) {if (event.isForced) {event.reset();}if (event.isStoppedImmediate || !event.model) {subsequentModels = models.slice(this.nthChild);subsequentModels.forEach(function (model) {_newArrowCheck(this, _this47);return model.setOnChildren('_isRendered', false);}.bind(this));break;} // Set model state
      ...
      /**
         ...
         */ }, { key: "addDescendants", value: function addDescendants() {return new Promise(function ($return, $error) {var
          ...
          view;addedDescendantCount = 0;childViews = this.getChildViews();if (!childViews) {return $return(addedDescendantCount);}i = 0, l = childViews.length;var $Loop_16_trampoline;function $Loop_16_step() {i++;return $Loop_16;}function $Loop_16() {if (i < l) {view = childViews[i];
              return Promise.resolve(new Promise(function ($return, $error) {if (view.addChildren) {return Promise.resolve(view.addChildren()).then($return, $error);}return $return(0);})).then(function ($await_40) {try {addedDescendantCount = $await_40;
      ...
      /**
                                                                   ...
                                                                   * and ready.
                                                                   */ }, { key: "whenReady", value: function whenReady() {return new Promise(function ($return, $error) {var _this48;_this48 = this;

          if (this.model.get('_isReady')) return $return();
          return Promise.resolve(new Promise(function (resolve) {var _this49 = this;_newArrowCheck(this, _this48);
            var _onReadyChange = function onReadyChange(model, value) {_newArrowCheck(this, _this49);
              if (!value) return;
      ...
      isParentFirst) {var _this50 = this;
        var descendants = [];
        var childViews = this.getChildViews();
        childViews && childViews.forEach(function (view) {_newArrowCheck(this, _this50);
      ...
      type) {var _this51 = this;
        ...
        if (descendantComponents.length === 0) {
          ...
          descendantComponents.forEach(function (model) {_newArrowCheck(this, _this51);return model.reset(type);}.bind(this));
        }
      ...
      {var _this52 = this;
        ...
        Adapt.wait.for(function (end) {var _this53 = this;_newArrowCheck(this, _this52);
      ...
      {var _this54 = this;
        ...
        return _.indexBy(this.getChildViews(), function (view) {_newArrowCheck(this, _this54);return view.model.get('_id');}.bind(this));
...
function (Adapt, AdaptView) {var
  ...
  ContentObjectView = /*#__PURE__*/function (_AdaptView) {"use strict";_inherits(ContentObjectView, _AdaptView);var _super22 = _createSuper(ContentObjectView);function ContentObjectView() {_classCallCheck(this, ContentObjectView);return _super22.apply(this, arguments);}_createClass(ContentObjectView, [{ key: "attributes", value: function attributes()
      ...
      {var _this55 = this;
        ...
        return this;
      } }, { key: "isReady", value: function isReady() {return new Promise(function ($return, $error) {var _this56 = this;
          ...
          var type = this.constructor.type;
          var performIsReady = function performIsReady() {return new Promise(function ($return, $error) {var _this57,
      ...
      id) {return new Promise(function ($return, $error) {var _this58,
          models,
          index,
          ...
          ids,
          _forceUntilId;_this58 = this;models = this.model.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this58);return model.get('_isAvailable');}.bind(this));index = models.findIndex(function (model) {_newArrowCheck(this, _this58);return model.get('_id') === id;}.bind(this));if (index === -1) {return $error(new Error("Cannot renderTo \"".concat(id, "\" as it isn't a descendant.")));} // Return early if the model is already rendered and ready
          model = models[index];if (model.get('_isRendered') && model.get('_isReady')) {return $return();} // Force all models up until the id to render
          models = models.slice(0, index + 1);ids = _.indexBy(models, function (model) {_newArrowCheck(this, _this58);return model.get('_id');}.bind(this));_forceUntilId = function forceUntilId(event) {_newArrowCheck(this, _this58);var addingId = event.model.get('_id');if (!ids[addingId]) return;
            event.force();
          ...
          return Promise.resolve(this.addChildren()).then(function ($await_43) {try {
              return Promise.resolve(this.whenReady()).then(function ($await_44) {try {
      ...
      {var _this59 = this;
        ...
        Adapt.wait.for(function (end) {var _this60 = this;_newArrowCheck(this, _this59);
          this.$el.off('onscreen.adaptView');
          this.findDescendantViews().reverse().forEach(function (view) {_newArrowCheck(this, _this60);
            view.remove();
          }.bind(this));
          this.setChildViews(null);
          _get(_getPrototypeOf(ContentObjectView.prototype), "remove", this).call(this);
          _.defer(function () {_newArrowCheck(this, _this60);
...
function (Adapt, ContentObjectView) {var
  ...
  PageView = /*#__PURE__*/function (_ContentObjectView) {"use strict";_inherits(PageView, _ContentObjectView);var _super23 = _createSuper(PageView);function PageView() {_classCallCheck(this, PageView);return _super23.apply(this, arguments);}_createClass(PageView, [{ key: "preRender", value: function preRender()

      {var _this61 = this;
        // checkIfResetOnRevisit on descendant models before render
        this.model.getAllDescendantModels().forEach(function (model) {_newArrowCheck(this, _this61);
...
function (Adapt, AdaptView) {var
  ...
  ArticleView = /*#__PURE__*/function (_AdaptView2) {"use strict";_inherits(ArticleView, _AdaptView2);var _super24 = _createSuper(ArticleView);function ArticleView() {_classCallCheck(this, ArticleView);return _super24.apply(this, arguments);}_createClass(ArticleView, [{ key: "className", value: function className()
...
function (Adapt, AdaptView) {var
  ...
  BlockView = /*#__PURE__*/function (_AdaptView3) {"use strict";_inherits(BlockView, _AdaptView3);var _super25 = _createSuper(BlockView);function BlockView() {_classCallCheck(this, BlockView);return _super25.apply(this, arguments);}_createClass(BlockView, [{ key: "className", value: function className()
...
function (Adapt, Data, AdaptSubsetCollection, CourseModel, ContentObjectModel, MenuModel, PageModel, ArticleModel, BlockModel, ComponentModel, PageView, ArticleView, BlockView) {var
  ...
  MPABC = /*#__PURE__*/function (_Backbone$Controller5) {"use strict";_inherits(MPABC, _Backbone$Controller5);var _super26 = _createSuper(MPABC);function MPABC() {_classCallCheck(this, MPABC);return _super26.apply(this, arguments);}_createClass(MPABC, [{ key: "initialize", value: function initialize()
      ...
      {var _this62 = this;
        ...
        Object.defineProperty(Adapt, 'contentObjects', {
          get: function get() {_newArrowCheck(this, _this62);
            Adapt.log.deprecated('Adapt.contentObjects, please use Adapt.data instead');
            return contentObjects;
          }.bind(this),
          set: function set(value) {_newArrowCheck(this, _this62);return contentObjects = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'articles', {
          ...
          set: function set(value) {_newArrowCheck(this, _this62);return articles = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'blocks', {
          ...
          set: function set(value) {_newArrowCheck(this, _this62);return blocks = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'components', {
          ...
          set: function set(value) {_newArrowCheck(this, _this62);return components = value;}.bind(this) });
...
function (Adapt) {var
  ...
  Scrolling = /*#__PURE__*/function (_Backbone$Controller6) {"use strict";_inherits(Scrolling, _Backbone$Controller6);var _super27 = _createSuper(Scrolling);function Scrolling() {_classCallCheck(this, Scrolling);return _super27.apply(this, arguments);}_createClass(Scrolling, [{ key: "initialize", value: function initialize()
      ...
      {var _this63 = this;
        ...
        var $window = $(window);
        this.$app.on('scroll', function () {_newArrowCheck(this, _this63);
          $window.scroll();
        }.bind(this));
      }
      ...
      selector) {var $args = arguments;return new Promise(function ($return, $error) {var _this64, settings,
          ...
          offsetTop;_this64 = this;settings = $args.length > 1 && $args[1] !== undefined ? $args[1] : {};currentModelId = selector.replace(/\./g, '');currentModel = Adapt.findById(currentModelId);if (!currentModel) return $return();if (!currentModel.get('_isRendered') || !currentModel.get('_isRendered')) {return Promise.resolve(Adapt.parentView.renderTo(currentModelId)).then(function ($await_45) {try {return $If_19.call(this);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} // Get the current location - this is set in the router
          function $If_19() {location = Adapt.location._contentType ? Adapt.location._contentType : Adapt.location._currentLocation; // Trigger initial scrollTo event
            ...
            return Promise.resolve(new Promise(function (resolve) {var _this65 = this;_newArrowCheck(this, _this64);
              _.delay(function () {_newArrowCheck(this, _this65);
                Adapt.a11y.focusNext(selector);
                Adapt.trigger("".concat(location, ":scrolledTo"), selector);
                resolve();
              }.bind(this), settings.duration + 300);
            }.bind(this))).then(function ($await_46) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}return $If_19.call(this);}.bind(this));} }]);return Scrolling;}(Backbone.Controller);
...
function (Adapt) {var
  ...
  NavigationView = /*#__PURE__*/function (_Backbone$View2) {"use strict";_inherits(NavigationView, _Backbone$View2);var _super28 = _createSuper(NavigationView);function NavigationView() {_classCallCheck(this, NavigationView);return _super28.apply(this, arguments);}_createClass(NavigationView, [{ key: "className", value: function className()
...
define('core/js/models/itemModel', [], function () {var
  ...
  ItemModel = /*#__PURE__*/function (_Backbone$Model6) {"use strict";_inherits(ItemModel, _Backbone$Model6);var _super29 = _createSuper(ItemModel);function ItemModel() {_classCallCheck(this, ItemModel);return _super29.apply(this, arguments);}_createClass(ItemModel, [{ key: "defaults", value: function defaults()
...
function (ComponentModel, ItemModel) {var
  ...
  ItemsComponentModel = /*#__PURE__*/function (_ComponentModel) {"use strict";_inherits(ItemsComponentModel, _ComponentModel);var _super30 = _createSuper(ItemsComponentModel);function ItemsComponentModel() {_classCallCheck(this, ItemsComponentModel);return _super30.apply(this, arguments);}_createClass(ItemsComponentModel, [{ key: "toJSON", value: function toJSON()
      ...
      {var _this67 = this;
        ...
        items.forEach(function (item, index) {_newArrowCheck(this, _this67);return item._index = index;}.bind(this));
      ...
      type, force) {var _this68 = this;
        this.getChildren().each(function (item) {_newArrowCheck(this, _this68);return item.reset();}.bind(this));
      ...
      {var _this69 = this;
        this.getChildren().each(function (item) {_newArrowCheck(this, _this69);return item.toggleActive(false);}.bind(this));
...
function (Adapt, AdaptView) {var
  ...
  ComponentView = /*#__PURE__*/function (_AdaptView4) {"use strict";_inherits(ComponentView, _AdaptView4);var _super31 = _createSuper(ComponentView);function ComponentView() {_classCallCheck(this, ComponentView);return _super31.apply(this, arguments);}_createClass(ComponentView, [{ key: "attributes", value: function attributes()
...
function (Adapt, ComponentModel, BUTTON_STATE) {var
  ...
  QuestionModel = /*#__PURE__*/function (_ComponentModel2) {"use strict";_inherits(QuestionModel, _ComponentModel2);var _super32 = _createSuper(QuestionModel);function QuestionModel() {_classCallCheck(this, QuestionModel);return _super32.apply(this, arguments);}_createClass(QuestionModel, [{ key: "defaults",
      ...
      {var _get3,_this70 = this;for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {args[_key15] = arguments[_key15];}
        (_get3 = _get(_getPrototypeOf(QuestionModel.prototype), "setupModel", this)).call.apply(_get3, [this].concat(args));
        this.on('change:_isInteractionComplete', function (model, value) {_newArrowCheck(this, _this70);
          if (!value) {
            return;
          }
      ...
      {var _this71 = this;var object = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.toJSON();
        var trackables = this.trackable();
        var types = this.trackableType();
        trackables.find(function (name, index) {_newArrowCheck(this, _this71);
        ...
        var values = trackables.map(function (n) {_newArrowCheck(this, _this71);return object[n];}.bind(this));
        var booleans = values.filter(function (v, i) {_newArrowCheck(this, _this71);return types[i] === Boolean;}.bind(this)).map(Boolean);
        var numbers = values.filter(function (v, i) {_newArrowCheck(this, _this71);return types[i] === Number;}.bind(this)).map(function (v) {_newArrowCheck(this, _this71);return Number(v) || 0;}.bind(this));
        var arrays = values.filter(function (v, i) {_newArrowCheck(this, _this71);return types[i] === Array;}.bind(this));
        return [
        numbers,
        booleans,
        arrays];
      ...
      {var _this72 = this;var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.getAttemptState();
        var trackables = this.trackable();
        var types = this.trackableType();
        trackables.find(function (name, index) {_newArrowCheck(this, _this72);
          if (name !== '_attemptStates') return;
          // Exclude _attemptStates as it's trackable but isn't needed here
          trackables.splice(index, 1);
          types.splice(index, 1);
        ...
        var object = {};
        trackables.forEach(function (n, i) {_newArrowCheck(this, _this72);
          if (n === '_id') return;
          switch (types[i]) {
            case Number:
      ...
      {var _this73 = this;
        ...
        return states.map(function (state) {_newArrowCheck(this, _this73);
...
function (Adapt, ComponentView, ButtonsView, QuestionModel, BUTTON_STATE) {
  ...
  QuestionView = /*#__PURE__*/function (_ComponentView) {"use strict";_inherits(QuestionView, _ComponentView);var _super33 = _createSuper(QuestionView);function QuestionView() {_classCallCheck(this, QuestionView);return _super33.apply(this, arguments);}_createClass(QuestionView, [{ key: "className", value: function className()
    ...
    }, { key: "checkIfResetOnRevisit", value: function checkIfResetOnRevisit() {var _this74 = this;
  ...
  ViewOnlyQuestionViewCompatibilityLayer = /*#__PURE__*/function (_QuestionView) {"use strict";_inherits(ViewOnlyQuestionViewCompatibilityLayer, _QuestionView);var _super34 = _createSuper(ViewOnlyQuestionViewCompatibilityLayer);function ViewOnlyQuestionViewCompatibilityLayer() {_classCallCheck(this, ViewOnlyQuestionViewCompatibilityLayer);return _super34.apply(this, arguments);}_createClass(ViewOnlyQuestionViewCompatibilityLayer, [{ key: "getInteractionObject",
...
'core/js/models/questionModel',
'core/js/models/itemsComponentModel'],
function (Adapt, QuestionModel, ItemsComponentModel) {var _this75 = this;var

  BlendedItemsComponentQuestionModel = /*#__PURE__*/function (_QuestionModel) {"use strict";_inherits(BlendedItemsComponentQuestionModel, _QuestionModel);var _super35 = _createSuper(BlendedItemsComponentQuestionModel);function BlendedItemsComponentQuestionModel() {_classCallCheck(this, BlendedItemsComponentQuestionModel);return _super35.apply(this, arguments);}_createClass(BlendedItemsComponentQuestionModel, [{ key: "init", value: function init()
  ...
  Object.getOwnPropertyNames(ItemsComponentModel.prototype).forEach(function (name) {_newArrowCheck(this, _this75);
  ...
  ItemsQuestionModel = /*#__PURE__*/function (_BlendedItemsComponen) {"use strict";_inherits(ItemsQuestionModel, _BlendedItemsComponen);var _super36 = _createSuper(ItemsQuestionModel);function ItemsQuestionModel() {_classCallCheck(this, ItemsQuestionModel);return _super36.apply(this, arguments);}_createClass(ItemsQuestionModel, [{ key: "init", value: function init()
      ...
      {var _this76 = this;
        ...
        itemModels.each(function (item) {_newArrowCheck(this, _this76);
      ...
      // This is important for returning or showing the users answer
      // This should preserve the state of the users answers
    }, { key: "storeUserAnswer", value: function storeUserAnswer() {var _this77 = this;
        var items = this.getChildren().slice(0);
        items.sort(function (a, b) {_newArrowCheck(this, _this77);return a.get('_index') - b.get('_index');}.bind(this));
        var userAnswer = items.map(function (itemModel) {_newArrowCheck(this, _this77);return itemModel.get('_isActive');}.bind(this));
      ...
      {var _this78 = this;
        ...
        this.getChildren().each(function (itemModel) {_newArrowCheck(this, _this78);
      ...
      {var _this79 = this;
        ...
        interactions.choices = this.getChildren().map(function (itemModel) {_newArrowCheck(this, _this79);
          return {
        ...
        var correctItems = this.getChildren().filter(function (itemModel) {_newArrowCheck(this, _this79);
          return itemModel.get('_shouldBeSelected');
        }.bind(this));

        interactions.correctResponsesPattern = [
        correctItems.map(function (itemModel) {_newArrowCheck(this, _this79);
      ...
      {var _this80 = this;
        var activeItems = this.getActiveItems();
        var activeIndexes = activeItems.map(function (itemModel) {_newArrowCheck(this, _this80);
          // indexes are 0-based, we need them to be 1-based for cmi.interactions
...
function (Adapt, QuestionModel, ComponentModel) {var
  ...
  Branching = /*#__PURE__*/function (_Backbone$Controller7) {"use strict";_inherits(Branching, _Backbone$Controller7);var _super37 = _createSuper(Branching);function Branching() {_classCallCheck(this, Branching);return _super37.apply(this, arguments);}_createClass(Branching, [{ key: "initialize", value: function initialize()

      {
        ...
        this.listenToOnce(Adapt, {
          ...
          return Promise.resolve(Adapt.data.whenReady()).then(function ($await_47) {try {
              this.setupBranching();
      ...
      {var _this81 = this;
        var containers = Adapt.course.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this81);
          var config = model.get('_branching');
          if (!config || !config._isContainer) return;
          return true;
        }.bind(this));
        containers.forEach(function (container) {var _this82 = this;_newArrowCheck(this, _this81);
          container.set('_canRequestChild', true);
          var children = container.getChildren();
          children.forEach(function (child) {_newArrowCheck(this, _this82);
            child.setOnChildren({
              _isAvailable: false });
      ...
      container, config) {var _this83 = this;
        ...
        trackingIds.forEach(function (trackingId) {_newArrowCheck(this, _this83);
      ...
      model, trackingId) {var _this84 = this;
        var children = model.getChildren();
        return children.find(function (child) {var _this85 = this;_newArrowCheck(this, _this84);
          return [child].concat(child.getAllDescendantModels(true)).find(function (child) {_newArrowCheck(this, _this85);
      ...
      container, config) {var _this86 = this;;
        var children = container.getChildren().models;
        var availableChildren = children.filter(function (model) {_newArrowCheck(this, _this86);return model.get('_isAvailable');}.bind(this));

        if (!availableChildren.length) {
          // Starting model
          return children.find(function (child) {_newArrowCheck(this, _this86);return child.get('_id') === config._start;}.bind(this));
        }
        ...
        return children.find(function (child) {_newArrowCheck(this, _this86);return child.get('_id') === nextId;}.bind(this));
      ...
      container, nextModel) {var _this87 = this;var restore = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        [nextModel].concat(nextModel.getAllDescendantModels(true)).forEach(function (model) {_newArrowCheck(this, _this87);
        ...
        {
          _isAvailable: true },
        function (model, clone) {_newArrowCheck(this, _this87);
        ...
        if (hasRestored) {
          ...
          cloned.getAllDescendantModels(true).reverse().forEach(function (model) {_newArrowCheck(this, _this87);
      ...
      nextModel) {var _this88 = this;
        var trackingIdModel = [nextModel].concat(nextModel.getAncestorModels()).find(function (model) {_newArrowCheck(this, _this88);return model.has('_trackingId');}.bind(this));
...
function (Adapt) {var
  ...
  ContentObjectTransition = /*#__PURE__*/function (_Backbone$Controller8) {"use strict";_inherits(ContentObjectTransition, _Backbone$Controller8);var _super38 = _createSuper(ContentObjectTransition);function ContentObjectTransition() {_classCallCheck(this, ContentObjectTransition);return _super38.apply(this, arguments);}_createClass(ContentObjectTransition, [{ key: "initialize", value: function initialize()
      ...
      contentObjectView) {var _this89 = this;
        ...
        if (this.lastState && this.lastState.scroll !== undefined) {
          ...
          var scrollTo = this.lastState.scroll - $('.nav').height();
        ...
        var models = [Adapt.course].concat(Adapt.course.getAllDescendantModels(true));
        var previousModel = this.views[index - 1].model;
        var currentModel = contentObjectView.model;
        var previousIndex = models.findIndex(function (model) {_newArrowCheck(this, _this89);return model === previousModel;}.bind(this));
        var currentIndex = models.findIndex(function (model) {_newArrowCheck(this, _this89);return model === currentModel;}.bind(this));

        var isScrollForward = currentIndex >= previousIndex;
      ...
      } }, { key: "onContentObjectViewPreReady", value: function onContentObjectViewPreReady(
      ...
      event) {var _this91 = this;
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this91);return view.$el[0] === event.srcElement;}.bind(this));
        if (index === -1) return;
        ...
        window.requestAnimationFrame(function () {_newArrowCheck(this, _this91);
        ...
        _.defer(function () {_newArrowCheck(this, _this91);
          $(window).resize();
          outgoingContentObject.destroy();
        }.bind(this));
      } }, { key: "onContentObjectViewPostRemove", value: function onContentObjectViewPostRemove(

      contentObjectView) {var _this92 = this;
        // Remove contentObject views from list
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this92);return view === contentObjectView;}.bind(this));
...
function (Adapt, QuestionBank) {
  ...
  var AssessmentModel = {
    ...
    getSaveState: function getSaveState() {var _this93 = this;
      var state = this.getState();
      var blocks;
      ...
      if (!banksActive && !randomisationActive) {
        ...
        blocks = state.questions.map(function (question) {_newArrowCheck(this, _this93);return Adapt.findById(question._id).getParent();}.bind(this));
      }
      blocks = blocks.filter(function (block) {_newArrowCheck(this, _this93);
        var trackingId = block.get('_trackingId');
        return Number.isInteger(trackingId) && trackingId >= 0;
      }.bind(this));
      var blockTrackingIds = blocks.map(function (block) {_newArrowCheck(this, _this93);return block.get('_trackingId');}.bind(this));
      var blockCompletion = blocks.map(function (block) {var _this94 = this;_newArrowCheck(this, _this93);
        var questions = block.findDescendantModels('question');
        return questions.map(function (question) {_newArrowCheck(this, _this94);return question.get('_isCorrect') || false;}.bind(this));
      }.bind(this));
    ...
    setRestoreState: function setRestoreState(dataPackage) {var _this95 = this;
      ...
      var blocks = blockData[0].map(function (trackingId) {_newArrowCheck(this, _this95);return Adapt.data.findWhere({ _trackingId: trackingId });}.bind(this));
      ...
      var questions = [];
      blocks.forEach(function (block, blockIndex) {var _this96 = this;_newArrowCheck(this, _this95);
        var blockQuestions = block.findDescendantModels('question');
        blockQuestions.forEach(function (question, questionIndex) {_newArrowCheck(this, _this96);
          questions.push({
  ...
  var Bookmarking = Backbone.Controller.extend({
    ...
    navigateToPrevious: function navigateToPrevious() {
      _.defer(function () {return new Promise(function ($return, $error) {var
          ...
          return Promise.resolve(Adapt.navigateToElement('.' + this.restoredLocationID, { trigger: true, replace: isSinglePage, duration: 400 })).then(function ($await_48) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));}.
      bind(this));
...
(function () {var _this105 = this;
  ...
  function binaryToBase64(binary) {
    ...
    for (var _i3 = 0, _l3 = bytesCount; _i3 < _l3; _i3++) {var _shiftUnsignedInteger =
      shiftUnsignedIntegerFromBinary(binary, BYTE_BIT_LENGTH);var _shiftUnsignedInteger2 = _slicedToArray(_shiftUnsignedInteger, 2);charCodes[_i3] = _shiftUnsignedInteger2[0];binary = _shiftUnsignedInteger2[1];
    }
  ...
  /**
     ...
     */var
  FixedIntegerType = /*#__PURE__*/function (_AbstractValueType) {"use strict";_inherits(FixedIntegerType, _AbstractValueType);var _super39 = _createSuper(FixedIntegerType);
    ...
    /**
                                                                                                                                                                              ...
                                                                                                                                                                              */
    function FixedIntegerType(options) {var _this97;_classCallCheck(this, FixedIntegerType);
      _this97 = _super39.call(this, options);
      _this97.esType = 'number';
      if (!_this97.valueBinaryLength) {
        return _possibleConstructorReturn(_this97);
      }
      _this97.minValue = options.minValue || 0;
      _this97.maxValue = options.maxValue || Math.pow(2, _this97.valueBinaryLength) - 1;return _this97;
    }
    ...
    /**
       ...
       * @returns {[string]}
       */_createClass(FixedIntegerType, [{ key: "valueToBinary", value: function valueToBinary(
      ...
      /**
         ...
         * @param {string} binary
         * @returns {[number, string]}
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var integer;var _shiftUnsignedInteger3 =
        shiftUnsignedIntegerFromBinary(binary, this.valueBinaryLength);var _shiftUnsignedInteger4 = _slicedToArray(_shiftUnsignedInteger3, 2);integer = _shiftUnsignedInteger4[0];binary = _shiftUnsignedInteger4[1];
        return [integer, binary];
  ...
  /**
                                                           ...
                                                           */var
  FixedBooleanType = /*#__PURE__*/function (_FixedIntegerType) {"use strict";_inherits(FixedBooleanType, _FixedIntegerType);var _super40 = _createSuper(FixedBooleanType);
    ...
    /**
                                                                                                                                                                            ...
                                                                                                                                                                            * @param {string} options.binaryType Binary string identifying the type
                                                                                                                                                                            */
    function FixedBooleanType(options) {var _this98;_classCallCheck(this, FixedBooleanType);
      options.valueBinaryLength = 1;
      _this98 = _super40.call(this, options);
      _this98.esType = 'boolean';return _this98;
    }
    ...
    /**
       ...
       */_createClass(FixedBooleanType, [{ key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var bool = binary[0] === '1';
  ...
  /**
                                                          ...
                                                          */var
  LengthAndValueBinary = /*#__PURE__*/function () {"use strict";
    ...
    /**
                                                                  ...
                                                                  */
    function LengthAndValueBinary(parent, name, bitSizes) {var _this99 = this;_classCallCheck(this, LengthAndValueBinary);
      this.parent = parent;
      this.name = name;
      this.bitSizes = bitSizes;
      this.maxValues = _.flatten(this.bitSizes).map(function (value) {_newArrowCheck(this, _this99);return Math.pow(2, value) - 1;}.bind(this));
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(LengthAndValueBinary, [{ key: "valueToBinary", value: function valueToBinary(
      integer) {var _this100 = this;var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        var parentName = this.parent.name;
        var sizeIndex = this.maxValues.findIndex(function (maxValue) {_newArrowCheck(this, _this100);return integer <= maxValue;}.bind(this));
        if (sizeIndex === -1) {
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var sizeBinary;var _shiftBinary =
        shiftBinary(binary, this.sizeBinaryLength);var _shiftBinary2 = _slicedToArray(_shiftBinary, 2);sizeBinary = _shiftBinary2[0];binary = _shiftBinary2[1];
        var sizeIndex = binaryToUnsignedInteger(sizeBinary);
        var valueLength = this.bitSizes[sizeIndex];
        var integer;var _shiftUnsignedInteger5 =
        shiftUnsignedIntegerFromBinary(binary, valueLength);var _shiftUnsignedInteger6 = _slicedToArray(_shiftUnsignedInteger5, 2);integer = _shiftUnsignedInteger6[0];binary = _shiftUnsignedInteger6[1];
        return [integer, binary];
  ...
  /**
                                              ...
                                              * binary string
                                              */var
  VariableIntegerType = /*#__PURE__*/function (_FixedIntegerType2) {"use strict";_inherits(VariableIntegerType, _FixedIntegerType2);var _super41 = _createSuper(VariableIntegerType);
    ...
    /**
                                                                                                                                                                                       ...
                                                                                                                                                                                       */
    function VariableIntegerType(options) {var _this101;_classCallCheck(this, VariableIntegerType);
      _this101 = _super41.call(this, options);
      _this101.isNegative = _this101.minValue < 0 && _this101.maxValue === 0;
      _this101.integer = new LengthAndValueBinary(_assertThisInitialized(_this101), 'integer', options.integerBitSizes);return _this101;
    }
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(VariableIntegerType, [{ key: "valueToBinary", value: function valueToBinary(
      integer) {var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var integer;var _this$integer$shiftVa =
        this.integer.shiftValueFromBinary(binary);var _this$integer$shiftVa2 = _slicedToArray(_this$integer$shiftVa, 2);integer = _this$integer$shiftVa2[0];binary = _this$integer$shiftVa2[1];
        if (this.isNegative) {
          integer = -integer;
        }
        return [integer, binary];
  ...
  /**
                                                             ...
                                                             */var
  VariableArrayType = /*#__PURE__*/function (_VariableIntegerType) {"use strict";_inherits(VariableArrayType, _VariableIntegerType);var _super42 = _createSuper(VariableArrayType);
    ...
    /**
                                                                                                                                                                                     ...
                                                                                                                                                                                     * @param {[number]} options.integerBitSizes Expressible storage bit sizes
                                                                                                                                                                                     */
    function VariableArrayType(options) {var _this102;_classCallCheck(this, VariableArrayType);
      _this102 = _super42.call(this, options);
      _this102.esType = 'array';return _this102;
    }
    ...
    /**
       ...
       */_createClass(VariableArrayType, [{ key: "valueToBinary", value: function valueToBinary(
      array) {var _this103 = this;var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        var arrayLength = array.length;
        ...
        if (arrayLength) {
          ...
          binary.push(array.map(function (value) {_newArrowCheck(this, _this103);return valueType.valueToBinary(value, logStats);}.bind(this)));
        }
        if (logStats) {
          this.log(binary);
        }
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var arrayLength;var _get$call = _get(_getPrototypeOf(VariableArrayType.prototype), "shiftValueFromBinary", this).call(this,
        binary);var _get$call2 = _slicedToArray(_get$call, 2);arrayLength = _get$call2[0];binary = _get$call2[1];
        var value = new Array(arrayLength);
        if (arrayLength) {
          var valueType;var _shiftValueTypeFromBi =
          shiftValueTypeFromBinary(binary);var _shiftValueTypeFromBi2 = _slicedToArray(_shiftValueTypeFromBi, 2);valueType = _shiftValueTypeFromBi2[0];binary = _shiftValueTypeFromBi2[1];
          for (var _i5 = 0, _l5 = arrayLength; _i5 < _l5; _i5++) {var _valueType$shiftValue =
            valueType.shiftValueFromBinary(binary);var _valueType$shiftValue2 = _slicedToArray(_valueType$shiftValue, 2);value[_i5] = _valueType$shiftValue2[0];binary = _valueType$shiftValue2[1];
          }
        }
        return [value, binary];
  ...
  /**
                                                              ...
                                                              */var
  VariableSignedIntegerType = /*#__PURE__*/function (_VariableIntegerType2) {"use strict";_inherits(VariableSignedIntegerType, _VariableIntegerType2);var _super43 = _createSuper(VariableSignedIntegerType);function VariableSignedIntegerType() {_classCallCheck(this, VariableSignedIntegerType);return _super43.apply(this, arguments);}_createClass(VariableSignedIntegerType, [{ key: "valueToBinary",
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var isNegative;var _shiftUnsignedInteger7 =
        shiftUnsignedIntegerFromBinary(binary, 1);var _shiftUnsignedInteger8 = _slicedToArray(_shiftUnsignedInteger7, 2);isNegative = _shiftUnsignedInteger8[0];binary = _shiftUnsignedInteger8[1];
        var integer;var _this$integer$shiftVa3 =
        this.integer.shiftValueFromBinary(binary);var _this$integer$shiftVa4 = _slicedToArray(_this$integer$shiftVa3, 2);integer = _this$integer$shiftVa4[0];binary = _this$integer$shiftVa4[1];
        if (isNegative) {
          integer = -integer;
        }
        return [integer, binary];
  ...
  /**
                                                                      ...
                                                                      */var
  VariableDecimalType = /*#__PURE__*/function (_VariableIntegerType3) {"use strict";_inherits(VariableDecimalType, _VariableIntegerType3);var _super44 = _createSuper(VariableDecimalType);
    ...
    /**
                                                                                                                                                                                             ...
                                                                                                                                                                                             */
    function VariableDecimalType(options) {var _this104;_classCallCheck(this, VariableDecimalType);
      _this104 = _super44.call(this, options);
      _this104.isFloat = true;
      _this104.decimal = new LengthAndValueBinary(_assertThisInitialized(_this104), 'decimal', options.decimalBitSizes);return _this104;
    }
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(VariableDecimalType, [{ key: "valueToBinary", value: function valueToBinary(
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBinary", value: function shiftValueFromBinary(
      binary) {
        var isNegative;var _shiftUnsignedInteger9 =
        shiftUnsignedIntegerFromBinary(binary, 1);var _shiftUnsignedInteger10 = _slicedToArray(_shiftUnsignedInteger9, 2);isNegative = _shiftUnsignedInteger10[0];binary = _shiftUnsignedInteger10[1];
        var higherInteger;var _this$integer$shiftVa5 =
        this.integer.shiftValueFromBinary(binary);var _this$integer$shiftVa6 = _slicedToArray(_this$integer$shiftVa5, 2);higherInteger = _this$integer$shiftVa6[0];binary = _this$integer$shiftVa6[1];
        var lowerInteger;var _this$decimal$shiftVa =
        this.decimal.shiftValueFromBinary(binary);var _this$decimal$shiftVa2 = _slicedToArray(_this$decimal$shiftVa, 2);lowerInteger = _this$decimal$shiftVa2[0];binary = _this$decimal$shiftVa2[1];
  ...
  ValueTypes.forEach(function (valueType) {_newArrowCheck(this, _this105);return ValueTypes.nameIndex[valueType.name] = valueType;}.bind(this));
  ...
  /**
     ...
     * @returns {AbstractValueType}
     */
  function findValueTypeFromValue(value) {var _this106 = this;
    ...
    var isValueInValueTypeRange = function isValueInValueTypeRange(valueType) {_newArrowCheck(this, _this106);return value >= valueType.minValue && value <= valueType.maxValue;}.bind(this);
  ...
  /**
     ...
     * @returns {AbstractValueType}
     */
  function findValueTypeFromValues(values) {var _this107 = this;
    if (!values.length) {
      return;
    }
    var minValue = 0;
    var maxValue = 0;
    var isFloat = false;
    var esTypes = values.map(function (value) {_newArrowCheck(this, _this107);
    ...
    var isRangeInValueTypeRange = function isRangeInValueTypeRange(valueType) {_newArrowCheck(this, _this107);return minValue >= valueType.minValue && maxValue <= valueType.maxValue;}.bind(this);
    var valueType = isFloat ?
  ...
  /**
     ...
     */
  function shiftValueTypeFromBinary(binary) {var _this108 = this;
    var valueType = ValueTypes.find(function (valueType) {_newArrowCheck(this, _this108);
  ...
  Converter = /*#__PURE__*/function () {"use strict";function Converter() {_classCallCheck(this, Converter);}_createClass(Converter, [{ key: "getInvalidTypeError",
      ...
      /**
         ...
         * @returns {string}
         */ }, { key: "valueToBinary", value: function valueToBinary(
      ...
      /**
         ...
         * @param {string} [typeName] To force an internal data type for testing
         * @returns {number|boolean|Array}
         */ }, { key: "valueFromBinary", value: function valueFromBinary(
      binary) {var typeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        binary = _.flatten(binary).join('');
        var hasInitialType = typeof typeName === 'string';
        var valueType;
        if (hasInitialType) {
          ...
          shiftValueTypeFromBinary(binary);var _shiftValueTypeFromBi4 = _slicedToArray(_shiftValueTypeFromBi3, 2);valueType = _shiftValueTypeFromBi4[0];binary = _shiftValueTypeFromBi4[1];
        }
        ...
        }var _valueType$shiftValue3 =
        valueType.shiftValueFromBinary(binary),_valueType$shiftValue4 = _slicedToArray(_valueType$shiftValue3, 1),value = _valueType$shiftValue4[0];
        return value;
      }
...
function (Adapt) {
  ...
  var serializer = {
    ...
    captureData: function captureData() {var _this109 = this;
      var data = [];

      var trackingIds = Adapt.blocks.pluck("_trackingId").filter(function (id) {_newArrowCheck(this, _this109);return Number.isInteger(id) && id >= 0;}.bind(this));
      var blocks = {};
      var countInBlock = {};
...
function (Adapt, serializer, questions, COMPLETION_STATE) {
  ...
  var AdaptStatefulSession = _.extend({
    ...
    getSessionState: function getSessionState() {
      ...
      Adapt.log.info("course._isComplete: ".concat(courseComplete, ", course._isAssessmentPassed: ").concat(assessmentPassed, ", BlockCompletion: ").concat(blockCompletion));
      var courseState = SCORMSuspendData.serialize([
      courseComplete,
      assessmentPassed].concat(_toConsumableArray(
...
function (Adapt, ComponentView) {var
  ...
  TrickleButtonView = /*#__PURE__*/function (_ComponentView2) {"use strict";_inherits(TrickleButtonView, _ComponentView2);var _super45 = _createSuper(TrickleButtonView);function TrickleButtonView() {_classCallCheck(this, TrickleButtonView);return _super45.apply(this, arguments);}_createClass(TrickleButtonView, [{ key: "events", value: function events()
      ...
      model, value) {return new Promise(function ($return, $error) {
          ...
          return Promise.resolve(Adapt.trickle.continue()).then(function ($await_50) {try {
...
function (Adapt, ComponentModel) {var
  ...
  TrickleButtonModel = /*#__PURE__*/function (_ComponentModel3) {"use strict";_inherits(TrickleButtonModel, _ComponentModel3);var _super46 = _createSuper(TrickleButtonModel);function TrickleButtonModel() {_classCallCheck(this, TrickleButtonModel);return _super46.apply(this, arguments);}_createClass(TrickleButtonModel, [{ key: "init", value: function init()
      ...
      {var _this110 = this;
        ...
        return !this.getSiblings().find(function (sibling) {_newArrowCheck(this, _this110);
      ...
      {var _this111 = this;
        ...
        var trickleParent = ancestors.find(function (model) {_newArrowCheck(this, _this111);return model.get('_trickleSiteParentId') === siteId;}.bind(this));
        var trickleSiblings = trickleParent.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this111);
          return model.get('_isAvailable') && model.get('_trickleSiteChildId') === siteId;
        }.bind(this));
        var index = trickleSiblings.findIndex(function (model) {_newArrowCheck(this, _this111);return model.get('_id') === parentId;}.bind(this));
        this.set({
...
function (Adapt, ContentObjectModel) {
  ...
  Trickle = /*#__PURE__*/function (_Backbone$Controller9) {"use strict";_inherits(Trickle, _Backbone$Controller9);var _super47 = _createSuper(Trickle);function Trickle() {_classCallCheck(this, Trickle);return _super47.apply(this, arguments);}_createClass(Trickle, [{ key: "initialize", value: function initialize()
      ...
      {var _this112 = this;
        ...
        var buttonSites = models.reduce(function (buttonSites, model) {_newArrowCheck(this, _this112);
        ...
        buttonSites.forEach(function (site) {var _this113 = this;_newArrowCheck(this, _this112);
          site.model.set('_trickleSiteParentId', site.id);
          site.models.forEach(function (model, index) {_newArrowCheck(this, _this113);
            model.set({
              '_isTrickled': true,
      ...
      {var _this114 = this;
        ...
        var lockingGroups = models.reduce(function (lockingGroups, model) {var _this115 = this;_newArrowCheck(this, _this114);
          ...
          if (group) {
            ...
            group.forEach(function (item) {_newArrowCheck(this, _this115);
        ...
        _.flatten(lockingGroups).forEach(function (model) {var _this116 = this;_newArrowCheck(this, _this114);
        ...
        lockingGroups.forEach(function (lockingModels) {var _this117 = this;_newArrowCheck(this, _this114);
          lockingModels.slice(1).forEach(function (model, previousIndex) {var _this118 = this;_newArrowCheck(this, _this117);
            ...
            model.getAllDescendantModels(true).forEach(function (model) {_newArrowCheck(this, _this118);
              locks[model.get('_id')].newState = isLocked;
            }.bind(this));
          }.bind(this));
        }.bind(this));
        ...
        var changedLocks = Object.values(locks).filter(function (lock) {_newArrowCheck(this, _this114);return lock.previousState !== lock.newState;}.bind(this));
        changedLocks.forEach(function (lock) {_newArrowCheck(this, _this114);
          lock.model.set('_isLocked', lock.newState);
        }.bind(this));
        var addedLockCount = changedLocks.reduce(function (count, lock) {_newArrowCheck(this, _this114);
          if (lock.newState) count++;
          return count;
        }.bind(this), 0);
        var removedLockCount = changedLocks.reduce(function (count, lock) {_newArrowCheck(this, _this114);
          if (!lock.newState) count++;
          return count;
        }.bind(this), 0);
      ...
      child) {var _this119 = this;
        var allSiblings = child.getParent().getAvailableChildModels();
        var selfAndSubsequentSiblings = allSiblings.slice(allSiblings.findIndex(function (sibling) {_newArrowCheck(this, _this119);return sibling === child;}.bind(this)));

        var allParents = child.getAncestorModels();
        var inPageParents = allParents.slice(0, allParents.findIndex(function (parent) {_newArrowCheck(this, _this119);return parent instanceof ContentObjectModel;}.bind(this)) + 1);

        var lockingModels = selfAndSubsequentSiblings;
        inPageParents.slice(1).forEach(function (grandParent, previousIndex) {var _this120 = this;_newArrowCheck(this, _this119);
          var parent = inPageParents[previousIndex];
          var allChildren = grandParent.getAvailableChildModels();
          lockingModels.push.apply(lockingModels, _toConsumableArray(allChildren.slice(allChildren.findIndex(function (child) {_newArrowCheck(this, _this120);return child === parent;}.bind(this)) + 1)));
        }.bind(this));
      ...
      event) {
        ...
        event.stop();
          ...
          this.setupLocking();
          return Promise.resolve(Adapt.parentView.addChildren()).then(function ($await_51) {try {
              return Promise.resolve(Adapt.parentView.whenReady()).then(function ($await_52) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "scroll", value: function scroll(


      fromModel) {return new Promise(function ($return, $error) {var _this121,
          trickle,
          scrollTo,
...
function (Adapt, MenuModel) {var
  ...
  InfiniteScroll = /*#__PURE__*/function (_Backbone$Controller10) {"use strict";_inherits(InfiniteScroll, _Backbone$Controller10);var _super48 = _createSuper(InfiniteScroll);function InfiniteScroll() {_classCallCheck(this, InfiniteScroll);return _super48.apply(this, arguments);}_createClass(InfiniteScroll, [{ key: "initialize", value: function initialize()
      ...
      event) {var _this122 = this;
        // Never infinite scroll menus
        if (this.isMenu()) {
          return;
        }

        var expectedNextModel = Adapt.parentView.model.getAllDescendantModels(true).find(function (model) {_newArrowCheck(this, _this122);
        ...
        if (hasNoChildren || !event.model.hasManagedChildren) {
          ...
          this.listenToOnce(event, 'closed', function () {_newArrowCheck(this, _this122);
