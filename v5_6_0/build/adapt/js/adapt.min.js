...
function (Wait) {var
  ...
  Adapt = /*#__PURE__*/function (_Backbone$Model) {"use strict";_inherits(Adapt, _Backbone$Model);var _super = _createSuper(Adapt);function Adapt() {_classCallCheck(this, Adapt);return _super.apply(this, arguments);}_createClass(Adapt, [{ key: "initialize", value: function initialize()
      ...
      /**
         ...
         */ }, { key: "navigateToElement", value: function navigateToElement() {return new Promise(function ($return, $error) {return $return();});}
      ...
      /**
                                                                                                                                                      ...
                                                                                                                                                      * @param {Object} [settings={}] The settings for the `$.scrollTo` function (See https://github.com/flesler/jquery.scrollTo#settings).
                                                                                                                                                      * @param {Object} [settings.replace=false] Set to `true` if you want to update the URL without creating an entry in the browser's history.
                                                                                                                                                      */ }, { key: "scrollTo", value: function scrollTo() {return new Promise(function ($return, $error) {return $return();});}
      ...
      nameModelOrData) {var _this8 = this;
        ...
        if (nameModelOrData instanceof Object) {
          ...
          if (names.length) {
            ...
            var name = names.find(function (name) {_newArrowCheck(this, _this8);return this.store[name] && this.store[name].model;}.bind(this));
            return name || names.pop(); // return last available if none found
          }
        }
...

      {
        ...
        $('html').toggleClass('disable-animation', disableAnimation === true);
      } }, { key: "remove", value: function remove() {return new Promise(function ($return, $error) {var


          currentView;currentView = this.parentView;
          if (currentView) {
          ...
          return Promise.resolve(this.wait.queue()).then(function ($await_23) {try {
              // Facilitate contentObject transitions
              if (currentView && this.get('_shouldDestroyContentObjects')) {
                currentView.destroy();
              }
              this.trigger('remove', currentView);
              _.defer(this.trigger.bind(this), 'postRemove', currentView);return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "componentStore", get: function get() {this.log && this.log.deprecated('Adapt.componentStore, please use Adapt.store instead');return this.store;} }]);return Adapt;}(Backbone.Model);
...
function (Adapt) {
  ...
  /**
                   ...
                   */var
  Log = /*#__PURE__*/function (_Backbone$Controller) {"use strict";_inherits(Log, _Backbone$Controller);var _super2 = _createSuper(Log);function Log() {_classCallCheck(this, Log);return _super2.apply(this, arguments);}_createClass(Log, [{ key: "initialize", value: function initialize()
      ...
      {var _Adapt$log;for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
        if (!this._canWarn) {
          return;
        }
      ...
      {var _Adapt$log2;for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}
        if (!this._canWarn) {
          return;
        }
        args = ['A11Y'].concat(args);
...
function (Adapt) {var
  ...
  AdaptCollection = /*#__PURE__*/function (_Backbone$Collection) {"use strict";_inherits(AdaptCollection, _Backbone$Collection);var _super3 = _createSuper(AdaptCollection);function AdaptCollection() {_classCallCheck(this, AdaptCollection);return _super3.apply(this, arguments);}_createClass(AdaptCollection, [{ key: "initialize", value: function initialize(
...
function (Adapt, LOG_LEVEL) {var
  ...
  Logging = /*#__PURE__*/function (_Backbone$Controller2) {"use strict";_inherits(Logging, _Backbone$Controller2);var _super4 = _createSuper(Logging);function Logging() {_classCallCheck(this, Logging);return _super4.apply(this, arguments);}_createClass(Logging, [{ key: "initialize", value: function initialize()
...
function (Adapt) {var
  ...
  BuildModel = /*#__PURE__*/function (_Backbone$Model2) {"use strict";_inherits(BuildModel, _Backbone$Model2);var _super5 = _createSuper(BuildModel);function BuildModel() {_classCallCheck(this, BuildModel);return _super5.apply(this, arguments);}_createClass(BuildModel, [{ key: "defaults", value: function defaults()
      ...
      attrs, options) {var _this11 = this;
        ...
        this.fetch({
          success: function success() {_newArrowCheck(this, _this11);
            this.isLoaded = true;
            Adapt.trigger('buildModel:dataLoaded');
          }.bind(this),
          error: function error() {_newArrowCheck(this, _this11);
      ...
      {var _this12 = this;
        ...
        return new Promise(function (resolve) {_newArrowCheck(this, _this12);
...
function (Adapt) {var
  ...
  ConfigModel = /*#__PURE__*/function (_Backbone$Model3) {"use strict";_inherits(ConfigModel, _Backbone$Model3);var _super6 = _createSuper(ConfigModel);function ConfigModel() {_classCallCheck(this, ConfigModel);return _super6.apply(this, arguments);}_createClass(ConfigModel, [{ key: "defaults", value: function defaults()
      ...
      attrs, options) {var _this13 = this;
        ...
        // 'configModel:loadCourseData' event starts the core content collections and models being fetched
        this.fetch({
          success: function success() {var _this14 = this;_newArrowCheck(this, _this13);
            Adapt.trigger('offlineStorage:prepare');
            Adapt.wait.queue(function () {_newArrowCheck(this, _this14);
              Adapt.trigger('configModel:dataLoaded');
              if (!this.get('_canLoadData')) return;
              Adapt.trigger('configModel:loadCourseData');
            }.bind(this));
          }.bind(this),
          error: function error() {_newArrowCheck(this, _this13);return console.log('Unable to load course/config.json');}.bind(this) });
...
function (Adapt, ModelEvent) {var
  ...
  AdaptModel = /*#__PURE__*/function (_Backbone$Model4) {"use strict";_inherits(AdaptModel, _Backbone$Model4);var _super7 = _createSuper(AdaptModel);function AdaptModel() {_classCallCheck(this, AdaptModel);return _super7.apply(this, arguments);}_createClass(AdaptModel, [{ key: "toJSON", value: function toJSON()
      ...
      {var _this15 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this15);
          if (this.hasManagedChildren) {
      ...
      {var _this16 = this;
        ...
        function () {_newArrowCheck(this, _this16);

          // Flag that the function is awaiting trigger
          this.triggerTrackableState.isQueued = true;

        }.bind(this),
        _.debounce(function () {_newArrowCheck(this, _this16);
        ...
        this.listenTo(this, 'change', function (_ref) {var _this17 = this;_newArrowCheck(this, _this16);var changed = _ref.changed;
          ...
          var isTrackable = changedPropertyNames.find(function (item) {_newArrowCheck(this, _this17);
      ...
      model, value) {var _this18 = this;
        ...
        if (children.find(function (child) {_newArrowCheck(this, _this18);return child.get('_isReady') === false && child.get('_isRendered');}.bind(this))) {
          return false;
        }
      ...
      {var _this19 = this;var completionAttribute = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '_isComplete';
        var completed = false;
        var children = this.getAvailableChildModels();
        ...
        if (requireCompletionOf === -1) {// a value of -1 indicates that ALL mandatory children must be completed
          completed = children.every(function (child) {_newArrowCheck(this, _this19);
            return child.get(completionAttribute) || child.get('_isOptional');
          }.bind(this));
        } else {
          completed = children.filter(function (child) {_newArrowCheck(this, _this19);
            return child.get(completionAttribute) && !child.get('_isOptional');
      ...
      {var _this20 = this;
        ...
        return this._typeGroups = _.uniq(typeGroups.filter(Boolean).map(function (s) {_newArrowCheck(this, _this20);return s.toLowerCase();}.bind(this)));
      }
      ...
      descendants, options) {var _this21 = this;
        var allDescendantsModels = this.getAllDescendantModels();
        var returnedDescendants = allDescendantsModels.filter(function (model) {_newArrowCheck(this, _this21);
        ...
        if (options.where) {
          return returnedDescendants.filter(function (descendant) {_newArrowCheck(this, _this21);
      ...
      isParentFirst) {var _this22 = this;
        ...
        children.models.forEach(function (child) {_newArrowCheck(this, _this22);
      ...
      relativeString) {var _this23 = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        ...
        var modelIndex = pageDescendants.findIndex(function (pageDescendant) {_newArrowCheck(this, _this23);
        ...
        if (options.loop) {
          ...
          var totalOfType = pageDescendants.reduce(function (count, model) {_newArrowCheck(this, _this23);
      ...
      {var _this24 = this;
        ...
        if (!this.hasManagedChildren) {
          ...
          var children = Adapt.data.filter(function (model) {_newArrowCheck(this, _this24);return model.get('_parentId') === id;}.bind(this));
      ...
      passSiblingsAndIncludeSelf) {var _this25 = this;
        var id = this.get('_id');
        var parentId = this.get('_parentId');
        var siblings;
        if (!passSiblingsAndIncludeSelf) {
          ...
          siblings = Adapt.data.filter(function (model) {_newArrowCheck(this, _this25);
      ...
      {var _this26 = this;for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {args[_key11] = arguments[_key11];}
        ...
        var children = this.getChildren();
        children.models.forEach(function (child) {_newArrowCheck(this, _this26);return child.setOnChildren.apply(child, args);}.bind(this));
      ...
      {var _this27 = this;
        var children = this.getAvailableChildModels();
        children.forEach(function (child) {_newArrowCheck(this, _this27);
      ...
      child) {
        ...
        for (var i = lockedBy.length - 1; i >= 0; i--) {
          ...
          try {
            var _model = Adapt.findById(id);

            if (!_model.get('_isAvailable')) continue;
            if (!_model.get('_isComplete')) return true;
          } catch (e) {
      ...
      {var _this28 = this;var set = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var setOnChildren = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var modifier = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
        // Shallow clone the JSON and set overrides
        var json = Object.assign({}, this.toJSON(), set);
        // Fetch the class
        var ModelClass = this.constructor;
        var hasId = Boolean(json._id);
        if (hasId) {
          // Create a unique id if needed
          var cid = _.uniqueId(ModelClass.prototype.cidPrefix || 'c');
          json._id = "".concat(cid, "_").concat(json._id);
        }
        // Clone the model
        var clonedModel = new ModelClass(json);
        // Add cloned model to Adapt.data for Adapt.findById resolution
        hasId && Adapt.data.add(clonedModel);
        // Clone any children
        this.hasManagedChildren && this.getChildren().each(function (child) {_newArrowCheck(this, _this28);
          if (!child.deepClone) {
            throw new Error('Cannot deepClone child.');
          }
          var set = setOnChildren;
          if (hasId) {
        ...
        if (hasId) {
          ...
          var parentModel = clonedModel.getParent();
...
function (Adapt, AdaptModel) {var
  ...
  ContentObjectModel = /*#__PURE__*/function (_AdaptModel) {"use strict";_inherits(ContentObjectModel, _AdaptModel);var _super8 = _createSuper(ContentObjectModel);function ContentObjectModel() {_classCallCheck(this, ContentObjectModel);return _super8.apply(this, arguments);}_createClass(ContentObjectModel, [{ key: "getTypeGroup",
...
function (Adapt, ContentObjectModel) {var
  ...
  MenuModel = /*#__PURE__*/function (_ContentObjectModel) {"use strict";_inherits(MenuModel, _ContentObjectModel);var _super9 = _createSuper(MenuModel);function MenuModel() {_classCallCheck(this, MenuModel);return _super9.apply(this, arguments);}_createClass(MenuModel, [{ key: "getTypeGroup",
...
function (Adapt, MenuModel) {var
  ...
  CourseModel = /*#__PURE__*/function (_MenuModel) {"use strict";_inherits(CourseModel, _MenuModel);var _super10 = _createSuper(CourseModel);function CourseModel() {_classCallCheck(this, CourseModel);return _super10.apply(this, arguments);}_createClass(CourseModel, [{ key: "getTypeGroup",
      ...
      {var _get2;
        Adapt.trigger('courseModel:dataLoading');for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {args[_key12] = arguments[_key12];}
        (_get2 = _get(_getPrototypeOf(CourseModel.prototype), "initialize", this)).call.apply(_get2, [this].concat(args));
        this.loadedData();
      } }, { key: "loadedData", value: function loadedData()
...
function (Adapt, AdaptCollection, BuildModel, ConfigModel, CourseModel) {var
  ...
  Data = /*#__PURE__*/function (_AdaptCollection) {"use strict";_inherits(Data, _AdaptCollection);var _super11 = _createSuper(Data);function Data() {_classCallCheck(this, Data);return _super11.apply(this, arguments);}_createClass(Data, [{ key: "model", value: function model(
      ...
      } }, { key: "init", value: function init() {return new Promise(function ($return, $error) {


          this.reset();
          this._byAdaptID = {};
          Adapt.build = new BuildModel(null, { url: 'adapt/js/build.min.js', reset: true });
          return Promise.resolve(Adapt.build.whenReady()).then(function ($await_24) {try {
              $('html').attr('data-adapt-framework-version', Adapt.build.get('package').version);
              this.loadConfigData();return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "onAdded", value: function onAdded(
      ...
      } }, { key: "loadCourseData", value: function loadCourseData(

      newLanguage) {return new Promise(function ($return, $error) {var


          language,
          courseFolder;language = Adapt.config.get('_activeLanguage');courseFolder = 'course/' + language + '/';

          $('html').attr('lang', language);

          return Promise.resolve(this.loadManifestFiles(courseFolder)).then(function ($await_25) {try {
              return Promise.resolve(this.triggerDataLoaded()).then(function ($await_26) {try {
                  return Promise.resolve(this.triggerDataReady(newLanguage)).then(function ($await_27) {try {
                      this.triggerInit();return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "getJSON", value: function getJSON(



      path) {var _this30 = this;
        return new Promise(function (resolve, reject) {var _this31 = this;_newArrowCheck(this, _this30);
          $.getJSON(path, function (data) {_newArrowCheck(this, _this31);
            // Add path to data incase it's necessary later
            data.__path__ = path;
            resolve(data);
          }.bind(this)).fail(reject);
        }.bind(this));
      } }, { key: "loadManifestFiles", value: function loadManifestFiles(

      languagePath) {return new Promise(function ($return, $error) {var _this32,
          ...
          course;_this32 = this;this.trigger('loading');this.reset();manifestPath = languagePath + 'language_data_manifest.js';var $Try_6_Post = function () {try {return Promise.resolve(Promise.all(manifest.map(function (filePath) {_newArrowCheck(this, _this32);return this.getJSON("".concat(languagePath).concat(filePath));}.bind(this)))).then(function ($await_28) {try {allFileData = $await_28;allModelData = allFileData.reduce(function (result, fileData) {_newArrowCheck(this, _this32);if (Array.isArray(fileData)) {result.push.apply(result, _toConsumableArray(fileData));} else if (fileData instanceof Object) {result.push(fileData);} else {Adapt.log.warnOnce("File data isn't an array or object: ".concat(fileData.__path__));}return result;}.bind(this), []);course = allModelData.find(function (modelData) {_newArrowCheck(this, _this32);return modelData._type === 'course';}.bind(this));
                  if (!course) {
                    return $error(new Error("Expected a model data with \"_type\": \"course\", none found."));
                  }
                  this.push(course);
                  // Add other models
                  allModelData.forEach(function (modelData) {_newArrowCheck(this, _this32);
                  ...
                  this.trigger('reset');
                  this.trigger('loaded');
                  return Promise.resolve(Adapt.wait.queue()).then(function ($await_29) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this);var $Try_6_Catch = function (err) {try {manifest = ['course.json', 'contentObjects.json', 'articles.json', 'blocks.json', 'components.json'];Adapt.log.warnOnce("Manifest path '".concat(manifestPath, " not found. Using traditional files: ").concat(manifest.join(', ')));return $Try_6_Post();} catch ($boundEx) {return $error($boundEx);}};try {return Promise.resolve(this.getJSON(manifestPath)).then(function ($await_30) {try {manifest = $await_30;return $Try_6_Post();} catch ($boundEx) {return $Try_6_Catch($boundEx);}}, $Try_6_Catch);} catch (err) {$Try_6_Catch(err)}}.bind(this));} }, { key: "triggerDataLoaded", value: function triggerDataLoaded() {return new Promise(function ($return, $error) {var _this33;_this33 = this;
          ...
          try {
            ...
            this.forEach(function (model) {_newArrowCheck(this, _this33);return model.setupModel && model.setupModel();}.bind(this));
            Adapt.trigger('app:dataLoaded');
          } catch (e) {
            Adapt.log.error('Error during app:dataLoading trigger', e);
          }
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_31) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "triggerDataReady", value: function triggerDataReady(


      newLanguage) {return new Promise(function ($return, $error) {var _this34;_this34 = this;
          if (newLanguage) {
            Adapt.trigger('app:languageChanged', newLanguage);
            _.defer(function () {_newArrowCheck(this, _this34);
              Adapt.startController.loadCourseData();
              var hash = Adapt.startController.isEnabled() ?
              '#/' :
          ...
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_32) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "triggerInit", value: function triggerInit()
      ...
      {var _this35 = this;
        ...
        return new Promise(function (resolve) {_newArrowCheck(this, _this35);
          this.once('ready', resolve);
        }.bind(this));
      }
...
function (Adapt) {
  ...
  var NotifyView = Backbone.View.extend({
    ...
    onAlertButtonClicked: function onAlertButtonClicked(event) {
      event.preventDefault();
    ...
    onPromptButtonClicked: function onPromptButtonClicked(event) {
      event.preventDefault();
      // tab index preservation, notify must close before subsequent callback is triggered
      this.closeNotify();
    ...
    onShadowClicked: function onShadowClicked(event) {
      event.preventDefault();
      if (this.model.get('_closeOnShadowClick') === false) return;
      this.cancelNotify();
    },

    cancelNotify: function cancelNotify() {
    ...
    resetNotifySize: function resetNotifySize() {
    ...
    addSubView: function addSubView() {
    ...
    closeNotify: function closeNotify(event) {
    ...
    onCloseReady: function onCloseReady() {
      if (this.disableAnimation) {
        this.$('.notify__popup').css('visibility', 'hidden');
        this.$el.css('visibility', 'hidden');
        this.remove();
    ...
    removeSubView: function removeSubView() {
      if (!this.subView) return;
...
function (Adapt, NotifyPushCollection, NotifyView, NotifyModel) {
  ...
  var Notify = Backbone.Controller.extend({
    ...
    _deprecated: function _deprecated(type, notifyObject) {
    ...
    create: function create(notifyObject, defaults) {
    ...
    /**
        ...
        */
    popup: function popup(notifyObject) {
    ...
    /**
        ...
        * @param {Backbone.View} [notifyObject._view] Subview to display in the popup instead of the standard view
        */
    alert: function alert(notifyObject) {
    ...
    /**
        ...
        * @param {Backbone.View} [notifyObject._view] Subview to display in the popup instead of the standard view
        */
    prompt: function prompt(notifyObject) {
    ...
    /**
        ...
        * @param {string} [notifyObject._classes] A class name or (space separated) list of class names you'd like to be applied to the popup's `<div>`
        */
    push: function push(notifyObject) {
...
function (Adapt) {var
  ...
  RouterModel = /*#__PURE__*/function (_Backbone$Model5) {"use strict";_inherits(RouterModel, _Backbone$Model5);var _super12 = _createSuper(RouterModel);function RouterModel() {_classCallCheck(this, RouterModel);return _super12.apply(this, arguments);}_createClass(RouterModel, [{ key: "defaults", value: function defaults()
...
function (Adapt, RouterModel, CourseModel, ContentObjectModel, MenuModel) {var
  ...
  Router = /*#__PURE__*/function (_Backbone$Router) {"use strict";_inherits(Router, _Backbone$Router);var _super13 = _createSuper(Router);function Router() {_classCallCheck(this, Router);return _super13.apply(this, arguments);}_createClass(Router, [{ key: "routes", value: function routes()
      ...
      {var _this36 = this;
        ...
        filter(Boolean).join(' | ');
        this.listenToOnce(Adapt, 'contentObjectView:preRender', function () {_newArrowCheck(this, _this36);
      ...
      args) {var _this37 = this;
        args = args.filter(function (v) {_newArrowCheck(this, _this37);return v !== null;}.bind(this));
      ...
      {var _this38 = this;for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {args[_key13] = arguments[_key13];}
        args = args.filter(function (v) {_newArrowCheck(this, _this38);return v !== null;}.bind(this));
      ...
      } }, { key: "handlePluginRouter", value: function handlePluginRouter(

      pluginName, location, action) {return new Promise(function ($return, $error) {var
          pluginLocation;pluginLocation = [
          pluginName,
          location && "-".concat(location),
          action && "-".concat(action)].
          filter(Boolean).join('');
          return Promise.resolve(this.updateLocation(pluginLocation, null, null, null)).then(function ($await_33) {try {

              Adapt.trigger('router:plugin:' + pluginName, pluginName, location, action);
              Adapt.trigger('router:plugin', pluginName, location, action);
              this.model.set('_canNavigate', true, { pluginName: 'adapt' });return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "handleId", value: function handleId(


      id) {return new Promise(function ($return, $error) {var _this39,
          rootModel,
          model,
          ...
          ViewClass,
          isMenu;_this39 = this;rootModel = Adapt.router.rootModel;model = !id ? rootModel : Adapt.findById(id);if (!model) {// Bad id
            this.model.set('_canNavigate', true, { pluginName: 'adapt' });return $return();}id = model.get('_id');isContentObject = model instanceof ContentObjectModel;if (!isContentObject) {// Allow navigation.
            this.model.set('_canNavigate', true, { pluginName: 'adapt' }); // Scroll to element
            Adapt.navigateToElement('.' + id, { replace: true, duration: 400 });return $return();}isRoot = model === rootModel;if (isRoot && Adapt.course.has('_start')) {startController = Adapt.course.get('_start');if (startController._isEnabled === true && startController._isMenuDisabled === true) {return $return();}}if (model.get('_isLocked') && Adapt.config.get('_forceRouteLocking')) {// Locked id
            Adapt.log.warn('Unable to navigate to locked id: ' + id);this.model.set('_canNavigate', true, { pluginName: 'adapt' });if (Adapt.location._previousId === undefined) {return $return(this.navigate('#/', { trigger: true, replace: true }));}return $return(this.navigateBack());} // Move to a content object
          this.showLoading();return Promise.resolve(Adapt.remove()).then(function ($await_34) {try {isCourse = model instanceof CourseModel;type = isCourse ? 'menu' : model.get('_type');location = isCourse ? 'course' : "".concat(type, "-").concat(id);model.set('_isVisited', true);return Promise.resolve(this.updateLocation(location, type, id, model)).then(function ($await_35) {try {Adapt.once('contentObjectView:ready', function () {_newArrowCheck(this, _this39); // Allow navigation.
                    this.model.set('_canNavigate', true, { pluginName: 'adapt' });this.handleNavigationFocus();}.bind(this));Adapt.trigger("router:".concat(type, " router:contentObject"), model);ViewClass = Adapt.getViewClass(model);isMenu = model instanceof MenuModel;if (!ViewClass && isMenu) {Adapt.log.deprecated("Using event based menu view instantiation for '".concat(Adapt.getViewName(model), "'"));return $return();}this.$wrapper.append(new ViewClass({ model: model }).$el);return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "updateLocation", value: function updateLocation(

      currentLocation, type, id, currentModel) {return new Promise(function ($return, $error) {
          ...
          return Promise.resolve(Adapt.wait.queue()).then(function ($await_36) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "setGlobalClasses", value: function setGlobalClasses()
      ...
      /**
         ...
         * @param {Object} [settings] The settings for the `$.scrollTo` function (See https://github.com/flesler/jquery.scrollTo#settings).
         * @param {Object} [settings.replace=false] Set to `true` if you want to update the URL without creating an entry in the browser's history.
         */ }, { key: "navigateToElement", value: function navigateToElement(
      selector) {var $args = arguments;return new Promise(function ($return, $error) {var _this40, settings,
          ...
          shouldReplaceRoute;_this40 = this;settings = $args.length > 1 && $args[1] !== undefined ? $args[1] : {};currentModelId = selector.replace(/\./g, '');currentModel = Adapt.findById(currentModelId);if (!currentModel) return $return(); // Get current page to check whether this is the current page
          currentPage = currentModel instanceof ContentObjectModel ? currentModel : currentModel.findAncestor('contentObjects');pageId = currentPage.get('_id'); // If current page - scrollTo element
          if (pageId === Adapt.location._currentId) {return Promise.resolve(Adapt.scrollTo(selector, settings)).then($return, $error);}shouldReplaceRoute = settings.replace || false;return Promise.resolve(new Promise(function (resolve) {var _this41 = this;_newArrowCheck(this, _this40);
            // If the element is on another page navigate and wait until pageView:ready is fired
            // Then scrollTo element
            Adapt.once('contentObjectView:ready', _.debounce(function () {return new Promise(function ($return, $error) {_newArrowCheck(this, _this41);
                this.model.set('_shouldNavigateFocus', true, { pluginName: 'adapt' });
                return Promise.resolve(Adapt.scrollTo(selector, settings)).then(function ($await_38) {try {
                    resolve();return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));}.bind(this),
            1));
          ...
          }.bind(this))).then(function ($await_39) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "get", value: function get()
...
'core/js/adapt',
'./adaptCollection'],
function (Adapt, AdaptCollection) {var

  AdaptSubsetCollection = /*#__PURE__*/function (_AdaptCollection2) {"use strict";_inherits(AdaptSubsetCollection, _AdaptCollection2);var _super14 = _createSuper(AdaptSubsetCollection);function AdaptSubsetCollection() {_classCallCheck(this, AdaptSubsetCollection);return _super14.apply(this, arguments);}_createClass(AdaptSubsetCollection, [{ key: "initialize", value: function initialize(
      ...
      {var _this42 = this;
        this.set(this.parent.filter(function (model) {_newArrowCheck(this, _this42);return model instanceof this.model;}.bind(this)));
...
function (Adapt, ContentObjectModel) {var
  ...
  PageModel = /*#__PURE__*/function (_ContentObjectModel2) {"use strict";_inherits(PageModel, _ContentObjectModel2);var _super15 = _createSuper(PageModel);function PageModel() {_classCallCheck(this, PageModel);return _super15.apply(this, arguments);}_createClass(PageModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  ArticleModel = /*#__PURE__*/function (_AdaptModel2) {"use strict";_inherits(ArticleModel, _AdaptModel2);var _super16 = _createSuper(ArticleModel);function ArticleModel() {_classCallCheck(this, ArticleModel);return _super16.apply(this, arguments);}_createClass(ArticleModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  BlockModel = /*#__PURE__*/function (_AdaptModel3) {"use strict";_inherits(BlockModel, _AdaptModel3);var _super17 = _createSuper(BlockModel);function BlockModel() {_classCallCheck(this, BlockModel);return _super17.apply(this, arguments);}_createClass(BlockModel, [{ key: "getTypeGroup",
...
function (Adapt, AdaptModel) {var
  ...
  ComponentModel = /*#__PURE__*/function (_AdaptModel4) {"use strict";_inherits(ComponentModel, _AdaptModel4);var _super18 = _createSuper(ComponentModel);function ComponentModel() {_classCallCheck(this, ComponentModel);return _super18.apply(this, arguments);}_createClass(ComponentModel, [{ key: "getTypeGroup",
      ...
      } }, { key: "_parent", get: function get() {Adapt.log.deprecated('componentModel._parent, use componentModel.getParent() instead, parent models are defined by the JSON');return 'blocks';} }, { key: "_siblings", get: function get() {Adapt.log.deprecated('componentModel._siblings, use componentModel.getSiblings() instead, sibling models are defined by the JSON');return 'components';} }, { key: "hasManagedChildren", get: function get()

      {
        return false;
      } }]);return ComponentModel;}(AdaptModel);
...
define('core/js/childEvent', [], function () {
  ...
  /**
                                               ...
                                               */var
  ChildEvent = /*#__PURE__*/function (_Backbone$Controller3) {"use strict";_inherits(ChildEvent, _Backbone$Controller3);var _super19 = _createSuper(ChildEvent);function ChildEvent() {_classCallCheck(this, ChildEvent);return _super19.apply(this, arguments);}_createClass(ChildEvent, [{ key: "initialize",
         ...
         */ }, { key: "close", value: function close()
      {
        this.trigger('closed');
                                                                      ...
                                                                      * @param {AdaptModel}
                                                                      */, set: function set(value) {if (this.type !== 'requestChild') {Adapt.log.warn("Cannot change model in ".concat(this.type, " event."));return;}if (this._model) {Adapt.log.warn("Cannot inject two models in one sitting. ".concat(model.get('_id'), " attempts to overwrite ").concat(this._model.get('_id')));return;}this._model = value;this.hasRequestChild = true;} }]);return ChildEvent;}(Backbone.Controller);
  return ChildEvent;
...
function (Adapt, ChildEvent) {var
  ...
  AdaptView = /*#__PURE__*/function (_Backbone$View) {"use strict";_inherits(AdaptView, _Backbone$View);var _super20 = _createSuper(AdaptView);function AdaptView() {_classCallCheck(this, AdaptView);return _super20.apply(this, arguments);}_createClass(AdaptView, [{ key: "attributes", value: function attributes()
      ...
      {var _this43 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this43);
      ...
      {var _this44 = this;
        ...
        this.$el.on('onscreen.adaptView', function (e, m) {_newArrowCheck(this, _this44);
      ...
      /**
         ...
         */ }, { key: "addChildren", value: function addChildren() {return new Promise(function ($return, $error) {var _this45,
          ...
          childView;_this45 = this;this.nthChild = this.nthChild || 0; // Check descendants first
          return Promise.resolve(this.addDescendants(false)).then(function ($await_40) {try {addedCount = $await_40;while (models = this.model.getAvailableChildModels(), event = this.getAddChildEvent(models[this.nthChild])) {if (event.isForced) {event.reset();}if (event.isStoppedImmediate || !event.model) {subsequentModels = models.slice(this.nthChild);subsequentModels.forEach(function (model) {_newArrowCheck(this, _this45);return model.setOnChildren('_isRendered', false);}.bind(this));break;} // Set model state
                _model2 = event.model;_model2.set({ '_isRendered': true, '_nthChild': ++this.nthChild }); // Create child view
                ChildView = this.constructor.childView || Adapt.getViewClass(_model2);if (!ChildView) {return $error(new Error("The component '".concat(_model2.attributes._id, "' ('").concat(_model2.attributes._component, "') has not been installed, and so is not available in your project.")));}childView = new ChildView({ model: _model2 });this.addChildView(childView);addedCount++;if (event.isStoppedNext) {
                  break;
                }
              }

              if (!addedCount) {
                return $return(addedCount);
              }

              // Children were added, unset _isReady
              this.model.set('_isReady', false);
              return $return(addedCount);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));}
      ...
      /**
         ...
         * @returns {number} Count of views added
         */ }, { key: "addDescendants", value: function addDescendants() {return new Promise(function ($return, $error) {var
          ...
          i, l,
          view;addedDescendantCount = 0;childViews = this.getChildViews();if (!childViews) {return $return(addedDescendantCount);}i = 0, l = childViews.length;var $Loop_16_trampoline;function $Loop_16_step() {i++;return $Loop_16;}function $Loop_16() {if (i < l) {view = childViews[i];
              return Promise.resolve(new Promise(function ($return, $error) {if (view.addChildren) {return Promise.resolve(view.addChildren()).then($return, $error);}return $return(0);})).then(function ($await_42) {try {addedDescendantCount = $await_42;
                  if (addedDescendantCount) {
                    return [1];
                  }return $Loop_16_step;} catch ($boundEx) {return $error($boundEx);}}, $error);} else return [1];}return ($Loop_16_trampoline = function (q) {while (q) {if (q.then) return void q.then($Loop_16_trampoline, $error);try {if (q.pop) {if (q.length) return q.pop() ? $Loop_16_exit.call(this) : q;else q = $Loop_16_step;} else q = q.call(this);} catch (_exception) {return $error(_exception);}}}.bind(this))($Loop_16);function $Loop_16_exit() {

            if (!addedDescendantCount) {
              this.model.checkReadyStatus();
              return $return(addedDescendantCount);
            }
            // Descendants were added, unset _isReady
            this.model.set('_isReady', false);
            return $return(addedDescendantCount);}}.bind(this));}


      /**
                                                                   * Resolves after outstanding asynchronous view additions are finished
                                                                   * and ready.
                                                                   */ }, { key: "whenReady", value: function whenReady() {return new Promise(function ($return, $error) {var _this46;_this46 = this;

          if (this.model.get('_isReady')) return $return();
          return Promise.resolve(new Promise(function (resolve) {var _this47 = this;_newArrowCheck(this, _this46);
            var _onReadyChange = function onReadyChange(model, value) {_newArrowCheck(this, _this47);
              if (!value) return;
            ...
            this.model.checkReadyStatus();
          }.bind(this))).then($return, $error);}.bind(this));}
      ...
      /**
                                                                ...
                                                                * @param {AdaptModel} model
                                                                * @returns {ChildEvent}
                                                                */ }, { key: "getAddChildEvent", value: function getAddChildEvent(
      model) {
        var isRequestChild = !Boolean(model);
      ...
      isParentFirst) {var _this48 = this;
        var descendants = [];
        var childViews = this.getChildViews();
        childViews && childViews.forEach(function (view) {_newArrowCheck(this, _this48);
      ...
      type) {var _this49 = this;
        ...
        if (descendantComponents.length === 0) {
          ...
          descendantComponents.forEach(function (model) {_newArrowCheck(this, _this49);return model.reset(type);}.bind(this));
        }
      ...
      {var _this50 = this;
        ...
        Adapt.wait.for(function (end) {var _this51 = this;_newArrowCheck(this, _this50);
          this.$el.off('onscreen.adaptView');
          _get(_getPrototypeOf(AdaptView.prototype), "remove", this).call(this);
          _.defer(function () {_newArrowCheck(this, _this51);
      ...
      {var _this52 = this;
        ...
        return _.indexBy(this.getChildViews(), function (view) {_newArrowCheck(this, _this52);return view.model.get('_id');}.bind(this));
...
function (Adapt, AdaptView) {var
  ...
  ContentObjectView = /*#__PURE__*/function (_AdaptView) {"use strict";_inherits(ContentObjectView, _AdaptView);var _super21 = _createSuper(ContentObjectView);function ContentObjectView() {_classCallCheck(this, ContentObjectView);return _super21.apply(this, arguments);}_createClass(ContentObjectView, [{ key: "attributes", value: function attributes()
      ...
      {var _this53 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this53);
          // don't call postRender after remove
          if (this._isRemoved) return;
        ...
        return this;
      } }, { key: "isReady", value: function isReady() {return new Promise(function ($return, $error) {var _this54 = this;


          if (!this.model.get('_isReady') || this._isTriggeredReady) return $return();
          this._isTriggeredReady = true;

          var type = this.constructor.type;
          var performIsReady = function performIsReady() {return new Promise(function ($return, $error) {var _this55,
              ...
              styleOptions;_this55 = this;_newArrowCheck(this, _this54);Adapt.trigger("".concat(type, "View:preReady contentObjectView:preReady view:preReady"), this);return Promise.resolve(Adapt.wait.queue()).then(function ($await_44) {try {$('.js-loading').hide();if (Adapt.get('_shouldContentObjectScrollTop') !== false) {$(window).scrollTop(0);}Adapt.trigger("".concat(type, "View:ready contentObjectView:ready view:ready"), this);$.inview.unlock("".concat(type, "View"));styleOptions = { opacity: 1 };
                  if (this.disableAnimation) {
                    this.$el.css(styleOptions);
                    $.inview();
                    _.defer(function () {_newArrowCheck(this, _this55);
                      Adapt.trigger("".concat(type, "View:postReady contentObjectView:postReady view:postReady"), this);
                    }.bind(this));
                  } else {
                    this.$el.velocity(styleOptions, {
                      duration: 'fast',
                      complete: function complete() {_newArrowCheck(this, _this55);
                        $.inview();
                        Adapt.trigger("".concat(type, "View:postReady contentObjectView:postReady view:postReady"), this);
                      }.bind(this) });

                  }
                  $(window).scroll();return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));}.bind(this);


          _.defer(performIsReady);return $return();}.bind(this));}


      /**
                                                                    * Force render up to specified id. Resolves when views are ready.
                                                                    * @param {string} id
                                                                    */ }, { key: "renderTo", value: function renderTo(
      id) {return new Promise(function ($return, $error) {var _this56,
          models,
          index,
          ...
          ids,
          _forceUntilId;_this56 = this;models = this.model.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this56);return model.get('_isAvailable');}.bind(this));index = models.findIndex(function (model) {_newArrowCheck(this, _this56);return model.get('_id') === id;}.bind(this));if (index === -1) {return $error(new Error("Cannot renderTo \"".concat(id, "\" as it isn't a descendant.")));} // Return early if the model is already rendered and ready
          model = models[index];if (model.get('_isRendered') && model.get('_isReady')) {return $return();} // Force all models up until the id to render
          models = models.slice(0, index + 1);ids = _.indexBy(models, function (model) {_newArrowCheck(this, _this56);return model.get('_id');}.bind(this));_forceUntilId = function forceUntilId(event) {_newArrowCheck(this, _this56);var addingId = event.model.get('_id');if (!ids[addingId]) return;
            event.force();
          ...
          return Promise.resolve(this.addChildren()).then(function ($await_45) {try {
              return Promise.resolve(this.whenReady()).then(function ($await_46) {try {
                  // Error if model isn't rendered and ready
                  if (!model.get('_isRendered') || !model.get('_isReady')) {
                    return $error(new Error("Cannot renderTo \"".concat(id, "\".")));
                  }return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "preRemove", value: function preRemove()
      ...
      {var _this57 = this;
        var type = this.constructor.type;
        this.preRemove();
        Adapt.trigger("".concat(type, "View:remove contentObjectView:preRemove view:preRemove"), this);
        this._isRemoved = true;

        Adapt.wait.for(function (end) {var _this58 = this;_newArrowCheck(this, _this57);
          this.$el.off('onscreen.adaptView');
          this.findDescendantViews().reverse().forEach(function (view) {_newArrowCheck(this, _this58);
            view.remove();
          }.bind(this));
          this.setChildViews(null);
          _get(_getPrototypeOf(ContentObjectView.prototype), "remove", this).call(this);
          _.defer(function () {_newArrowCheck(this, _this58);
...
function (Adapt, ContentObjectView) {var
  ...
  PageView = /*#__PURE__*/function (_ContentObjectView) {"use strict";_inherits(PageView, _ContentObjectView);var _super22 = _createSuper(PageView);function PageView() {_classCallCheck(this, PageView);return _super22.apply(this, arguments);}_createClass(PageView, [{ key: "preRender", value: function preRender()

      {var _this59 = this;
        // checkIfResetOnRevisit on descendant models before render
        this.model.getAllDescendantModels().forEach(function (model) {_newArrowCheck(this, _this59);
...
function (Adapt, AdaptView) {var
  ...
  ArticleView = /*#__PURE__*/function (_AdaptView2) {"use strict";_inherits(ArticleView, _AdaptView2);var _super23 = _createSuper(ArticleView);function ArticleView() {_classCallCheck(this, ArticleView);return _super23.apply(this, arguments);}_createClass(ArticleView, [{ key: "className", value: function className()
...
function (Adapt, AdaptView) {var
  ...
  BlockView = /*#__PURE__*/function (_AdaptView3) {"use strict";_inherits(BlockView, _AdaptView3);var _super24 = _createSuper(BlockView);function BlockView() {_classCallCheck(this, BlockView);return _super24.apply(this, arguments);}_createClass(BlockView, [{ key: "className", value: function className()
...
function (Adapt, Data, AdaptSubsetCollection, CourseModel, ContentObjectModel, MenuModel, PageModel, ArticleModel, BlockModel, ComponentModel, PageView, ArticleView, BlockView) {var
  ...
  MPABC = /*#__PURE__*/function (_Backbone$Controller4) {"use strict";_inherits(MPABC, _Backbone$Controller4);var _super25 = _createSuper(MPABC);function MPABC() {_classCallCheck(this, MPABC);return _super25.apply(this, arguments);}_createClass(MPABC, [{ key: "initialize", value: function initialize()
...

      {
        ...
        Adapt.wait.end();
      } }, { key: "setupDeprecatedSubsetCollections", value: function setupDeprecatedSubsetCollections()

      {var _this60 = this;
        var contentObjects = new AdaptSubsetCollection(null, { parent: Data, model: ContentObjectModel });
        var articles = new AdaptSubsetCollection(null, { parent: Data, model: ArticleModel });
        var blocks = new AdaptSubsetCollection(null, { parent: Data, model: BlockModel });
        var components = new AdaptSubsetCollection(null, { parent: Data, model: ComponentModel });
        Object.defineProperty(Adapt, 'contentObjects', {
          get: function get() {_newArrowCheck(this, _this60);
            Adapt.log.deprecated('Adapt.contentObjects, please use Adapt.data instead');
            return contentObjects;
          }.bind(this),
          set: function set(value) {_newArrowCheck(this, _this60);return contentObjects = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'articles', {
          ...
          set: function set(value) {_newArrowCheck(this, _this60);return articles = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'blocks', {
          ...
          set: function set(value) {_newArrowCheck(this, _this60);return blocks = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'components', {
          ...
          set: function set(value) {_newArrowCheck(this, _this60);return components = value;}.bind(this) });
...
function (Adapt) {var
  ...
  Scrolling = /*#__PURE__*/function (_Backbone$Controller5) {"use strict";_inherits(Scrolling, _Backbone$Controller5);var _super26 = _createSuper(Scrolling);function Scrolling() {_classCallCheck(this, Scrolling);return _super26.apply(this, arguments);}_createClass(Scrolling, [{ key: "initialize", value: function initialize()
      ...
      {var _this61 = this;
        ...
        var $window = $(window);
        this.$app.on('scroll', function () {_newArrowCheck(this, _this61);
          $window.scroll();
        }.bind(this));
      }
      ...
      selector) {var $args = arguments;return new Promise(function ($return, $error) {var _this62, settings,
          ...
          offsetTop;_this62 = this;settings = $args.length > 1 && $args[1] !== undefined ? $args[1] : {};currentModelId = selector.replace(/\./g, '');currentModel = Adapt.findById(currentModelId);if (!currentModel) return $return();if (!currentModel.get('_isRendered') || !currentModel.get('_isRendered')) {return Promise.resolve(Adapt.parentView.renderTo(currentModelId)).then(function ($await_47) {try {return $If_19.call(this);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} // Get the current location - this is set in the router
          function $If_19() {location = Adapt.location._contentType ? Adapt.location._contentType : Adapt.location._currentLocation; // Trigger initial scrollTo event
            Adapt.trigger("".concat(location, ":scrollTo"), selector); // Setup duration variable passed upon argumentsß
            disableScrollToAnimation = Adapt.config.has('_disableAnimation') ? Adapt.config.get('_disableAnimation') : false;if (disableScrollToAnimation) {settings.duration = 0;} else if (!settings.duration) {settings.duration = $.scrollTo.defaults.duration;}offsetTop = 0;if (Adapt.scrolling.isLegacyScrolling) {offsetTop = -$('.nav').outerHeight(); // prevent scroll issue when component description aria-label coincident with top of component
            ...
            return Promise.resolve(new Promise(function (resolve) {var _this63 = this;_newArrowCheck(this, _this62);
              _.delay(function () {_newArrowCheck(this, _this63);
                Adapt.a11y.focusNext(selector);
                Adapt.trigger("".concat(location, ":scrolledTo"), selector);
                resolve();
              }.bind(this), settings.duration + 300);
            }.bind(this))).then(function ($await_48) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}return $If_19.call(this);}.bind(this));} }]);return Scrolling;}(Backbone.Controller);
...
function (Adapt) {var
  ...
  NavigationView = /*#__PURE__*/function (_Backbone$View2) {"use strict";_inherits(NavigationView, _Backbone$View2);var _super27 = _createSuper(NavigationView);function NavigationView() {_classCallCheck(this, NavigationView);return _super27.apply(this, arguments);}_createClass(NavigationView, [{ key: "className", value: function className()
      ...
      {var _this64 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this64);
...
define('core/js/models/itemModel', [], function () {var
  ...
  ItemModel = /*#__PURE__*/function (_Backbone$Model6) {"use strict";_inherits(ItemModel, _Backbone$Model6);var _super28 = _createSuper(ItemModel);function ItemModel() {_classCallCheck(this, ItemModel);return _super28.apply(this, arguments);}_createClass(ItemModel, [{ key: "defaults", value: function defaults()
...
function (ComponentModel, ItemModel) {var
  ...
  ItemsComponentModel = /*#__PURE__*/function (_ComponentModel) {"use strict";_inherits(ItemsComponentModel, _ComponentModel);var _super29 = _createSuper(ItemsComponentModel);function ItemsComponentModel() {_classCallCheck(this, ItemsComponentModel);return _super29.apply(this, arguments);}_createClass(ItemsComponentModel, [{ key: "toJSON", value: function toJSON()
      ...
      {var _this65 = this;
        ...
        items.forEach(function (item, index) {_newArrowCheck(this, _this65);return item._index = index;}.bind(this));
      ...
      type, force) {var _this66 = this;
        this.getChildren().each(function (item) {_newArrowCheck(this, _this66);return item.reset();}.bind(this));
      ...
      {var _this67 = this;
        this.getChildren().each(function (item) {_newArrowCheck(this, _this67);return item.toggleActive(false);}.bind(this));
...
function (ItemsComponentModel) {
  ...
  var AccordionModel = ItemsComponentModel.extend({
    ...
    toggleItemsState: function toggleItemsState(index) {
...
function (Adapt, AdaptView) {var
  ...
  ComponentView = /*#__PURE__*/function (_AdaptView4) {"use strict";_inherits(ComponentView, _AdaptView4);var _super30 = _createSuper(ComponentView);function ComponentView() {_classCallCheck(this, ComponentView);return _super30.apply(this, arguments);}_createClass(ComponentView, [{ key: "attributes", value: function attributes()
      ...
      inviewElementSelector, callback) {
...
function (ComponentView) {
  ...
  var AccordionView = ComponentView.extend({
    ...
    onItemsActiveChange: function onItemsActiveChange(item, isActive) {
      this.toggleItem(item, isActive);
    },

    onItemsVisitedChange: function onItemsVisitedChange(item, isVisited) {
      if (!isVisited) return;
    ...
    toggleItem: function toggleItem(item, shouldExpand) {
      var $item = this.getItemElement(item);
...
function (Adapt, ComponentModel) {
  ...
  var AssessmentResultsModel = ComponentModel.extend({
    ...
    /**
        ...
        */
    checkIfAssessmentComplete: function checkIfAssessmentComplete() {
    ...
    onAssessmentComplete: function onAssessmentComplete(state) {
    ...
    setFeedbackBand: function setFeedbackBand(state) {
    ...
    checkRetryEnabled: function checkRetryEnabled(state) {
    ...
    setFeedbackText: function setFeedbackText() {
      var feedbackBand = this.get('_feedbackBand');
    ...
    toggleVisibility: function toggleVisibility(isVisible) {
    ...
    /**
        ...
        */
    onAssessmentReset: function onAssessmentReset(state) {
      if (this.get('_assessmentId') === undefined ||
      this.get('_assessmentId') != state.id) return;
...
function (Adapt, ComponentView) {
  ...
  var AssessmentResultsView = ComponentView.extend({
    ...
    /**
        ...
        */
    addClassesToArticle: function addClassesToArticle(model, value) {
...
function (Adapt, ComponentModel, BUTTON_STATE) {var
  ...
  QuestionModel = /*#__PURE__*/function (_ComponentModel2) {"use strict";_inherits(QuestionModel, _ComponentModel2);var _super31 = _createSuper(QuestionModel);function QuestionModel() {_classCallCheck(this, QuestionModel);return _super31.apply(this, arguments);}_createClass(QuestionModel, [{ key: "defaults",
      ...
      {var _get3,_this68 = this;for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {args[_key14] = arguments[_key14];}
        (_get3 = _get(_getPrototypeOf(QuestionModel.prototype), "setupModel", this)).call.apply(_get3, [this].concat(args));
        this.on('change:_isInteractionComplete', function (model, value) {_newArrowCheck(this, _this68);
          if (!value) {
            return;
          }
    ...
    }, { key: "resetUserAnswer", value: function resetUserAnswer() {} }, { key: "refresh", value: function refresh()
      ...
      {var _this69 = this;var object = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.toJSON();
        var trackables = this.trackable();
        var types = this.trackableType();
        trackables.find(function (name, index) {_newArrowCheck(this, _this69);
        ...
        var values = trackables.map(function (n) {_newArrowCheck(this, _this69);return object[n];}.bind(this));
        var booleans = values.filter(function (v, i) {_newArrowCheck(this, _this69);return types[i] === Boolean;}.bind(this)).map(Boolean);
        var numbers = values.filter(function (v, i) {_newArrowCheck(this, _this69);return types[i] === Number;}.bind(this)).map(function (v) {_newArrowCheck(this, _this69);return Number(v) || 0;}.bind(this));
        var arrays = values.filter(function (v, i) {_newArrowCheck(this, _this69);return types[i] === Array;}.bind(this));
        return [
        numbers,
        booleans,
        arrays];
      ...
      {var _this70 = this;var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.getAttemptState();
        var trackables = this.trackable();
        var types = this.trackableType();
        trackables.find(function (name, index) {_newArrowCheck(this, _this70);
          if (name !== '_attemptStates') return;
          // Exclude _attemptStates as it's trackable but isn't needed here
          trackables.splice(index, 1);
          types.splice(index, 1);
        ...
        var object = {};
        trackables.forEach(function (n, i) {_newArrowCheck(this, _this70);
          if (n === '_id') return;
          switch (types[i]) {
            case Number:
      ...
      {var _this71 = this;
        ...
        return states.map(function (state) {_newArrowCheck(this, _this71);
...
function (Adapt, ComponentView, ButtonsView, QuestionModel, BUTTON_STATE) {
  ...
  QuestionView = /*#__PURE__*/function (_ComponentView) {"use strict";_inherits(QuestionView, _ComponentView);var _super32 = _createSuper(QuestionView);function QuestionView() {_classCallCheck(this, QuestionView);return _super32.apply(this, arguments);}_createClass(QuestionView, [{ key: "className", value: function className()
      ...
      // Used to check if the question should reset on revisit
    }, { key: "checkIfResetOnRevisit", value: function checkIfResetOnRevisit() {var _this72 = this;
        ...
        if (isResetOnRevisit) {
          ...
          _.defer(function () {_newArrowCheck(this, _this72);
  ...
  ViewOnlyQuestionViewCompatibilityLayer = /*#__PURE__*/function (_QuestionView) {"use strict";_inherits(ViewOnlyQuestionViewCompatibilityLayer, _QuestionView);var _super33 = _createSuper(ViewOnlyQuestionViewCompatibilityLayer);function ViewOnlyQuestionViewCompatibilityLayer() {_classCallCheck(this, ViewOnlyQuestionViewCompatibilityLayer);return _super33.apply(this, arguments);}_createClass(ViewOnlyQuestionViewCompatibilityLayer, [{ key: "getInteractionObject",
...
'core/js/models/questionModel',
'core/js/models/itemsComponentModel'],
function (Adapt, QuestionModel, ItemsComponentModel) {var _this73 = this;var

  BlendedItemsComponentQuestionModel = /*#__PURE__*/function (_QuestionModel) {"use strict";_inherits(BlendedItemsComponentQuestionModel, _QuestionModel);var _super34 = _createSuper(BlendedItemsComponentQuestionModel);function BlendedItemsComponentQuestionModel() {_classCallCheck(this, BlendedItemsComponentQuestionModel);return _super34.apply(this, arguments);}_createClass(BlendedItemsComponentQuestionModel, [{ key: "init", value: function init()
  ...
  Object.getOwnPropertyNames(ItemsComponentModel.prototype).forEach(function (name) {_newArrowCheck(this, _this73);
  ...
  ItemsQuestionModel = /*#__PURE__*/function (_BlendedItemsComponen) {"use strict";_inherits(ItemsQuestionModel, _BlendedItemsComponen);var _super35 = _createSuper(ItemsQuestionModel);function ItemsQuestionModel() {_classCallCheck(this, ItemsQuestionModel);return _super35.apply(this, arguments);}_createClass(ItemsQuestionModel, [{ key: "init", value: function init()
      ...
      {var _this74 = this;
        ...
        itemModels.each(function (item) {_newArrowCheck(this, _this74);
      ...
      // This is important for returning or showing the users answer
      // This should preserve the state of the users answers
    }, { key: "storeUserAnswer", value: function storeUserAnswer() {var _this75 = this;
        var items = this.getChildren().slice(0);
        items.sort(function (a, b) {_newArrowCheck(this, _this75);return a.get('_index') - b.get('_index');}.bind(this));
        var userAnswer = items.map(function (itemModel) {_newArrowCheck(this, _this75);return itemModel.get('_isActive');}.bind(this));
      ...
      {var _this76 = this;
        ...
        this.getChildren().each(function (itemModel) {_newArrowCheck(this, _this76);
      ...
      {var _this77 = this;
        ...
        interactions.choices = this.getChildren().map(function (itemModel) {_newArrowCheck(this, _this77);
          return {
        ...
        var correctItems = this.getChildren().filter(function (itemModel) {_newArrowCheck(this, _this77);
          return itemModel.get('_shouldBeSelected');
        }.bind(this));

        interactions.correctResponsesPattern = [
        correctItems.map(function (itemModel) {_newArrowCheck(this, _this77);
      ...
      {var _this78 = this;
        var activeItems = this.getActiveItems();
        var activeIndexes = activeItems.map(function (itemModel) {_newArrowCheck(this, _this78);
          // indexes are 0-based, we need them to be 1-based for cmi.interactions
...
function (Adapt, ComponentView, ComponentModel) {
  ...
  var GraphicView = ComponentView.extend({
    ...
    resizeImage: function resizeImage(width, setupInView) {
      var imageWidth = width === 'medium' ? 'small' : width;
...
function (Adapt) {
  ...
  var HotgraphicPopupView = Backbone.View.extend({
    ...
    applyNavigationClasses: function applyNavigationClasses(index) {
    ...
    onItemsActiveChange: function onItemsActiveChange(item, _isActive) {
      if (!_isActive) return;
      var index = item.get('_index');
      this.updatePageCount();
    ...
    applyItemClasses: function applyItemClasses(index) {
    ...
    onItemsVisitedChange: function onItemsVisitedChange(item, _isVisited) {
    ...
    getNextIndex: function getNextIndex(direction) {
    ...
    setItemState: function setItemState(index) {
...
function (Adapt, ComponentView, HotgraphicPopupView) {
  ...
  var HotGraphicView = ComponentView.extend({
    ...
    setUpViewData: function setUpViewData() {
      this.popupView = null;
      this._isPopupOpen = false;
    },

    setUpModelData: function setUpModelData() {
    ...
    prepareNarrativeModel: function prepareNarrativeModel() {
    ...
    onItemsActiveChange: function onItemsActiveChange(model, _isActive) {
      this.getItemElement(model).toggleClass('is-active', _isActive);
    },

    getItemElement: function getItemElement(model) {
      var index = model.get('_index');
      return this.$('.js-hotgraphic-item-click').filter('[data-index="' + index + '"]');
    },

    onItemsVisitedChange: function onItemsVisitedChange(model, _isVisited) {
      if (!_isVisited) return;
    ...
    onPinClicked: function onPinClicked(event) {
...
function (Adapt, ComponentView, MODE) {
  ...
  var NarrativeView = ComponentView.extend({
    ...
    calculateMode: function calculateMode() {
    ...
    isLargeMode: function isLargeMode() {
    ...
    setupNarrative: function setupNarrative() {
      this.renderMode();
    ...
    replaceInstructions: function replaceInstructions() {
      if (this.isLargeMode()) {
    ...
    replaceWithHotgraphic: function replaceWithHotgraphic() {
    ...
    prepareHotgraphicModel: function prepareHotgraphicModel() {
      var model = this.model;
    ...
    moveSliderToIndex: function moveSliderToIndex(itemIndex) {
    ...
    setStage: function setStage(item) {
      var index = item.get('_index');
      if (this.isLargeMode()) {
    ...
    evaluateNavigation: function evaluateNavigation() {
    ...
    evaluateCompletion: function evaluateCompletion() {
    ...
    onNavigationClicked: function onNavigationClicked(event) {
...
function (Adapt, ComponentView, ComponentModel) {
  ...
  var TextView = ComponentView.extend({
    ...
    setupInview: function setupInview() {
    ...
    /**
        ...
        */
    getInviewElementSelector: function getInviewElementSelector() {
...
define('extensions/adapt-branching/js/adapt-branching', [
'core/js/adapt',
'core/js/models/questionModel',
'core/js/models/componentModel'],
function (Adapt, QuestionModel, ComponentModel) {var

  Branching = /*#__PURE__*/function (_Backbone$Controller6) {"use strict";_inherits(Branching, _Backbone$Controller6);var _super36 = _createSuper(Branching);function Branching() {_classCallCheck(this, Branching);return _super36.apply(this, arguments);}_createClass(Branching, [{ key: "initialize", value: function initialize()
      ...
      } }, { key: "onAppDataReady", value: function onAppDataReady() {return new Promise(function ($return, $error) {var


          config;config = Adapt.course.get('_branching');
          if (!config || !config._isEnabled) return $return();
          return Promise.resolve(Adapt.data.whenReady()).then(function ($await_49) {try {
              this.setupBranching();
              this.setupEventListeners();return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "setupBranching", value: function setupBranching()


      {var _this79 = this;
        var containers = Adapt.course.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this79);
          var config = model.get('_branching');
          if (!config || !config._isContainer) return;
          return true;
        }.bind(this));
        containers.forEach(function (container) {var _this80 = this;_newArrowCheck(this, _this79);
          container.set('_canRequestChild', true);
          var children = container.getChildren();
          children.forEach(function (child) {_newArrowCheck(this, _this80);
            child.setOnChildren({
              _isAvailable: false });

          }.bind(this));
          var config = container.get('_branching');
          if (this.restoreModelOrder(container, config)) {
            return;
          }
          var model = this.getNextModel(container, config);
          this.addNextModel(container, model);
        }.bind(this));
      } }, { key: "restoreModelOrder", value: function restoreModelOrder(

      container, config) {var _this81 = this;
        var branching = Adapt.offlineStorage.get('b');
        if (!branching) {
          return;
        }
        var id = container.get('_id');
        if (!branching[id]) {
          return;
        }
        var trackingIds = Adapt.offlineStorage.deserialize(branching[id]);
        container.set("_isBranchingRestoring", true);
        trackingIds.forEach(function (trackingId) {_newArrowCheck(this, _this81);
          var model = this.findModelFromTrackingId(container, trackingId);
          this.addNextModel(container, model, true);
        }.bind(this));
        container.set("_isBranchingRestoring", false);
        return true;
      } }, { key: "findModelFromTrackingId", value: function findModelFromTrackingId(

      model, trackingId) {var _this82 = this;
        var children = model.getChildren();
        return children.find(function (child) {var _this83 = this;_newArrowCheck(this, _this82);
          return [child].concat(child.getAllDescendantModels(true)).find(function (child) {_newArrowCheck(this, _this83);
...

      {
        ...
        this.listenTo(Adapt.data, _defineProperty({
          'change:_isComplete': this.onBranchComplete }, "change:_isComplete",
        this.onQuestionComplete));

      } }, { key: "onRequestChild", value: function onRequestChild(

      event) {
        var config = event.target.model.get('_branching');
        if (!config || !config._isContainer) return;
        var model = this.getNextModel(event.target.model, config);
        if (!model) {
          event.stop();
          return;
        }
        var clonedModel = this.addNextModel(event.target.model, model);
        event.model = clonedModel;
        Adapt.log.debug("BRANCHING: ".concat(model.get('_id'), " cloned, attempt ").concat(model.get('_branchAttempts')));
        event.stop(false);
      } }, { key: "getNextModel", value: function getNextModel(

      container, config) {var _this84 = this;;
        var children = container.getChildren().models;
        var availableChildren = children.filter(function (model) {_newArrowCheck(this, _this84);return model.get('_isAvailable');}.bind(this));

        if (!availableChildren.length) {
          // Starting model
          return children.find(function (child) {_newArrowCheck(this, _this84);return child.get('_id') === config._start;}.bind(this));
        }

        var lastChildModel = availableChildren[availableChildren.length - 1];
        ...
        var correctness = this.fetchCorrectness(lastChildModel);
        var lastConfig = lastChildModel.get('_branching') || {};
        var nextId;
        switch (correctness) {
          case 'none':
        ...
        return children.find(function (child) {_newArrowCheck(this, _this84);return child.get('_id') === nextId;}.bind(this));
      } }, { key: "fetchCorrectness", value: function fetchCorrectness(

      model) {
        var questions = model.findDescendantModels('question');
        if (!questions.length) {
          return 'none';
        }
        ...
        return 'incorrect';
      } }, { key: "addNextModel", value: function addNextModel(

      container, nextModel) {var _this85 = this;var restore = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        [nextModel].concat(nextModel.getAllDescendantModels(true)).forEach(function (model) {_newArrowCheck(this, _this85);
          var branchAttempts = model.get('_branchAttempts') || 0;
          model.set('_branchAttempts', branchAttempts + 1);
        }.bind(this));
        var hasRestored = false;
        var cloned = nextModel.deepClone({
          _isBranch: true,
          _isAvailable: true },
        {
          _isAvailable: true },
        function (model, clone) {_newArrowCheck(this, _this85);
          ...
          if (clone instanceof QuestionModel) {
            ...
            if (restore) {
              var attemptIndex = clone.get('_branchAttempts') - 1;
              var attemptObjects = model.getAttemptObjects();
        ...
        if (hasRestored) {
          ...
          cloned.getAllDescendantModels(true).reverse().forEach(function (model) {_newArrowCheck(this, _this85);
        ...
        return cloned;
      } }, { key: "saveModelOrder", value: function saveModelOrder(

      container, nextModel) {
        if (container.get("_isBranchingRestoring")) return;
        var branching = Adapt.offlineStorage.get('b') || {};
        var id = container.get('_id');
        var trackingIds = branching[id] && Adapt.offlineStorage.deserialize(branching[id]) || [];
      ...
      } }, { key: "findTrackingIdFromModel", value: function findTrackingIdFromModel(

      nextModel) {var _this86 = this;
        var trackingIdModel = [nextModel].concat(nextModel.getAncestorModels()).find(function (model) {_newArrowCheck(this, _this86);return model.has('_trackingId');}.bind(this));
        return trackingIdModel.get('_trackingId');
      } }, { key: "onBranchComplete", value: function onBranchComplete(

      model, value) {
        if (!value || !model.get('_isBranch')) return;
        Adapt.parentView.addChildren();
      } }, { key: "onQuestionComplete", value: function onQuestionComplete(

      model, value) {
        if (!value || !model.get('_isBranchQuestion')) return;
        var branchModelId = model.get('_branchModelId');
        var originalModel = Adapt.findById(branchModelId);
        originalModel.addAttemptObject(model.getAttemptObject());
        Adapt.offlineStorage.save();
      } }]);return Branching;}(Backbone.Controller);
...
function (AdaptView) {var
  ...
  MenuItemView = /*#__PURE__*/function (_AdaptView5) {"use strict";_inherits(MenuItemView, _AdaptView5);var _super37 = _createSuper(MenuItemView);function MenuItemView() {_classCallCheck(this, MenuItemView);return _super37.apply(this, arguments);}_createClass(MenuItemView, [{ key: "attributes", value: function attributes()
...
function (ContentObjectView, MenuItemView) {var
  ...
  MenuView = /*#__PURE__*/function (_ContentObjectView2) {"use strict";_inherits(MenuView, _ContentObjectView2);var _super38 = _createSuper(MenuView);function MenuView() {_classCallCheck(this, MenuView);return _super38.apply(this, arguments);}return MenuView;}(ContentObjectView);
...
define('extensions/adapt-contentObjectTransition/js/adapt-contentObjectTransition', [
'core/js/adapt',
'core/js/views/menuView'],
function (Adapt, MenuView) {var

  ContentObjectTransition = /*#__PURE__*/function (_Backbone$Controller7) {"use strict";_inherits(ContentObjectTransition, _Backbone$Controller7);var _super39 = _createSuper(ContentObjectTransition);function ContentObjectTransition() {_classCallCheck(this, ContentObjectTransition);return _super39.apply(this, arguments);}_createClass(ContentObjectTransition, [{ key: "initialize", value: function initialize()
      ...
      } }, { key: "onDataReady", value: function onDataReady()

      {
        var config = Adapt.course.get('_contentObjectTransition');
        if (!config || !config._isEnabled) return;
        this.setupOverrides();
        this.setupEventListeners();
      } }, { key: "setupOverrides", value: function setupOverrides()
      ...
      } }, { key: "updateHash", value: function updateHash(
      ...
      } }, { key: "onPreRemove", value: function onPreRemove(

      contentObjectView) {
        if (!contentObjectView) return;
        this.views.push(contentObjectView);
      } }, { key: "onContentObjectViewPreRender", value: function onContentObjectViewPreRender(

      contentObjectView) {return new Promise(function ($return, $error) {var _this87,
          ...
          scrollTo;_this87 = this;if (this.views.length < 1) return $return();index = this.views.length; // Stop normal contentObject animation behaviour
          contentObjectView.disableAnimation = true;contentObjectView.$el.css('opacity', ''); // Capture view
          this.views.push(contentObjectView); // Initialize animation
          contentObjectView.$el.addClass('contentobjecttransition__initial'); // Is this a scroll forward or scroll back?
          models = [Adapt.course].concat(Adapt.course.getAllDescendantModels(true));previousModel = this.views[index - 1].model;currentModel = contentObjectView.model;previousIndex = models.findIndex(function (model) {_newArrowCheck(this, _this87);return model === previousModel;}.bind(this));currentIndex = models.findIndex(function (model) {_newArrowCheck(this, _this87);return model === currentModel;}.bind(this));isScrollForward = currentIndex >= previousIndex; // Add appropriate animation
          if (isScrollForward) {contentObjectView.$el.addClass('contentobjecttransition__initial__forward');} else {contentObjectView.$el.addClass('contentobjecttransition__initial__backward');}if (this.lastState && this.lastState.scroll !== undefined) {if (this.lastState.lowestId) {return Promise.resolve(Adapt.parentView.renderTo(this.lastState.lowestId)).then(function ($await_50) {try {return $If_21.call(this);} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);} // Offset incoming page to match required scroll top
            function $If_21() {scrollTo = this.lastState.scroll - $('.nav').height();contentObjectView.$el.css('top', -scrollTo);return $If_20.call(this);}return $If_21.call(this);}function $If_20() {return $return();}return $If_20.call(this);}.bind(this));} }, { key: "onContentObjectViewPreReady", value: function onContentObjectViewPreReady(contentObjectView) {var _this88 = this;
        if (this.views.length < 2) return;
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this88);return view === contentObjectView;}.bind(this));
        if (index === -1) return;
        ...
        var incomingContentObject = this.views[index];
        ...
        var outgoingContentObject = this.views[index - 1];
        outgoingContentObject.$el.css('transform-origin', "center calc(".concat($(window).scrollTop(), "px + (100vh / 2))"));
      ...
      } }, { key: "endAnimation", value: function endAnimation(

      event) {var _this89 = this;
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this89);return view.$el[0] === event.srcElement;}.bind(this));
        if (index === -1) return;
        ...
        window.requestAnimationFrame(function () {_newArrowCheck(this, _this89);
          ...
          var scrollTo = this.lastState && this.lastState.scroll !== undefined ?
      ...
      } }, { key: "onContentObjectViewPostRemove", value: function onContentObjectViewPostRemove(

      contentObjectView) {var _this90 = this;
        // Remove contentObject views from list
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this90);return view === contentObjectView;}.bind(this));
        this.views.splice(index, 2);
        if (this.views.length) return;
      } }]);return ContentObjectTransition;}(Backbone.Controller);
...
function (Adapt, QuestionBank) {
  ...
  var AssessmentModel = {
    ...
    getSaveState: function getSaveState() {var _this91 = this;
      var state = this.getState();
      var blocks;
      ...
      if (!banksActive && !randomisationActive) {
        ...
        blocks = state.questions.map(function (question) {_newArrowCheck(this, _this91);return Adapt.findById(question._id).getParent();}.bind(this));
      }
      blocks = blocks.filter(function (block) {_newArrowCheck(this, _this91);
        var trackingId = block.get('_trackingId');
        return Number.isInteger(trackingId) && trackingId >= 0;
      }.bind(this));
      var blockTrackingIds = blocks.map(function (block) {_newArrowCheck(this, _this91);return block.get('_trackingId');}.bind(this));
      var blockCompletion = blocks.map(function (block) {var _this92 = this;_newArrowCheck(this, _this91);
        var questions = block.findDescendantModels('question');
        return questions.map(function (question) {_newArrowCheck(this, _this92);return question.get('_isCorrect') || false;}.bind(this));
      }.bind(this));
    ...
    setRestoreState: function setRestoreState(dataPackage) {var _this93 = this;
      ...
      var blocks = blockData[0].map(function (trackingId) {_newArrowCheck(this, _this93);return Adapt.data.findWhere({ _trackingId: trackingId });}.bind(this));
      var restoredChildrenModels = blocks;
      ...
      var questions = [];
      blocks.forEach(function (block, blockIndex) {var _this94 = this;_newArrowCheck(this, _this93);
        var blockQuestions = block.findDescendantModels('question');
        blockQuestions.forEach(function (question, questionIndex) {_newArrowCheck(this, _this94);
          questions.push({
...
function (Adapt) {
  ...
  var Bookmarking = Backbone.Controller.extend({
    ...
    navigateToPrevious: function navigateToPrevious() {
      _.defer(function () {return new Promise(function ($return, $error) {var
          isSinglePage;isSinglePage = Adapt.contentObjects.models.length == 1;
          return Promise.resolve(Adapt.navigateToElement('.' + this.restoredLocationID, { trigger: true, replace: isSinglePage, duration: 400 })).then(function ($await_51) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));}.
      bind(this));
...
function (Adapt) {
  ...
  var LanguagePickerDrawerView = Backbone.View.extend({
    ...
    onDontChangeLanguage: function onDontChangeLanguage() {
      this.remove();
...
function (Adapt) {
  ...
  var LanguagePickerModel = Backbone.Model.extend({
    ...
    getLanguageDetails: function getLanguageDetails(language) {
    ...
    markLanguageAsSelected: function markLanguageAsSelected(model, language) {
    ...
    getState: function getState(models) {
...
function (Adapt, PageLevelProgressItemView) {
  ...
  var PageLevelProgressView = Backbone.View.extend({
    ...
    scrollToPageElement: function scrollToPageElement(event) {return new Promise(function ($return, $error) {var
        ...
        currentComponentSelector;if (event && event.preventDefault) event.preventDefault();$target = $(event.currentTarget);if ($target.is('.is-disabled')) return $return();id = $target.attr('data-pagelevelprogress-id');model = Adapt.findById(id);if (!model.get('_isRendered')) {var $Try_10_Post = function () {try {return $If_22.call(this);} catch ($boundEx) {return $error($boundEx);}}.bind(this);var $Try_10_Catch = function (err) {try {return $return();} catch ($boundEx) {return $error($boundEx);}};try {return Promise.resolve(Adapt.parentView.renderTo(id)).then(function ($await_52) {try {return $Try_10_Post();} catch ($boundEx) {return $Try_10_Catch($boundEx);}}, $Try_10_Catch);} catch (err) {$Try_10_Catch(err)}}function $If_22() {currentComponentSelector = '.' + id;

          Adapt.once('drawer:closed', function () {
            Adapt.scrollTo(currentComponentSelector, { duration: 400 });
          }).trigger('drawer:closeDrawer', $(currentComponentSelector));return $return();}return $If_22.call(this);});},
...
function (pipwerks) {
  ...
  var ScormWrapper = function ScormWrapper() {
    /* configuration */
...
function (Adapt) {
  ...
  var serializer = {
    ...
    serializeSaveState: function serializeSaveState(attribute) {
    ...
    deserialize: function deserialize(completion, callback) {
      var syncIterations = 1; // number of synchronous iterations to perform
    ...
    deserializeSaveState: function deserializeSaveState(string) {
...
(function () {var _this103 = this;
  ...
  function uintToBin(integer, binLen) {
    ...
    if (length > binLen) {
      throw new Error("Integer too big for specified binary length. int: ".concat(integer, " binlen: ").concat(binLen));
    }
    bin = zeroPadLeftToLen(bin, binLen);
    return bin;
  }
  ...
  function byteArrToStr(arr) {
    ...
    for (var _i = 0, _l = arrLength; _i < _l; _i++) {
      str[_i] = String.fromCharCode(arr[_i]);
    }
    str = str.join('');
    return str;
  }
  ...
  function strToByteArr(str) {
    ...
    for (var _i2 = 0, _l2 = strLength; _i2 < _l2; _i2++) {
      arr[_i2] = str.charCodeAt(_i2);
    }
    return arr;
  }
  ...
  function binToBase64(bin) {
    ...
    for (var _i3 = 0, _l3 = bytesCount; _i3 < _l3; _i3++) {var _shiftUintFromBin =
      shiftUintFromBin(bin, BYTE_BIT_LENGTH);var _shiftUintFromBin2 = _slicedToArray(_shiftUintFromBin, 2);charCodes[_i3] = _shiftUintFromBin2[0];bin = _shiftUintFromBin2[1];
    }
  ...
  function base64ToBin(base64) {
    ...
    for (var _i4 = 0, _l4 = bytesCount; _i4 < _l4; _i4++) {
      bin[_i4] = uintToBin(charCodes[_i4], BYTE_BIT_LENGTH);
    }
    bin = bin.join('');
    return bin;
  }
  ...
  /**
                          ...
                          */var
  AbstractValueType = /*#__PURE__*/function () {"use strict";
    ...
    /**
                                                               ...
                                                               */
    function AbstractValueType(options) {_classCallCheck(this, AbstractValueType);
    ...
    /**
       ...
       */_createClass(AbstractValueType, [{ key: "log", value: function log(
      bin) {
        var name = this.name;
  ...
  /**
     ...
     */var
  FixedIntegerType = /*#__PURE__*/function (_AbstractValueType) {"use strict";_inherits(FixedIntegerType, _AbstractValueType);var _super40 = _createSuper(FixedIntegerType);
    ...
    /**
                                                                                                                                                                              ...
                                                                                                                                                                              */
    function FixedIntegerType(options) {var _this95;_classCallCheck(this, FixedIntegerType);
      _this95 = _super40.call(this, options);
      _this95.esType = 'number';
      if (!_this95.valueBinLength) {
        return _possibleConstructorReturn(_this95);
      }
      _this95.minValue = options.minValue || 0;
      _this95.maxValue = options.maxValue || Math.pow(2, _this95.valueBinLength) - 1;return _this95;
    }
    ...
    /**
       ...
       * @returns {[string]}
       */_createClass(FixedIntegerType, [{ key: "valueToBin", value: function valueToBin(
      integer) {var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      ...
      /**
         ...
         * @param {string} bin
         * @returns {[number, string]}
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var int;var _shiftUintFromBin3 =
        shiftUintFromBin(bin, this.valueBinLength);var _shiftUintFromBin4 = _slicedToArray(_shiftUintFromBin3, 2);int = _shiftUintFromBin4[0];bin = _shiftUintFromBin4[1];
        return [int, bin];
      } }]);return FixedIntegerType;}(AbstractValueType);
  ...
  /**
                                                           ...
                                                           */var
  FixedBooleanType = /*#__PURE__*/function (_FixedIntegerType) {"use strict";_inherits(FixedBooleanType, _FixedIntegerType);var _super41 = _createSuper(FixedBooleanType);
    ...
    /**
                                                                                                                                                                            ...
                                                                                                                                                                            * @param {string} options.binType Binary string identifying the type
                                                                                                                                                                            */
    function FixedBooleanType(options) {var _this96;_classCallCheck(this, FixedBooleanType);
      options.valueBinLength = 1;
      _this96 = _super41.call(this, options);
      _this96.esType = 'boolean';return _this96;
    }
    ...
    /**
       ...
       */_createClass(FixedBooleanType, [{ key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var bool = bin[0] === '1' ? true : false;
        bin = bin.slice(1);
        return [bool, bin];
      } }]);return FixedBooleanType;}(FixedIntegerType);
  ...
  /**
                                                          ...
                                                          */var
  LengthAndValueBin = /*#__PURE__*/function () {"use strict";
    ...
    /**
                                                               ...
                                                               */
    function LengthAndValueBin(parent, name, bitSizes) {var _this97 = this;_classCallCheck(this, LengthAndValueBin);
      this.parent = parent;
      this.name = name;
      this.bitSizes = bitSizes;
      this.maxValues = _.flatten(this.bitSizes).map(function (value) {_newArrowCheck(this, _this97);return Math.pow(2, value) - 1;}.bind(this));
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(LengthAndValueBin, [{ key: "valueToBin", value: function valueToBin(
      integer) {var _this98 = this;var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        var parentName = this.parent.name;
        var sizeIndex = this.maxValues.findIndex(function (maxValue) {_newArrowCheck(this, _this98);return integer <= maxValue;}.bind(this));
        if (sizeIndex === -1) {
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var sizeBin;var _shiftBin =
        shiftBin(bin, this.sizeBinLen);var _shiftBin2 = _slicedToArray(_shiftBin, 2);sizeBin = _shiftBin2[0];bin = _shiftBin2[1];
        var sizeIndex = binToUint(sizeBin);
        var valueLen = this.bitSizes[sizeIndex];
        var int;var _shiftUintFromBin5 =
        shiftUintFromBin(bin, valueLen);var _shiftUintFromBin6 = _slicedToArray(_shiftUintFromBin5, 2);int = _shiftUintFromBin6[0];bin = _shiftUintFromBin6[1];
        return [int, bin];
      } }]);return LengthAndValueBin;}();
  ...
  /**
                                           ...
                                           */var
  VariableIntegerType = /*#__PURE__*/function (_FixedIntegerType2) {"use strict";_inherits(VariableIntegerType, _FixedIntegerType2);var _super42 = _createSuper(VariableIntegerType);
    ...
    /**
                                                                                                                                                                                       ...
                                                                                                                                                                                       */
    function VariableIntegerType(options) {var _this99;_classCallCheck(this, VariableIntegerType);
      _this99 = _super42.call(this, options);
      _this99.isNegative = _this99.minValue < 0 && _this99.maxValue === 0;
      _this99.int = new LengthAndValueBin(_assertThisInitialized(_this99), 'int', options.intBitSizes);return _this99;
    }
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(VariableIntegerType, [{ key: "valueToBin", value: function valueToBin(
      integer) {var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        integer = integer.toFixed(0);
        var bin = this.int.valueToBin(Math.abs(integer), logStats);
        logStats && this.log(bin);
        return bin;
      }
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var int;var _this$int$shiftValueF =
        this.int.shiftValueFromBin(bin);var _this$int$shiftValueF2 = _slicedToArray(_this$int$shiftValueF, 2);int = _this$int$shiftValueF2[0];bin = _this$int$shiftValueF2[1];
        if (this.isNegative) {
          int = -int;
        }
        return [int, bin];
      } }]);return VariableIntegerType;}(FixedIntegerType);
  ...
  /**
                                                             ...
                                                             */var
  VariableArrayType = /*#__PURE__*/function (_VariableIntegerType) {"use strict";_inherits(VariableArrayType, _VariableIntegerType);var _super43 = _createSuper(VariableArrayType);
    ...
    /**
                                                                                                                                                                                     ...
                                                                                                                                                                                     * @param {[number]} options.intBitSizes Expressible storage bit sizes
                                                                                                                                                                                     */
    function VariableArrayType(options) {var _this100;_classCallCheck(this, VariableArrayType);
      _this100 = _super43.call(this, options);
      _this100.esType = 'array';return _this100;
    }
    ...
    /**
       ...
       */_createClass(VariableArrayType, [{ key: "valueToBin", value: function valueToBin(
      arr) {var _this101 = this;var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        var arrLength = arr.length;
        var bin = _get(_getPrototypeOf(VariableArrayType.prototype), "valueToBin", this).call(this, arrLength);
        if (arrLength) {
          var valueType = findValueTypeFromValues(arr);
          bin.push(valueType.binType);
          bin.type = valueType.name;
          bin.push(arr.map(function (value) {_newArrowCheck(this, _this101);return valueType.valueToBin(value, logStats);}.bind(this)));
        }
        logStats && this.log(bin);
        return bin;
      }
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var arrLength;var _get$call = _get(_getPrototypeOf(VariableArrayType.prototype), "shiftValueFromBin", this).call(this,
        bin);var _get$call2 = _slicedToArray(_get$call, 2);arrLength = _get$call2[0];bin = _get$call2[1];
        var value = new Array(arrLength);
        if (arrLength) {
          var valueType;var _shiftValueTypeFromBi =
          shiftValueTypeFromBin(bin);var _shiftValueTypeFromBi2 = _slicedToArray(_shiftValueTypeFromBi, 2);valueType = _shiftValueTypeFromBi2[0];bin = _shiftValueTypeFromBi2[1];
          for (var _i5 = 0, _l5 = arrLength; _i5 < _l5; _i5++) {var _valueType$shiftValue =
            valueType.shiftValueFromBin(bin);var _valueType$shiftValue2 = _slicedToArray(_valueType$shiftValue, 2);value[_i5] = _valueType$shiftValue2[0];bin = _valueType$shiftValue2[1];
          }
        }
        return [value, bin];
      } }]);return VariableArrayType;}(VariableIntegerType);
  ...
  /**
                                                              ...
                                                              */var
  VariableSignedIntegerType = /*#__PURE__*/function (_VariableIntegerType2) {"use strict";_inherits(VariableSignedIntegerType, _VariableIntegerType2);var _super44 = _createSuper(VariableSignedIntegerType);
    ...
    /**
                                                                                                                                                                                                               ...
                                                                                                                                                                                                               * @param {[number]} options.intBitSizes Expressible storage bit sizes
                                                                                                                                                                                                               */
    function VariableSignedIntegerType(options) {_classCallCheck(this, VariableSignedIntegerType);return _super44.call(this,
      options);
    }
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(VariableSignedIntegerType, [{ key: "valueToBin", value: function valueToBin(
      integer) {var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        integer = integer.toFixed(0);
        var isNegative = integer < 0;
        var signBin = isNegative ? '1' : '0';
        var integerBin = this.int.valueToBin(Math.abs(integer), logStats);
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var isNegative;var _shiftUintFromBin7 =
        shiftUintFromBin(bin, 1);var _shiftUintFromBin8 = _slicedToArray(_shiftUintFromBin7, 2);isNegative = _shiftUintFromBin8[0];bin = _shiftUintFromBin8[1];
        var int;var _this$int$shiftValueF3 =
        this.int.shiftValueFromBin(bin);var _this$int$shiftValueF4 = _slicedToArray(_this$int$shiftValueF3, 2);int = _this$int$shiftValueF4[0];bin = _this$int$shiftValueF4[1];
        if (isNegative) {
          int = -int;
        }
        return [int, bin];
      } }]);return VariableSignedIntegerType;}(VariableIntegerType);
  ...
  /**
                                                                      ...
                                                                      */var
  VariableDecimalType = /*#__PURE__*/function (_VariableIntegerType3) {"use strict";_inherits(VariableDecimalType, _VariableIntegerType3);var _super45 = _createSuper(VariableDecimalType);
    ...
    /**
                                                                                                                                                                                             ...
                                                                                                                                                                                             */
    function VariableDecimalType(options) {var _this102;_classCallCheck(this, VariableDecimalType);
      _this102 = _super45.call(this, options);
      _this102.isFloat = true;
      _this102.dec = new LengthAndValueBin(_assertThisInitialized(_this102), 'dec', options.decBitSizes);return _this102;
    }
    ...
    /**
       ...
       * @param {boolean} [logStats] Log the type usage for output to the console
       * @returns {[string]}
       */_createClass(VariableDecimalType, [{ key: "valueToBin", value: function valueToBin(
      float) {var logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        var signBin = isNegative ? '1' : '0';
        var intValueBin = this.int.valueToBin(higherInt, logStats);
        var decValueBin = this.dec.valueToBin(lowerInt, logStats);
      ...
      /**
         ...
         */ }, { key: "shiftValueFromBin", value: function shiftValueFromBin(
      bin) {
        var isNegative;var _shiftUintFromBin9 =
        shiftUintFromBin(bin, 1);var _shiftUintFromBin10 = _slicedToArray(_shiftUintFromBin9, 2);isNegative = _shiftUintFromBin10[0];bin = _shiftUintFromBin10[1];
        var higherInt;var _this$int$shiftValueF5 =
        this.int.shiftValueFromBin(bin);var _this$int$shiftValueF6 = _slicedToArray(_this$int$shiftValueF5, 2);higherInt = _this$int$shiftValueF6[0];bin = _this$int$shiftValueF6[1];
        var lowerInt;var _this$dec$shiftValueF =
        this.dec.shiftValueFromBin(bin);var _this$dec$shiftValueF2 = _slicedToArray(_this$dec$shiftValueF, 2);lowerInt = _this$dec$shiftValueF2[0];bin = _this$dec$shiftValueF2[1];
        ...
        return [float, bin];
      } }]);return VariableDecimalType;}(VariableIntegerType);
  ...
  ValueTypes.forEach(function (valueType) {_newArrowCheck(this, _this103);return ValueTypes.nameIndex[valueType.name] = valueType;}.bind(this));
  ...
  /**
     ...
     * @returns {AbstractValueType}
     */
  function findValueTypeFromValue(value) {var _this104 = this;
    ...
    decimalTypes.find(function (valueType) {_newArrowCheck(this, _this104);return value >= valueType.minValue && value <= valueType.maxValue;}.bind(this)) :
    integerTypes.find(function (valueType) {_newArrowCheck(this, _this104);return value >= valueType.minValue && value <= valueType.maxValue;}.bind(this));
    if (!valueType) {
  ...
  /**
     ...
     * @returns {AbstractValueType}
     */
  function findValueTypeFromValues(values) {var _this105 = this;
    if (!values.length) {
      return;
    }
    var minValue = 0;
    var maxValue = 0;
    var isFloat = false;
    var esTypes = values.map(function (value) {_newArrowCheck(this, _this105);
    ...
    var valueType = isFloat ?
    decimalTypes.find(function (valueType) {_newArrowCheck(this, _this105);return minValue >= valueType.minValue && maxValue <= valueType.maxValue;}.bind(this)) :
    integerTypes.find(function (valueType) {_newArrowCheck(this, _this105);return minValue >= valueType.minValue && maxValue <= valueType.maxValue;}.bind(this));
    if (!valueType) {
  ...
  /**
     ...
     */
  function shiftValueTypeFromBin(bin) {var _this106 = this;
    var valueType = ValueTypes.find(function (valueType) {_newArrowCheck(this, _this106);
      var binType = bin.slice(0, valueType.binTypeLength);
      return binType === valueType.binType;
    }.bind(this));
    if (!valueType) {
      throw new Error("Cannot find type from binary: ".concat(bin.slice(0, 6), "..."));
    }
  ...
  /**
     * Main API
     */var
  Converter = /*#__PURE__*/function () {"use strict";function Converter() {_classCallCheck(this, Converter);}_createClass(Converter, [{ key: "getInvalidTypeError",

      /**
                                                                                                                                                                     * Checks the given value for conversion errors and returns the error
                                                                                                                                                                     * @param {string|number|Array} value
                                                                                                                                                                     * @returns {undefined|Error}
                                                                                                                                                                     */value: function getInvalidTypeError(
      value) {
        try {
      ...
      /**
         ...
         * @returns {string}
         */ }, { key: "valueToBin", value: function valueToBin(
      value) {var typeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;var logStats = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
        this.clearLog();
        ...
        if (hasInitialType) {
          ...
          if (!valueType) {
            throw new Error("Could not find value type from name \"".concat(typeName, "\" accepts: ").concat(Object.keys(ValueTypes.nameIndex), ". Leave empty for auto-detect."));
          }
        } else {
          valueType = findValueTypeFromValue(value);
          if (!valueType) {
            throw new Error("Could not find value type from value \"".concat(value, "\" accepts: ").concat(Object.keys(ValueTypes.nameIndex), ". Leave empty for auto-detect."));
          }
        }
      ...
      /**
         ...
         * @param {string} [typeName] To force an internal data type for testing
         * @returns {number|boolean|Array}
         */ }, { key: "valueFromBin", value: function valueFromBin(
      bin) {var typeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        bin = _.flatten(bin).join('');
        var valueType;
        if (typeof typeName === 'string') {
          ...
          shiftValueTypeFromBin(bin);var _shiftValueTypeFromBi4 = _slicedToArray(_shiftValueTypeFromBi3, 2);valueType = _shiftValueTypeFromBi4[0];bin = _shiftValueTypeFromBi4[1];
          if (!valueType || !(valueType instanceof AbstractValueType)) {
            throw new Error("Could not find value type from value \"".concat(value, "\" accepts: ").concat(Object.keys(ValueTypes.nameIndex), ". Leave empty for auto-detect."));
          }
        }
        var value;var _valueType$shiftValue3 =
        valueType.shiftValueFromBin(bin);var _valueType$shiftValue4 = _slicedToArray(_valueType$shiftValue3, 1);value = _valueType$shiftValue4[0];
        return value;
      }

      /**
         * Clears any previous logs
         */ }, { key: "clearLog", value: function clearLog()
      {
        logs.usedTypes = {};
        logs.typeLengths = {};
        logs.binarySamples = {};
      ...
      /**
         ...
         */ }, { key: "printLog", value: function printLog()
      {
      ...
      base64) {var typeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
function (Adapt) {
  ...
  var serializer = {
    ...
    serializeSaveState: function serializeSaveState() {
      if (Adapt.course.get('_latestTrackingId') === undefined) {
        var message = "This course is missing a latestTrackingID.\n\nPlease run the grunt process prior to deploying this module on LMS.\n\nScorm tracking will not work correctly until this is done.";
        console.error(message);
        return "";
    ...
    captureData: function captureData() {var _this107 = this;
      var data = [];

      var trackingIds = Adapt.blocks.pluck("_trackingId").filter(function (id) {_newArrowCheck(this, _this107);return Number.isInteger(id) && id >= 0;}.bind(this));
      var blocks = {};
      var countInBlock = {};
    ...
    releaseData: function releaseData(arr) {
...
function (Adapt, serializer, questions, COMPLETION_STATE) {
  ...
  var AdaptStatefulSession = _.extend({
    ...
    /**
        ...
        */
    getLearnerInfo: function getLearnerInfo() {
    ...
    saveSessionState: function saveSessionState() {
      var sessionPairs = this.getSessionState();
      Adapt.offlineStorage.set(sessionPairs);
    },

    restoreSessionState: function restoreSessionState(callback) {
    ...
    reattachEventListeners: function reattachEventListeners() {
      this.removeEventListeners();
      this.setupEventListeners();
    },

    onBlockComplete: function onBlockComplete(block) {
      this.saveSessionState();
    },

    onQuestionComponentComplete: function onQuestionComponentComplete(component) {
      if (!component.get("_isQuestionType")) return;

      this.saveSessionState();
    },

    onTrackingComplete: function onTrackingComplete(completionData) {
      this.saveSessionState();
    ...
    onAssessmentComplete: function onAssessmentComplete(stateModel) {
    ...
    onQuestionRecordInteraction: function onQuestionRecordInteraction(questionView) {
    ...
    submitScore: function submitScore(stateModel) {
...
function (Adapt, scorm) {
  ...
  Adapt.offlineStorage.initialize({
    ...
    getCustomStates: function getCustomStates() {
    ...
    getCustomState: function getCustomState(name) {
      var dataAsJSON = this.getCustomStates();
      return dataAsJSON[name];
    },

    useTemporaryStore: function useTemporaryStore() {
  ...
  var Spoor = _.extend({
    ...
    initialize: function initialize() {
      this.listenToOnce(Adapt, {
        ...
        'app:dataReady': function appDataReady() {
          Adapt.wait.for(adaptStatefulSession.initialize.bind(adaptStatefulSession));
        } });

    },

    onPrepareOfflineStorage: function onPrepareOfflineStorage() {
      if (!this.checkConfig()) {
    ...
    configureAdvancedSettings: function configureAdvancedSettings() {
...
define('extensions/adapt-contrib-trickle/js/trickleButtonView', [
'core/js/adapt',
'core/js/views/componentView'],
function (Adapt, ComponentView) {var

  TrickleButtonView = /*#__PURE__*/function (_ComponentView2) {"use strict";_inherits(TrickleButtonView, _ComponentView2);var _super46 = _createSuper(TrickleButtonView);function TrickleButtonView() {_classCallCheck(this, TrickleButtonView);return _super46.apply(this, arguments);}_createClass(TrickleButtonView, [{ key: "events", value: function events()

      {
        return {
          "click .js-trickle-btn": "onButtonClick" };

      } }, { key: "calculateViewState", value: function calculateViewState()

      {
        var trickle = this.model.getTrickleConfig();
        var isEnabled = trickle._isEnabled && trickle._button._isEnabled;
        ...
        var isStepUnlocked = this.model.isStepUnlocked();
        var isButtonComplete = this.model.get('_isComplete');
        var isFinished = isStepUnlocked && isButtonComplete;

        var isButtonVisibleBeforeCompletion = trickle._button._styleBeforeCompletion === "visible" &&
        !(trickle._button._autoHide && trickle._button._isFullWidth);
        var isButtonVisibleAfterCompletion = trickle._button._styleAfterClick !== 'hidden';

        var isButtonVisible = !isStepUnlocked && isButtonVisibleBeforeCompletion ||
        isFinished && isButtonVisibleAfterCompletion ||
        isStepUnlocked && !isButtonComplete;

        var isButtonEnabledAfterCompletion = trickle._button._styleAfterClick !== "disabled";
        var isStepLockingEnabled = trickle._stepLocking._isEnabled;
        var isStepLockingCompletionRequired = trickle._stepLocking._isEnabled && trickle._stepLocking._isCompletionRequired;

        var isPopupOpen = Boolean(this.popupOpenCount);

        var isButtonEnabled = !isStepLockingEnabled ||
      ...
      {
        if (this.model.get('_isStepLockingCompletionRequired') && !this.model.get('_isComplete')) {var _this$listenTo2;
          this.listenTo(Adapt, {
            "popup:opened": this.onPopupOpened,
            "popup:closed": this.onPopupClosed });

          var parentModel = this.model.getParent();
          var completionAttribute = this.model.get('_completionAttribute');
          this.listenTo(parentModel, (_this$listenTo2 = {}, _defineProperty(_this$listenTo2, "bubble:change:".concat(
          completionAttribute), this.onStepUnlocked), _defineProperty(_this$listenTo2, "change:".concat(
          completionAttribute), this.onButtonComplete), _this$listenTo2));

        }
        this.listenTo(Adapt.parentView, {
          "postRemove": this.onRemove });

      } }, { key: "onStepUnlocked", value: function onStepUnlocked(

      event) {return new Promise(function ($return, $error) {
          if (event.value === false) return $return();
          this.calculateViewState();
          ...
          var parentModel = this.model.getParent();
          var completionAttribute = this.model.get('_completionAttribute');
          this.stopListening(parentModel, _defineProperty({}, "bubble:change:".concat(
          completionAttribute), this.onStepUnlocked));

          // Allow for popup open
          _.defer(this.beforeButtonClick.bind(this));return $return();}.bind(this));} }, { key: "beforeButtonClick", value: function beforeButtonClick()


      {
        this.updateDOM();
      } }, { key: "updateDOM", value: function updateDOM()
      ...
      } }, { key: "onPopupOpened", value: function onPopupOpened()
      ...
      {
        var trickle = this.model.getTrickleConfig();
        var scrollAfterClick = trickle._button._styleAfterClick === 'scroll';
        var canScroll = !this.model.get('_isStepLockingCompletionRequired') ||
      ...
      } }, { key: "onButtonComplete", value: function onButtonComplete(

      model, value) {return new Promise(function ($return, $error) {
          if (!value) {
            return $return();
          }
          this.afterButtonClick();
          return Promise.resolve(Adapt.trickle.continue()).then(function ($await_53) {try {
              Adapt.trickle.scroll(this.model);return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }, { key: "afterButtonClick", value: function afterButtonClick()
...

      {
        ...
        this.remove();
      } }]);return TrickleButtonView;}(ComponentView);
...
/**
     ...
     */
;
define('extensions/adapt-contrib-trickle/js/trickleButtonModel', [
'core/js/adapt',
'core/js/models/componentModel'],
function (Adapt, ComponentModel) {var

  TrickleButtonModel = /*#__PURE__*/function (_ComponentModel3) {"use strict";_inherits(TrickleButtonModel, _ComponentModel3);var _super47 = _createSuper(TrickleButtonModel);function TrickleButtonModel() {_classCallCheck(this, TrickleButtonModel);return _super47.apply(this, arguments);}_createClass(TrickleButtonModel, [{ key: "init", value: function init()

      {
        this.set('_completionAttribute', this.getCompletionAttribute());
        var config = this.getTrickleConfig();
        ...
        this.setCompletionStatus();
      } }, { key: "getCompletionAttribute", value: function getCompletionAttribute()

      {
        var trickle = Adapt.config.get('_trickle');
        if (!trickle) return "_isComplete";
        return trickle._completionAttribute || "_isComplete";
      } }, { key: "getTrickleConfig", value: function getTrickleConfig()

      {
        return Adapt.trickle.getModelConfig(this);
      } }, { key: "isStepUnlocked", value: function isStepUnlocked()

      {var _this108 = this;
        var completionAttribute = this.getCompletionAttribute();
        return !this.getSiblings().find(function (sibling) {_newArrowCheck(this, _this108);
          if (sibling === this.model) {
            return;
          }
          return !sibling.get(completionAttribute);
        }.bind(this));
      } }, { key: "setupStartAndFinalFlags", value: function setupStartAndFinalFlags()

      {var _this109 = this;
        var parent = this.getParent();
        var parentId = parent.get('_id');
        var siteId = parent.get('_trickleSiteChildId');
        var ancestors = this.getAncestorModels();
        var trickleParent = ancestors.find(function (model) {_newArrowCheck(this, _this109);return model.get('_trickleSiteParentId') === siteId;}.bind(this));
        var trickleSiblings = trickleParent.getAllDescendantModels(true).filter(function (model) {_newArrowCheck(this, _this109);
          return model.get('_isAvailable') && model.get('_trickleSiteChildId') === siteId;
        }.bind(this));
        var index = trickleSiblings.findIndex(function (model) {_newArrowCheck(this, _this109);return model.get('_id') === parentId;}.bind(this));
        this.set({
          _isButtonStart: index === 0,
          _isButtonFinal: index === trickleSiblings.length - 1 && !trickleParent.get('_canRequestChild') });

      } }]);return TrickleButtonModel;}(ComponentModel);
...
define('extensions/adapt-contrib-trickle/js/trickleButton', [
'core/js/adapt',
'./trickleButtonView',
'./trickleButtonModel'],
...
function (Adapt, ContentObjectModel) {
  ...
  Trickle = /*#__PURE__*/function (_Backbone$Controller8) {"use strict";_inherits(Trickle, _Backbone$Controller8);var _super48 = _createSuper(Trickle);function Trickle() {_classCallCheck(this, Trickle);return _super48.apply(this, arguments);}_createClass(Trickle, [{ key: "initialize", value: function initialize()

      {
        this.listenTo(Adapt, {
          'app:dataLoaded': this.onAppDataReady });

      } }, { key: "onAppDataReady", value: function onAppDataReady()

      {
        this.addTrickleComponents();
        this.setupEventListeners();
        this.setupLocking();
      } }, { key: "addTrickleComponents", value: function addTrickleComponents()

      {var _this110 = this;
        var models = Adapt.course.getAllDescendantModels(true);

        var TrickleModel = Adapt.getModelClass('trickle-button');
        var id = 0;

        // Collect all trickle button sites
        var buttonSites = models.reduce(function (buttonSites, model) {_newArrowCheck(this, _this110);
          var trickleConfig = this.getModelConfig(model);
        ...
        buttonSites.forEach(function (site) {var _this111 = this;_newArrowCheck(this, _this110);
          site.model.set('_trickleSiteParentId', site.id);
          site.models.forEach(function (model, index) {_newArrowCheck(this, _this111);
            model.set({
              '_isTrickled': true,
              '_trickleSiteChildId': site.id });

            var trickleModel = new TrickleModel({
              _id: "trickle-".concat(id++),
      ...
      } }, { key: "setupTrickleDefaults", value: function setupTrickleDefaults(

      model) {
        // Setup original trickle configuration with defaults
        var config = Adapt.trickle.getModelConfig(model);
        _.defaults(config, {
          _isEnabled: true,
          _autoScroll: true });
...

      {
        ...
        if (!trickle) return "_isComplete";
        return trickle._completionAttribute || "_isComplete";
      } }, { key: "getModelConfig", value: function getModelConfig(

      model) {
        var configId = model.get('_trickleConfigId');
        if (configId) {
          var inheritedConfig = Adapt.findById(configId).get('_trickle');
          return $.extend(true, {}, inheritedConfig, model.get('_trickle'));
        }
        return model.get("_trickle");
      } }, { key: "setModelConfig", value: function setModelConfig(

      model, config) {
        return model.set("_trickle", config);
      } }, { key: "setupLocking", value: function setupLocking()
      ...
      {var _this112 = this;
        ...
        var lockingGroups = models.reduce(function (lockingGroups, model) {var _this113 = this;_newArrowCheck(this, _this112);
          ...
          var group;
          if (trickleConfig._setOnChildren) {
            var firstChild = model.getAvailableChildModels()[0];
            if (firstChild) {
          ...
          if (group) {
            ...
            var setId = model.get('_id');
            group.forEach(function (item) {_newArrowCheck(this, _this113);
        ...
        _.flatten(lockingGroups).forEach(function (model) {var _this114 = this;_newArrowCheck(this, _this112);
          ...
          model.getAllDescendantModels(true).forEach(function (model) {_newArrowCheck(this, _this114);
            locks[model.get('_id')] = locks[model.get('_id')] || {
              id: model.get('_id'),
              model: model,
              isPrimary: false,
        ...
        lockingGroups.forEach(function (lockingModels) {var _this115 = this;_newArrowCheck(this, _this112);
          lockingModels.slice(1).forEach(function (model, previousIndex) {var _this116 = this;_newArrowCheck(this, _this115);
            ...
            var previousLockingModel = lockingModels[previousIndex];
            var config = this.getModelConfig(model);
            var isStepLocked = config && config._stepLocking && config._stepLocking._isEnabled;
            var isLocked = isStepLocked &&
            ...
            model.getAllDescendantModels(true).forEach(function (model) {_newArrowCheck(this, _this116);
              locks[model.get('_id')].newState = isLocked;
            }.bind(this));
          }.bind(this));
        }.bind(this));
        ...
        var changedLocks = Object.values(locks).filter(function (lock) {_newArrowCheck(this, _this112);return lock.previousState !== lock.newState;}.bind(this));
        changedLocks.forEach(function (lock) {_newArrowCheck(this, _this112);
          lock.model.set('_isLocked', lock.newState);
        }.bind(this));
        var addedLockCount = changedLocks.reduce(function (count, lock) {_newArrowCheck(this, _this112);
          if (lock.newState) count++;
          return count;
        }.bind(this), 0);
        var removedLockCount = changedLocks.reduce(function (count, lock) {_newArrowCheck(this, _this112);
          if (!lock.newState) count++;
          return count;
        }.bind(this), 0);
        ...
        Adapt.log.debug("TRICKLE: ".concat(changedLocks.length, " locks changed. ").concat(addedLockCount, " added, ").concat(removedLockCount, " removed."));

      } }, { key: "fetchLockingModels", value: function fetchLockingModels(

      child) {var _this117 = this;
        var allSiblings = child.getParent().getAvailableChildModels();
        var selfAndSubsequentSiblings = allSiblings.slice(allSiblings.findIndex(function (sibling) {_newArrowCheck(this, _this117);return sibling === child;}.bind(this)));

        var allParents = child.getAncestorModels();
        var inPageParents = allParents.slice(0, allParents.findIndex(function (parent) {_newArrowCheck(this, _this117);return parent instanceof ContentObjectModel;}.bind(this)) + 1);

        var lockingModels = selfAndSubsequentSiblings;
        inPageParents.slice(1).forEach(function (grandParent, previousIndex) {var _this118 = this;_newArrowCheck(this, _this117);
          var parent = inPageParents[previousIndex];
          var allChildren = grandParent.getAvailableChildModels();
          lockingModels.push.apply(lockingModels, _toConsumableArray(allChildren.slice(allChildren.findIndex(function (child) {_newArrowCheck(this, _this118);return child === parent;}.bind(this)) + 1)));
        }.bind(this));

        return lockingModels;
      } }, { key: "onAddChild", value: function onAddChild(
      ...
      event) {
        ...
        event.stop();
      } }, { key: "continue", value: function _continue() {return new Promise(function ($return, $error) {


          this.setupLocking();
          return Promise.resolve(Adapt.parentView.addChildren()).then(function ($await_54) {try {
              return Promise.resolve(Adapt.parentView.whenReady()).then(function ($await_55) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));} }, { key: "scroll", value: function scroll(


      fromModel) {return new Promise(function ($return, $error) {var _this119,
          trickle,
          scrollTo,
          ...
          duration;_this119 = this;trickle = Adapt.trickle.getModelConfig(fromModel);scrollTo = trickle._scrollTo;if (scrollTo === undefined) scrollTo = "@block +1";scrollToId = "";switch (scrollTo.substr(0, 1)) {case "@":relativeModel = fromModel.findRelativeModel(scrollTo, { filter: function filter(model) {_newArrowCheck(this, _this119);return model.get("_isAvailable");}.bind(this) });if (relativeModel === undefined) return $return();scrollToId = relativeModel.get("_id");break;case ".": // NAVIGATE BY CLASS
              scrollToId = scrollTo.substr(1, scrollTo.length - 1);break;default:scrollToId = scrollTo;}if (scrollToId == "") return $return();return Promise.resolve(Adapt.parentView.renderTo(scrollToId)).then(function ($await_56) {try {$("." + scrollToId).focusOrNext();isAutoScrollOff = !trickle._autoScroll;if (isAutoScrollOff) {return $return(false);}duration = this.getModelConfig(fromModel)._scrollDuration || 500;Adapt.scrollTo("." + scrollToId, { duration: duration });return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} }]);return Trickle;}(Backbone.Controller);
...
define('extensions/adapt-infiniteScroll/js/adapt-infiniteScroll', [
'core/js/adapt',
'core/js/models/menuModel'],
function (Adapt, MenuModel) {var

  InfiniteScroll = /*#__PURE__*/function (_Backbone$Controller9) {"use strict";_inherits(InfiniteScroll, _Backbone$Controller9);var _super49 = _createSuper(InfiniteScroll);function InfiniteScroll() {_classCallCheck(this, InfiniteScroll);return _super49.apply(this, arguments);}_createClass(InfiniteScroll, [{ key: "initialize", value: function initialize()
      ...
      {
        var config = Adapt.course.get('_infiniteScroll');
        if (!config || !config._isEnabled) return;
        this.setupEventListeners();
      } }, { key: "setupEventListeners", value: function setupEventListeners()
      ...
      event) {var _this120 = this;
        // Never infinite scroll menus
        if (this.isMenu()) {
          return;
        }

        var expectedNextModel = Adapt.parentView.model.getAllDescendantModels(true).find(function (model) {_newArrowCheck(this, _this120);
        ...
        var hasNoChildren = !event.model.getChildren().length;
        if (hasNoChildren || !event.model.hasManagedChildren) {
          // Always render childless views
          this.listenToOnce(event, 'closed', function () {_newArrowCheck(this, _this120);
        ...
        var immediate = this.shouldStopLoading();
      ...
      } }, { key: "onReadyChange", value: function onReadyChange(
      ...
      model, value) {
        ...
        Adapt.parentView.addChildren();
      } }, { key: "shouldStopLoading", value: function shouldStopLoading()

      {
        var scrollTop = $(window).scrollTop();
        var windowInnerHeight = $(window).innerHeight();
        var parentHeight = Adapt.parentView.$el.height();
        var remainingParent = parentHeight - scrollTop;
        var shouldStopLoading = remainingParent >= windowInnerHeight * 1.5;
        return shouldStopLoading;
      } }, { key: "isMenu", value: function isMenu()

      {
        return Adapt.parentView && Adapt.parentView.model instanceof MenuModel;
      } }, { key: "isReady", value: function isReady()
...

      {
        ...
        Adapt.parentView.addChildren();
      } }]);return InfiniteScroll;}(Backbone.Controller);
...
;
define("plugins", ["components/adapt-contrib-accordion/js/adapt-contrib-accordion", "components/adapt-contrib-assessmentResults/js/adapt-contrib-assessmentResults", "components/adapt-contrib-blank/js/adapt-contrib-blank", "components/adapt-contrib-gmcq/js/adapt-contrib-gmcq", "components/adapt-contrib-graphic/js/adapt-contrib-graphic", "components/adapt-contrib-hotgraphic/js/adapt-contrib-hotgraphic", "components/adapt-contrib-matching/js/adapt-contrib-matching", "components/adapt-contrib-mcq/js/adapt-contrib-mcq", "components/adapt-contrib-media/js/adapt-contrib-media", "components/adapt-contrib-narrative/js/adapt-contrib-narrative", "components/adapt-contrib-slider/js/adapt-contrib-slider", "components/adapt-contrib-text/js/adapt-contrib-text", "components/adapt-contrib-textInput/js/adapt-contrib-textInput", "extensions/adapt-branching/js/adapt-branching", "extensions/adapt-contentObjectTransition/js/adapt-contentObjectTransition", "extensions/adapt-contrib-assessment/js/adapt-assessmentArticleExtension", "extensions/adapt-contrib-bookmarking/js/adapt-contrib-bookmarking", "extensions/adapt-contrib-languagePicker/js/adapt-languagePicker", "extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress", "extensions/adapt-contrib-resources/js/adapt-contrib-resources", "extensions/adapt-contrib-spoor/js/adapt-contrib-spoor", "extensions/adapt-contrib-trickle/js/adapt-contrib-trickle", "extensions/adapt-contrib-tutor/js/adapt-contrib-tutor", "extensions/adapt-infiniteScroll/js/adapt-infiniteScroll", "menu/adapt-contrib-boxMenu/js/adapt-contrib-boxMenu", "theme/adapt-contrib-vanilla/js/theme"], function () {});
