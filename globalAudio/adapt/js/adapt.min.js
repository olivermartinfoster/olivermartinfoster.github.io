require(['html-react-parser', 'semver', 'bowser', 'react-dom', 'libraries/mediaelement-and-player', 'libraries/rangeslider', 'handlebars', 'libraries/SCORM_API_wrapper', 'underscore', 'react'], function (HTMLReactParser, semver, Bowser, ReactDOM$1, mediaelementAndPlayer, rangeslider, Handlebars$1, pipwerks, _$1, React) { 'use strict';
  ...
  function find(hierarchy, iterator) {
    ...
    if (Array.isArray(hierarchy.props.children)) {
      return hierarchy.props.children.find(function (child) {
        if (!child) return;
  ...
  function clone(value) {
    ...
    var cloned = Array.isArray(value) ? [] : {};
    ...
    for (var name in descriptors) {
      ...
      if (_typeof(_value) === 'object' && _value !== null) {
        if (isDeep) {
          _value = descriptor.value = clone(_value, isDeep, modifier);
        }

        if (modifier && _typeof(_value.$$typeof) === 'symbol') {
          modifier(_value);
        }
      }
    ...
    if (modifier && _typeof(cloned.$$typeof) === 'symbol') {
      modifier(cloned);
    }
  ...
  function render(name) {
    ...
    var component = template.apply(void 0, args);
    return component;
  }
  ...
  function applyImgLoadingFix() {
    ...
    Adapt.on('reactTemplate:postRender', function (event) {
      var hasImageTagWithNoLoadingAttr = find(event.value, function (component) {
        if (component.type !== 'img') return;
        if (component.props.loading) return;
        return true;
      });
      if (!hasImageTagWithNoLoadingAttr) return;
      event.value = clone(event.value, true, function (component) {
        if (component.type !== 'img') return;
        if (component.props.loading) return;
  ...
  var AdaptView = function (_Backbone$View) {
    ...
    _createClass(AdaptView, [{
      ...
      value: function changed() {
        ...
        var element = render(this.constructor.template.replace('.jsx', ''), this.model, this);
        this.updateViewProperties();
        ReactDOM__default['default'].render(element, this.el);
      }
    }, {
  ...
  var MediaView = function (_ComponentView) {
    ...
    _createClass(MediaView, [{
      ...
      value: function setupPlayer() {
        ...
        this.addThirdPartyFixes(modelOptions, function () {
          ...
          if (!_media.mp3 && !_media.mp4 && !_media.ogv && !_media.webm && !_media.source) {
            Adapt.log.warn('ERROR! No media is selected in components.json for component ' + _this.model.get('_id'));
      ...
      key: "onMediaElementInview",
      value: function onMediaElementInview(event, isInView) {
      ...
      value: function onSkipToTranscript() {
        ...
        _.delay(function () {
          Adapt.a11y.focus(_this3.$('.media__transcript-btn'));
        }, 250);
      }
    }, {
  ...
  var Bookmarking = function (_Backbone$Controller) {
    ...
    _createClass(Bookmarking, [{
      ...
      value: function checkLocation() {
        ...
        var possibleViewIds = currentModel.findDescendantModels(this.bookmarkLevel + 's').map(function (desc) {
          return desc.get('_id');
        });
  ...
  __AMD("extensions/adapt-contrib-resources/js/adapt-contrib-resourcesHelpers", helpers);
  ...
  var _ScormError = ScormError$1,
      CLIENT_COULD_NOT_CONNECT = _ScormError.CLIENT_COULD_NOT_CONNECT,
      SERVER_STATUS_UNSUPPORTED = _ScormError.SERVER_STATUS_UNSUPPORTED,
      CLIENT_STATUS_UNSUPPORTED = _ScormError.CLIENT_STATUS_UNSUPPORTED,
      CLIENT_COULD_NOT_COMMIT = _ScormError.CLIENT_COULD_NOT_COMMIT,
      CLIENT_NOT_CONNECTED = _ScormError.CLIENT_NOT_CONNECTED,
      CLIENT_COULD_NOT_FINISH = _ScormError.CLIENT_COULD_NOT_FINISH,
      CLIENT_COULD_NOT_GET_PROPERTY = _ScormError.CLIENT_COULD_NOT_GET_PROPERTY,
      CLIENT_COULD_NOT_SET_PROPERTY = _ScormError.CLIENT_COULD_NOT_SET_PROPERTY,
  ...
  var ComponentSerializer = function (_Backbone$Controller) {
    ...
    _createClass(ComponentSerializer, [{
      ...
      key: "serialize",
      value: function serialize(shouldStoreResponses, shouldStoreAttempts) {
        var _this = this;
  ...
  var StatefulSession = function (_Backbone$Controller) {
    ...
    _createClass(StatefulSession, [{
      ...
      value: function saveSessionState() {
        ...
        var componentStates = this._componentSerializer.serialize(this._shouldStoreResponses, this._shouldStoreAttempts);
  ...
  var DOMModifier = function DOMModifier(_ref2) {
    var _ref2$elementFilter = _ref2.elementFilter,
        elementFilter = _ref2$elementFilter === void 0 ? function () {} : _ref2$elementFilter,
        _ref2$onElementAdd = _ref2.onElementAdd,
        onElementAdd = _ref2$onElementAdd === void 0 ? function () {} : _ref2$onElementAdd,
        _ref2$onElementRemove = _ref2.onElementRemove,
        onElementRemove = _ref2$onElementRemove === void 0 ? function () {} : _ref2$onElementRemove;
    ...
    function filter(list, prop) {
      ...
      var foundNodes = elementNodes.reduce(function (nodes, el) {
        return nodes.concat([el].concat(_toConsumableArray($(el).find('*').toArray())).filter(elementFilter));
      }, []);
      return foundNodes;
    }

    var observer = new MutationObserver(function (list, observer) {
      var added = filter(list, 'addedNodes');
      var removed = filter(list, 'removedNodes');
  ...
  var AudioView = __AMD("extensions/adapt-globalAudio/js/AudioView", function (_Backbone$View) {
    _inherits(AudioView, _Backbone$View);

    var _super = _createSuper(AudioView);

    function AudioView() {
      _classCallCheck(this, AudioView);

      return _super.apply(this, arguments);
    }

    _createClass(AudioView, [{
      key: "namedConfig",
      get: function () {
        var _this$config,
            _this$config$_items,
            _this$config$_items$f,
            _this = this;

        return (_this$config = this.config) === null || _this$config === void 0 ? void 0 : (_this$config$_items = _this$config._items) === null || _this$config$_items === void 0 ? void 0 : (_this$config$_items$f = _this$config$_items.find) === null || _this$config$_items$f === void 0 ? void 0 : _this$config$_items$f.call(_this$config$_items, function (item) {
          return item._name === _this.$el.attr('name');
        });
      }
    }, {
      key: "src",
      get: function () {
        var _this$namedConfig;

        return ((_this$namedConfig = this.namedConfig) === null || _this$namedConfig === void 0 ? void 0 : _this$namedConfig._src) || '';
      }
    }, {
      key: "controls",
      get: function () {
      ...
      key: "initialize",
      value: function initialize() {
        ___default['default'].bindAll(this, 'render', 'onScreenChange', 'update', 'onDataReady', 'onTimeUpdate');
      ...
      key: "onOffScreen",
      value: function () {
        var _onOffScreen = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  if (!(this.isPaused || this.hasUserPaused)) {
                    _context.next = 2;
                    break;
                  }
        ...
        function onOffScreen() {
          return _onOffScreen.apply(this, arguments);
        }
      ...
      key: "onOnScreen",
      value: function () {
        var _onOnScreen = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
        ...
        function onOnScreen() {
          return _onOnScreen.apply(this, arguments);
        }
      ...
      key: "play",
      value: function () {
        var _play = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
          var _this2 = this;
              ...
              switch (_context3.prev = _context3.next) {
                case 0:
                  return _context3.abrupt("return", new Promise(function (resolve) {
                    setTimeout(function () {
                      var _Adapt$globalAudio$au;

                      var isFinished = _this2.audioTag.currentSeconds === _this2.audioTag.duration - 1;

                      if (isFinished) {
                        if (!_this2.isPaused) _this2.audioTag.pause();
                      }

                      if (((_Adapt$globalAudio$au = Adapt.globalAudio.audioContext) === null || _Adapt$globalAudio$au === void 0 ? void 0 : _Adapt$globalAudio$au.state) !== 'suspended') {
      ...
      key: "rewind",
      value: function () {
        var _rewind = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
          var _Adapt$globalAudio$au2;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  if (!isPaused && ((_Adapt$globalAudio$au2 = Adapt.globalAudio.audioContext) === null || _Adapt$globalAudio$au2 === void 0 ? void 0 : _Adapt$globalAudio$au2.state) !== 'suspended') {
                    this.audioTag.play();
                  }
      ...
      key: "togglePlayPause",
      value: function () {
        var _togglePlayPause = _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
          return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  return _context5.abrupt("return", this.play());
      ...
      key: "render",
      value: function () {
        var _render = _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
          return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  this.$el.html(Handlebars.templates.globalAudio(_objectSpread2(_objectSpread2({}, this.config), {}, {
                    _src: this.src
                  })));
                  ...
                  _context6.next = 9;
                  return Adapt.globalAudio.whenResumed();
      ...
      key: "onDataReady",
      value: function () {
        var _onDataReady = _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
      ...
      value: function update() {
        var _globals$_extensions, _globals$_extensions$, _globals$_extensions2, _globals$_extensions3, _globals$_extensions4, _globals$_extensions5;

        this.$player.toggleClass('is-globalaudio-playing', !this.isPaused);
        this.$player.toggleClass('is-globalaudio-paused', this.isPaused);
        var globals = Adapt.course.get('_globals');
        var ariaLabel = ((globals === null || globals === void 0 ? void 0 : (_globals$_extensions = globals._extensions) === null || _globals$_extensions === void 0 ? void 0 : (_globals$_extensions$ = _globals$_extensions._globalAudio) === null || _globals$_extensions$ === void 0 ? void 0 : _globals$_extensions$.ariaRegion) || 'Audio Player') + ', ' + (this.isPaused ? (globals === null || globals === void 0 ? void 0 : (_globals$_extensions2 = globals._extensions) === null || _globals$_extensions2 === void 0 ? void 0 : (_globals$_extensions3 = _globals$_extensions2._globalAudio) === null || _globals$_extensions3 === void 0 ? void 0 : _globals$_extensions3.play) || 'play' : (globals === null || globals === void 0 ? void 0 : (_globals$_extensions4 = globals._extensions) === null || _globals$_extensions4 === void 0 ? void 0 : (_globals$_extensions5 = _globals$_extensions4._globalAudio) === null || _globals$_extensions5 === void 0 ? void 0 : _globals$_extensions5.pause) || 'pause');
        this.$player.find('.globalaudio__playpause').attr('aria-label', ariaLabel);
      }
    }, {
      key: "onPlayPauseClick",
      value: function () {
        var _onPlayPauseClick = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(event) {
        ...
        function onPlayPauseClick(_x) {
          return _onPlayPauseClick.apply(this, arguments);
        }
      ...
      value: function remove() {
        ...
        _get(_getPrototypeOf(AudioView.prototype), "remove", this).call(this);
      }
    }]);
  ...
  var GlobalAudio = function (_Backbone$Controller) {
    _inherits(GlobalAudio, _Backbone$Controller);

    var _super = _createSuper(GlobalAudio);

    function GlobalAudio() {
      _classCallCheck(this, GlobalAudio);

      return _super.apply(this, arguments);
    }

    _createClass(GlobalAudio, [{
      key: "initialize",
      value: function initialize() {
      ...
      key: "whenResumed",
      value: function () {
        var _whenResumed = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
          var _this = this;
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  return _context.abrupt("return", new Promise(function (resolve) {
                    if (_this.isResumed) return resolve();

                    _this.once('resumed', resolve);
                  }));
        ...
        function whenResumed() {
          return _whenResumed.apply(this, arguments);
        }
      ...
      value: function onDataReady() {
        var config = Adapt.course.get('_globalAudio');
        if (!(config !== null && config !== void 0 && config._isEnabled)) return;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    _context2.prev = 2;
                    _context2.next = 5;
                    return _this2.audioContext.resume();

                  case 5:
                    document.removeEventListener('click', resume);
                    _this2.isResumed = true;

                    _this2.trigger('resumed');
      ...
      value: function setUp() {
        Handlebars.registerHelper('ga', function (context) {
          return new Handlebars.SafeString("<div data-globalaudio=\"true\" ".concat(Object.entries(context.hash).map(function (_ref2) {
            var _ref3 = _slicedToArray(_ref2, 2),
                name = _ref3[0],
                value = _ref3[1];
  ...
  __AMD("extensions/adapt-globalAudio/js/adapt-globalAudio", Adapt.globalAudio = new GlobalAudio());
  ...
  var ThemeView = Backbone.View.extend({
    ...
    setResponsiveClasses: function () {
      ...
      this.$el.removeClass(Object.values(responsiveClasses)).addClass(responsiveClasses["_".concat(Adapt.device.screenSize)]);
    },
  ...
  register("component", function (model, view) {
    var data = model.toJSON();
    data._globals = Adapt.course.get('_globals');
    view.jsxHeading = view.jsxHeading || React__default['default'].createRef();
    view.jsxComponentDescription = view.jsxComponentDescription || React__default['default'].createRef();
    var displayTitle = data.displayTitle,
        body = data.body,
        instruction = data.instruction,
        mobileInstruction = data.mobileInstruction,
        _component = data._component,
        _disableAccessibilityState = data._disableAccessibilityState;

    var type = _component.toLowerCase();

    var sizedInstruction = mobileInstruction && Adapt.device.screenSize !== 'large' ? mobileInstruction : instruction;
    return (displayTitle || body || sizedInstruction) && React__default['default'].createElement("div", {
      className: classes(['component__header', "".concat(type, "__header")])
    }, React__default['default'].createElement("div", {
      className: classes(['component__header-inner', "".concat(type, "__header-inner")])
    }, displayTitle && React__default['default'].createElement("div", {
      className: classes(['component__title', "".concat(type, "__title")])
    }, !_disableAccessibilityState && React__default['default'].createElement("div", {
      className: "js-heading",
      ref: view.jsxHeading
    }), React__default['default'].createElement("div", {
      className: classes(['component__title-inner', "".concat(type, "__title-inner")]),
      "aria-hidden": !_disableAccessibilityState
    }, html(compile(displayTitle, data)))), html(helper('component_description', data), view.jsxComponentDescription), body && React__default['default'].createElement("div", {
      className: classes(['component__body', "".concat(type, "__body")])
    }, React__default['default'].createElement("div", {
      className: classes(['component__body-inner', "".concat(type, "__body-inner")])
    }, html(compile(body, data)))), sizedInstruction && React__default['default'].createElement("div", {
      className: classes(['component__instruction', "".concat(type, "__instruction")])
    }, React__default['default'].createElement("div", {
      className: classes(['component__instruction-inner', "".concat(type, "__instruction-inner")])
