...
function (Wait) {var
  ...
  Adapt = /*#__PURE__*/function (_Backbone$Model) {"use strict";_inherits(Adapt, _Backbone$Model);var _super = _createSuper(Adapt);function Adapt() {_classCallCheck(this, Adapt);return _super.apply(this, arguments);}_createClass(Adapt, [{ key: "initialize", value: function initialize()
      ...
      id) {var _this9 = this;
        ...
        var foundView = idPathToView.reduce(function (view, currentId) {_newArrowCheck(this, _this9);
...

      {
        ...
        $('html').toggleClass('disable-animation', disableAnimation === true);
      } }, { key: "remove", value: function () {var _remove = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var currentView;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                  ...
                  this.trigger('preRemove', currentView);_context.next = 5;return (
...
function (Adapt) {var
  ...
  BuildModel = /*#__PURE__*/function (_Backbone$Model2) {"use strict";_inherits(BuildModel, _Backbone$Model2);var _super5 = _createSuper(BuildModel);function BuildModel() {_classCallCheck(this, BuildModel);return _super5.apply(this, arguments);}_createClass(BuildModel, [{ key: "defaults", value: function defaults()
      ...
      attrs, options) {var _this10 = this;
        ...
        this.fetch({
          success: function success() {_newArrowCheck(this, _this10);
            this.isLoaded = true;
            Adapt.trigger('buildModel:dataLoaded');
          }.bind(this),
          error: function error() {_newArrowCheck(this, _this10);
      ...
      {var _this11 = this;
        ...
        return new Promise(function (resolve) {_newArrowCheck(this, _this11);
...
function (Adapt) {var
  ...
  ConfigModel = /*#__PURE__*/function (_Backbone$Model3) {"use strict";_inherits(ConfigModel, _Backbone$Model3);var _super6 = _createSuper(ConfigModel);function ConfigModel() {_classCallCheck(this, ConfigModel);return _super6.apply(this, arguments);}_createClass(ConfigModel, [{ key: "defaults", value: function defaults()
      ...
      attrs, options) {var _this12 = this;
        this.url = options.url;
        // Fetch data & if successful trigger event to enable plugins to stop course files loading
        // Then check if course files can load
        // 'configModel:loadCourseData' event starts the core content collections and models being fetched
        this.fetch({
          success: function success() {var _this13 = this;_newArrowCheck(this, _this12);
            Adapt.trigger('offlineStorage:prepare');
            Adapt.wait.queue(function () {_newArrowCheck(this, _this13);
              Adapt.trigger('configModel:dataLoaded');
              if (!this.get('_canLoadData')) return;
              Adapt.trigger('configModel:loadCourseData');
            }.bind(this));
          }.bind(this),
          error: function error() {_newArrowCheck(this, _this12);return console.log('Unable to load course/config.json');}.bind(this) });
...
function (Adapt, ModelEvent) {var
  ...
  AdaptModel = /*#__PURE__*/function (_Backbone$Model4) {"use strict";_inherits(AdaptModel, _Backbone$Model4);var _super7 = _createSuper(AdaptModel);function AdaptModel() {_classCallCheck(this, AdaptModel);return _super7.apply(this, arguments);}_createClass(AdaptModel, [{ key: "defaults", value: function defaults()
      ...
      {var _this14 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this14);
          if (this.hasManagedChildren) {
      ...
      {var _this15 = this;
        ...
        function () {_newArrowCheck(this, _this15);

          // Flag that the function is awaiting trigger
          this.triggerTrackableState.isQueued = true;

        }.bind(this),
        _.debounce(function () {_newArrowCheck(this, _this15);
        ...
        this.listenTo(this, 'change', function (_ref) {var _this16 = this;var changed = _ref.changed;_newArrowCheck(this, _this15);
          ...
          var isTrackable = changedPropertyNames.find(function (item) {_newArrowCheck(this, _this16);
      ...
      {var _this17 = this;
        ...
        if (children.find(function (child) {_newArrowCheck(this, _this17);return child.get('_isReady') === false;}.bind(this))) {
          return;
        }
      ...
      {var _this18 = this;var completionAttribute = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '_isComplete';
        var completed = false;
        var children = this.getAvailableChildModels();
        ...
        if (requireCompletionOf === -1) {// a value of -1 indicates that ALL mandatory children must be completed
          completed = children.every(function (child) {_newArrowCheck(this, _this18);
            return child.get(completionAttribute) || child.get('_isOptional');
          }.bind(this));
        } else {
          completed = children.filter(function (child) {_newArrowCheck(this, _this18);
            return child.get(completionAttribute) && !child.get('_isOptional');
      ...
      {var _this19 = this;
        ...
        return this._typeGroups = _.uniq(typeGroups.filter(Boolean).map(function (s) {_newArrowCheck(this, _this19);return s.toLowerCase();}.bind(this)));
      }
      ...
      descendants, options) {var _this20 = this;
        var allDescendantsModels = this.getAllDescendantModels();
        var returnedDescendants = allDescendantsModels.filter(function (model) {_newArrowCheck(this, _this20);
        ...
        if (options.where) {
          return returnedDescendants.filter(function (descendant) {_newArrowCheck(this, _this20);
      ...
      isParentFirst) {var _this21 = this;
        ...
        children.models.forEach(function (child) {_newArrowCheck(this, _this21);
      ...
      relativeString) {var _this22 = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        ...
        var modelIndex = pageDescendants.findIndex(function (pageDescendant) {_newArrowCheck(this, _this22);
        ...
        if (options.loop) {
          ...
          var totalOfType = pageDescendants.reduce(function (count, model) {_newArrowCheck(this, _this22);
      ...
      {var _this23 = this;
        ...
        if (!this.hasManagedChildren) {
          ...
          var id = this.get('_id');
          var children = Adapt.data.filter(function (model) {_newArrowCheck(this, _this23);return model.get('_parentId') === id;}.bind(this));
...

      {
        ...
        if (!parentId) return;
        var parent = Adapt.findById(parentId);
      ...
      passSiblingsAndIncludeSelf) {var _this24 = this;
        var id = this.get('_id');
        var parentId = this.get('_parentId');
        var siblings;
        if (!passSiblingsAndIncludeSelf) {
          ...
          siblings = Adapt.data.filter(function (model) {_newArrowCheck(this, _this24);
      ...
      {var _this25 = this;for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {args[_key11] = arguments[_key11];}
        ...
        var children = this.getChildren();
        children.models.forEach(function (child) {_newArrowCheck(this, _this25);return child.setOnChildren.apply(child, args);}.bind(this));
      ...
      {var _this26 = this;
        var children = this.getAvailableChildModels();
        children.forEach(function (child) {_newArrowCheck(this, _this26);
...
function (Adapt, AdaptCollection, BuildModel, ConfigModel, CourseModel) {var
  ...
  Data = /*#__PURE__*/function (_AdaptCollection) {"use strict";_inherits(Data, _AdaptCollection);var _super11 = _createSuper(Data);function Data() {_classCallCheck(this, Data);return _super11.apply(this, arguments);}_createClass(Data, [{ key: "model", value: function model(
      ...
      } }, { key: "init", value: function () {var _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:


                  Adapt.build = new BuildModel(null, { url: 'adapt/js/build.min.js', reset: true });_context2.next = 3;return (
                    Adapt.build.whenReady());case 3:
                  $('html').attr('data-adapt-framework-version', Adapt.build.get('package').version);
                  this.loadConfigData();case 5:case "end":return _context2.stop();}}}, _callee2, this);}));function init() {return _init.apply(this, arguments);}return init;}() }, { key: "loadConfigData", value: function loadConfigData()
      ...
      } }, { key: "loadCourseData", value: function () {var _loadCourseData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(

        newLanguage) {var language, courseFolder;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:

                  // All code that needs to run before adapt starts should go here
                  language = Adapt.config.get('_activeLanguage');
                  courseFolder = 'course/' + language + '/';

                  $('html').attr('lang', language);_context3.next = 5;return (

                    this.loadManifestFiles(courseFolder));case 5:_context3.next = 7;return (
                    this.triggerDataLoaded());case 7:_context3.next = 9;return (
                    this.triggerDataReady(newLanguage));case 9:
                  this.triggerInit();case 10:case "end":return _context3.stop();}}}, _callee3, this);}));function loadCourseData(_x) {return _loadCourseData.apply(this, arguments);}return loadCourseData;}() }, { key: "getJSON", value: function getJSON(



      path) {var _this28 = this;
        return new Promise(function (resolve, reject) {var _this29 = this;_newArrowCheck(this, _this28);
          $.getJSON(path, function (data) {_newArrowCheck(this, _this29);
            // Add path to data incase it's necessary later
            data.__path__ = path;
            resolve(data);
          }.bind(this)).fail(reject);
        }.bind(this));
      } }, { key: "loadManifestFiles", value: function () {var _loadManifestFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(

        languagePath) {var _this30 = this;var manifestPath, manifest, allFileData, allModelData, course;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                  this.trigger('loading');
                  this.reset();
                  manifestPath = languagePath + 'language_data_manifest.js';_context4.prev = 3;_context4.next = 6;return (


                    this.getJSON(manifestPath));case 6:manifest = _context4.sent;_context4.next = 13;break;case 9:_context4.prev = 9;_context4.t0 = _context4["catch"](3);

                  manifest = ['course.json', 'contentObjects.json', 'articles.json', 'blocks.json', 'components.json'];
                  Adapt.log.warnOnce("Manifest path '".concat(manifestPath, " not found. Using traditional files: ").concat(manifest.join(', ')));case 13:_context4.next = 15;return (

                    Promise.all(manifest.map(function (filePath) {_newArrowCheck(this, _this30);
                      return this.getJSON("".concat(languagePath).concat(filePath));
                    }.bind(this))));case 15:allFileData = _context4.sent;
                  // Flatten all file data into a single array of model data
                  allModelData = allFileData.reduce(function (result, fileData) {_newArrowCheck(this, _this30);
                  ...
                  course = allModelData.find(function (modelData) {_newArrowCheck(this, _this30);return modelData._type === 'course';}.bind(this));if (
                  course) {_context4.next = 20;break;}throw (
                    new Error("Expected a model data with \"_type\": \"course\", none found."));case 20:

                  this.push(course);
                  // Add other models
                  allModelData.forEach(function (modelData) {_newArrowCheck(this, _this30);
                  ...
                  this.trigger('reset');
                  this.trigger('loaded');_context4.next = 27;return (
                    Adapt.wait.queue());case 27:case "end":return _context4.stop();}}}, _callee4, this, [[3, 9]]);}));function loadManifestFiles(_x2) {return _loadManifestFiles.apply(this, arguments);}return loadManifestFiles;}() }, { key: "triggerDataLoaded", value: function () {var _triggerDataLoaded = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                  ...
                  try {
                    ...
                    Adapt.wait.queue());case 4:case "end":return _context5.stop();}}}, _callee5);}));function triggerDataLoaded() {return _triggerDataLoaded.apply(this, arguments);}return triggerDataLoaded;}() }, { key: "triggerDataReady", value: function () {var _triggerDataReady = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(


        newLanguage) {var _this31 = this;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
                  if (newLanguage) {
                    Adapt.trigger('app:languageChanged', newLanguage);
                    _.defer(function () {_newArrowCheck(this, _this31);
                      Adapt.startController.loadCourseData();
                  ...
                  try {
                    ...
                    Adapt.wait.queue());case 5:case "end":return _context6.stop();}}}, _callee6, this);}));function triggerDataReady(_x3) {return _triggerDataReady.apply(this, arguments);}return triggerDataReady;}() }, { key: "triggerInit", value: function triggerInit()
      ...
      {var _this32 = this;
        ...
        return new Promise(function (resolve) {_newArrowCheck(this, _this32);
          this.once('ready', resolve);
        }.bind(this));
      }
...
function (Adapt, RouterModel, CourseModel, ContentObjectModel, MenuModel) {var
  ...
  Router = /*#__PURE__*/function (_Backbone$Router) {"use strict";_inherits(Router, _Backbone$Router);var _super13 = _createSuper(Router);function Router() {_classCallCheck(this, Router);return _super13.apply(this, arguments);}_createClass(Router, [{ key: "routes", value: function routes()
      ...
      {var _this33 = this;
        ...
        filter(Boolean).join(' | ');
        this.listenToOnce(Adapt, 'contentObjectView:preRender', function () {_newArrowCheck(this, _this33);
      ...
      args) {var _this34 = this;
        args = args.filter(function (v) {_newArrowCheck(this, _this34);return v !== null;}.bind(this));
      ...
      {var _this35 = this;for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {args[_key13] = arguments[_key13];}
        args = args.filter(function (v) {_newArrowCheck(this, _this35);return v !== null;}.bind(this));
      ...
      } }, { key: "handlePluginRouter", value: function () {var _handlePluginRouter = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(

        pluginName, location, action) {var pluginLocation;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
                  pluginLocation = [
                  pluginName,
                  location && "-".concat(location),
                  action && "-".concat(action)].
                  filter(Boolean).join('');_context7.next = 3;return (
                    this.updateLocation(pluginLocation, null, null, null));case 3:

                  Adapt.trigger('router:plugin:' + pluginName, pluginName, location, action);
                  Adapt.trigger('router:plugin', pluginName, location, action);
                  this.model.set('_canNavigate', true, { pluginName: 'adapt' });case 6:case "end":return _context7.stop();}}}, _callee7, this);}));function handlePluginRouter(_x4, _x5, _x6) {return _handlePluginRouter.apply(this, arguments);}return handlePluginRouter;}() }, { key: "handleId", value: function () {var _handleId = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(


        id) {var _this36 = this;var rootModel, model, isContentObject, isRoot, startController, isCourse, type, location, ViewClass, isMenu;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
                  rootModel = Adapt.router.rootModel;
                  model = !id ? rootModel : Adapt.findById(id);if (

                  model) {_context8.next = 5;break;}
                  // Bad id
                  this.model.set('_canNavigate', true, { pluginName: 'adapt' });return _context8.abrupt("return");case 5:



                  id = model.get('_id');

                  isContentObject = model instanceof ContentObjectModel;if (
                  isContentObject) {_context8.next = 11;break;}
                  // Allow navigation.
                  this.model.set('_canNavigate', true, { pluginName: 'adapt' });
                  // Scroll to element
                  Adapt.navigateToElement('.' + id, { replace: true });return _context8.abrupt("return");case 11:



                  isRoot = model === rootModel;if (!(
                  isRoot && Adapt.course.has('_start'))) {_context8.next = 16;break;}
                  // Do not allow access to the menu when the start controller is enabled.
                  startController = Adapt.course.get('_start');if (!(
                  startController._isEnabled === true && startController._isMenuDisabled === true)) {_context8.next = 16;break;}return _context8.abrupt("return");case 16:if (!(




                  model.get('_isLocked') && Adapt.config.get('_forceRouteLocking'))) {_context8.next = 22;break;}
                  // Locked id
                  Adapt.log.warn('Unable to navigate to locked id: ' + id);
                  this.model.set('_canNavigate', true, { pluginName: 'adapt' });if (!(
                  Adapt.location._previousId === undefined)) {_context8.next = 21;break;}return _context8.abrupt("return",
                  this.navigate('#/', { trigger: true, replace: true }));case 21:return _context8.abrupt("return",

                  this.navigateBack());case 22:


                  // Move to a content object
                  this.showLoading();_context8.next = 25;return (
                    Adapt.remove());case 25:
                  ...
                  model.set('_isVisited', true);_context8.next = 31;return (
                    this.updateLocation(location, type, id, model));case 31:

                  Adapt.once('contentObjectView:ready', function () {_newArrowCheck(this, _this36);
                    // Allow navigation.
                    this.model.set('_canNavigate', true, { pluginName: 'adapt' });
                  ...
                  !ViewClass && isMenu)) {_context8.next = 38;break;}
                  Adapt.log.deprecated("Using event based menu view instantiation for '".concat(Adapt.getViewName(model), "'"));return _context8.abrupt("return");case 38:


                  this.$wrapper.append(new ViewClass({ model: model }).$el);case 39:case "end":return _context8.stop();}}}, _callee8, this);}));function handleId(_x7) {return _handleId.apply(this, arguments);}return handleId;}() }, { key: "updateLocation", value: function () {var _updateLocation = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(


        currentLocation, type, id, currentModel) {return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:
                  ...
                  Adapt.trigger('router:location', Adapt.location);_context9.next = 13;return (

                    Adapt.wait.queue());case 13:case "end":return _context9.stop();}}}, _callee9, this);}));function updateLocation(_x8, _x9, _x10, _x11) {return _updateLocation.apply(this, arguments);}return updateLocation;}() }, { key: "setGlobalClasses", value: function setGlobalClasses()
      ...
      /**
         ...
         * You may also include a `replace` property that you can set to `true` if you want to update the URL without creating an entry in the browser's history.
         */ }, { key: "navigateToElement", value: function navigateToElement(
      selector) {var _this37 = this;var settings = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        ...
        var currentPage = currentModel instanceof ContentObjectModel ? currentModel : currentModel.findAncestor('contentObjects');
        var pageId = currentPage.get('_id');
        ...
        Adapt.once('contentObjectView:ready', _.debounce(function () {_newArrowCheck(this, _this37);
...
function (Adapt, AdaptCollection) {var
  ...
  AdaptSubsetCollection = /*#__PURE__*/function (_AdaptCollection2) {"use strict";_inherits(AdaptSubsetCollection, _AdaptCollection2);var _super14 = _createSuper(AdaptSubsetCollection);function AdaptSubsetCollection() {_classCallCheck(this, AdaptSubsetCollection);return _super14.apply(this, arguments);}_createClass(AdaptSubsetCollection, [{ key: "initialize", value: function initialize(
      ...
      {var _this38 = this;
        this.set(this.parent.filter(function (model) {_newArrowCheck(this, _this38);return model instanceof this.model;}.bind(this)));
...
function (Adapt) {var
  ...
  AdaptView = /*#__PURE__*/function (_Backbone$View) {"use strict";_inherits(AdaptView, _Backbone$View);var _super19 = _createSuper(AdaptView);function AdaptView() {_classCallCheck(this, AdaptView);return _super19.apply(this, arguments);}_createClass(AdaptView, [{ key: "attributes", value: function attributes()
      ...
      {var _this41 = this;
        var nthChild = 0;var _this$model$getChildr =
        this.model.getChildren(),models = _this$model$getChildr.models;
        this.childViews = {};
        models.forEach(function (model) {_newArrowCheck(this, _this41);
          if (!model.get('_isAvailable')) return;

          nthChild++;
          model.set('_nthChild', nthChild);

          var ChildView = this.constructor.childView || Adapt.getViewClass(model);
      ...
      isParentFirst) {var _this42 = this;
        var descendants = [];
        this.childViews && _.each(this.childViews, function (view) {_newArrowCheck(this, _this42);
      ...
      type) {var _this43 = this;
        ...
        if (descendantComponents.length === 0) {
          ...
          descendantComponents.forEach(function (model) {_newArrowCheck(this, _this43);return model.reset(type);}.bind(this));
        }
      ...
      {var _this44 = this;
        ...
        Adapt.wait.for(function (end) {var _this45 = this;_newArrowCheck(this, _this44);
...
function (Adapt, AdaptView) {var
  ...
  ContentObjectView = /*#__PURE__*/function (_AdaptView) {"use strict";_inherits(ContentObjectView, _AdaptView);var _super20 = _createSuper(ContentObjectView);function ContentObjectView() {_classCallCheck(this, ContentObjectView);return _super20.apply(this, arguments);}_createClass(ContentObjectView, [{ key: "attributes", value: function attributes()
      ...
      {var _this46 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this46);
          // don't call postRender after remove
          if (this._isRemoved) return;
        ...
        return this;
      } }, { key: "isReady", value: function () {var _isReady = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {var _this47 = this;var type, performIsReady;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:if (!(


                  !this.model.get('_isReady') || this._isTriggeredReady)) {_context11.next = 2;break;}return _context11.abrupt("return");case 2:
                  this._isTriggeredReady = true;

                  type = this.constructor.type;
                  performIsReady = /*#__PURE__*/function () {var _performIsReady = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {var _this48 = this;var styleOptions;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_newArrowCheck(this, _this47);
                              Adapt.trigger("".concat(type, "View:preReady contentObjectView:preReady view:preReady"), this);_context10.next = 4;return (
                                Adapt.wait.queue());case 4:
                              $('.js-loading').hide();
                              if (Adapt.get('_shouldContentObjectScrollTop') !== false) {
                                $(window).scrollTop(0);
                              }
                              Adapt.trigger("".concat(type, "View:ready contentObjectView:ready view:ready"), this);
                              $.inview.unlock("".concat(type, "View"));
                              styleOptions = { opacity: 1 };
                              if (this.disableAnimation) {
                                this.$el.css(styleOptions);
                                $.inview();
                                _.defer(function () {_newArrowCheck(this, _this48);
                                  Adapt.trigger("".concat(type, "View:postReady contentObjectView:postReady view:postReady"), this);
                                }.bind(this));
                              } else {
                                this.$el.velocity(styleOptions, {
                                  duration: 'fast',
                                  complete: function complete() {_newArrowCheck(this, _this48);
                                    $.inview();
                                    Adapt.trigger("".concat(type, "View:postReady contentObjectView:postReady view:postReady"), this);
                                  }.bind(this) });

                              }
                              $(window).scroll();case 11:case "end":return _context10.stop();}}}, _callee10, this);}));function performIsReady() {return _performIsReady.apply(this, arguments);}return performIsReady;}().bind(this);


                  _.defer(performIsReady);case 6:case "end":return _context11.stop();}}}, _callee11, this);}));function isReady() {return _isReady.apply(this, arguments);}return isReady;}() }, { key: "preRemove", value: function preRemove()
      ...
      {var _this49 = this;
        ...
        Adapt.wait.for(function (end) {var _this50 = this;_newArrowCheck(this, _this49);
          this.$el.off('onscreen.adaptView');
          this.findDescendantViews().reverse().forEach(function (view) {_newArrowCheck(this, _this50);
            view.remove();
          }.bind(this));
          this.childViews = [];
          _get(_getPrototypeOf(ContentObjectView.prototype), "remove", this).call(this);
          _.defer(function () {_newArrowCheck(this, _this50);
...
function (Adapt, ContentObjectView) {var
  ...
  PageView = /*#__PURE__*/function (_ContentObjectView) {"use strict";_inherits(PageView, _ContentObjectView);var _super21 = _createSuper(PageView);function PageView() {_classCallCheck(this, PageView);return _super21.apply(this, arguments);}_createClass(PageView, [{ key: "remove", value: function remove()
...
function (Adapt, AdaptView) {var
  ...
  ArticleView = /*#__PURE__*/function (_AdaptView2) {"use strict";_inherits(ArticleView, _AdaptView2);var _super22 = _createSuper(ArticleView);function ArticleView() {_classCallCheck(this, ArticleView);return _super22.apply(this, arguments);}_createClass(ArticleView, [{ key: "className", value: function className()
...
function (Adapt, AdaptView) {var
  ...
  BlockView = /*#__PURE__*/function (_AdaptView3) {"use strict";_inherits(BlockView, _AdaptView3);var _super23 = _createSuper(BlockView);function BlockView() {_classCallCheck(this, BlockView);return _super23.apply(this, arguments);}_createClass(BlockView, [{ key: "className", value: function className()
...
function (Adapt, Data, AdaptSubsetCollection, CourseModel, ContentObjectModel, MenuModel, PageModel, ArticleModel, BlockModel, ComponentModel, PageView, ArticleView, BlockView) {var
  ...
  MPABC = /*#__PURE__*/function (_Backbone$Controller3) {"use strict";_inherits(MPABC, _Backbone$Controller3);var _super24 = _createSuper(MPABC);function MPABC() {_classCallCheck(this, MPABC);return _super24.apply(this, arguments);}_createClass(MPABC, [{ key: "initialize", value: function initialize()
      ...
      {var _this51 = this;
        ...
        Object.defineProperty(Adapt, 'contentObjects', {
          get: function get() {_newArrowCheck(this, _this51);
            Adapt.log.deprecated('Adapt.contentObjects, please use Adapt.data instead');
            return contentObjects;
          }.bind(this),
          set: function set(value) {_newArrowCheck(this, _this51);return contentObjects = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'articles', {
          ...
          set: function set(value) {_newArrowCheck(this, _this51);return articles = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'blocks', {
          ...
          set: function set(value) {_newArrowCheck(this, _this51);return blocks = value;}.bind(this) });
        ...
        Object.defineProperty(Adapt, 'components', {
          ...
          set: function set(value) {_newArrowCheck(this, _this51);return components = value;}.bind(this) });
...
function (Adapt) {var
  ...
  Scrolling = /*#__PURE__*/function (_Backbone$Controller4) {"use strict";_inherits(Scrolling, _Backbone$Controller4);var _super25 = _createSuper(Scrolling);function Scrolling() {_classCallCheck(this, Scrolling);return _super25.apply(this, arguments);}_createClass(Scrolling, [{ key: "initialize", value: function initialize()
      ...
      {var _this52 = this;
        ...
        var $window = $(window);
        this.$app.on('scroll', function () {_newArrowCheck(this, _this52);
          $window.scroll();
        }.bind(this));
      } }, { key: "scrollTo", value: function scrollTo(

      selector) {var _this53 = this;var settings = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
function (Adapt) {var
  ...
  NavigationView = /*#__PURE__*/function (_Backbone$View2) {"use strict";_inherits(NavigationView, _Backbone$View2);var _super26 = _createSuper(NavigationView);function NavigationView() {_classCallCheck(this, NavigationView);return _super26.apply(this, arguments);}_createClass(NavigationView, [{ key: "className", value: function className()
      ...
      {var _this54 = this;
        ...
        _.defer(function () {_newArrowCheck(this, _this54);
...
define('core/js/models/itemModel', [], function () {var
  ...
  ItemModel = /*#__PURE__*/function (_Backbone$Model6) {"use strict";_inherits(ItemModel, _Backbone$Model6);var _super27 = _createSuper(ItemModel);function ItemModel() {_classCallCheck(this, ItemModel);return _super27.apply(this, arguments);}_createClass(ItemModel, [{ key: "defaults", value: function defaults()
...
function (ComponentModel, ItemModel) {var
  ...
  ItemsComponentModel = /*#__PURE__*/function (_ComponentModel) {"use strict";_inherits(ItemsComponentModel, _ComponentModel);var _super28 = _createSuper(ItemsComponentModel);function ItemsComponentModel() {_classCallCheck(this, ItemsComponentModel);return _super28.apply(this, arguments);}_createClass(ItemsComponentModel, [{ key: "toJSON", value: function toJSON()
      ...
      {var _this55 = this;
        ...
        items.forEach(function (item, index) {_newArrowCheck(this, _this55);return item._index = index;}.bind(this));
      ...
      type, force) {var _this56 = this;
        this.get('_children').each(function (item) {_newArrowCheck(this, _this56);return item.reset();}.bind(this));
      ...
      {var _this57 = this;
        this.get('_children').each(function (item) {_newArrowCheck(this, _this57);return item.toggleActive(false);}.bind(this));
...
function (Adapt, AdaptView) {var
  ...
  ComponentView = /*#__PURE__*/function (_AdaptView4) {"use strict";_inherits(ComponentView, _AdaptView4);var _super29 = _createSuper(ComponentView);function ComponentView() {_classCallCheck(this, ComponentView);return _super29.apply(this, arguments);}_createClass(ComponentView, [{ key: "attributes", value: function attributes()
...
function (Adapt, ComponentView) {
  ...
  var AssessmentResultsView = ComponentView.extend({
    ...
    preRender: function preRender() {var _this58 = this;
      ...
      this.listenTo(this.model, {
        ...
        'change:body': function changeBody() {_newArrowCheck(this, _this58);
...
function (Adapt, ComponentModel, BUTTON_STATE) {var
  ...
  QuestionModel = /*#__PURE__*/function (_ComponentModel2) {"use strict";_inherits(QuestionModel, _ComponentModel2);var _super30 = _createSuper(QuestionModel);function QuestionModel() {_classCallCheck(this, QuestionModel);return _super30.apply(this, arguments);}_createClass(QuestionModel, [{ key: "defaults",
    ...
    }, { key: "getResponseType", value: function getResponseType() {} }]);return QuestionModel;}(ComponentModel);
...
function (Adapt, ComponentView, ButtonsView, QuestionModel, BUTTON_STATE) {
  ...
  QuestionView = /*#__PURE__*/function (_ComponentView) {"use strict";_inherits(QuestionView, _ComponentView);var _super31 = _createSuper(QuestionView);function QuestionView() {_classCallCheck(this, QuestionView);return _super31.apply(this, arguments);}_createClass(QuestionView, [{ key: "className", value: function className()
      ...
      // Used to check if the question should reset on revisit
    }, { key: "checkIfResetOnRevisit", value: function checkIfResetOnRevisit() {var _this59 = this;
        ...
        if (isResetOnRevisit) {
          ...
          _.defer(function () {_newArrowCheck(this, _this59);
  ...
  ViewOnlyQuestionViewCompatibilityLayer = /*#__PURE__*/function (_QuestionView) {"use strict";_inherits(ViewOnlyQuestionViewCompatibilityLayer, _QuestionView);var _super32 = _createSuper(ViewOnlyQuestionViewCompatibilityLayer);function ViewOnlyQuestionViewCompatibilityLayer() {_classCallCheck(this, ViewOnlyQuestionViewCompatibilityLayer);return _super32.apply(this, arguments);}_createClass(ViewOnlyQuestionViewCompatibilityLayer, [{ key: "getInteractionObject",
...
'core/js/models/questionModel',
'core/js/models/itemsComponentModel'],
function (Adapt, QuestionModel, ItemsComponentModel) {var _this60 = this;var

  BlendedItemsComponentQuestionModel = /*#__PURE__*/function (_QuestionModel) {"use strict";_inherits(BlendedItemsComponentQuestionModel, _QuestionModel);var _super33 = _createSuper(BlendedItemsComponentQuestionModel);function BlendedItemsComponentQuestionModel() {_classCallCheck(this, BlendedItemsComponentQuestionModel);return _super33.apply(this, arguments);}_createClass(BlendedItemsComponentQuestionModel, [{ key: "init", value: function init()
  ...
  Object.getOwnPropertyNames(ItemsComponentModel.prototype).forEach(function (name) {_newArrowCheck(this, _this60);
  ...
  ItemsQuestionModel = /*#__PURE__*/function (_BlendedItemsComponen) {"use strict";_inherits(ItemsQuestionModel, _BlendedItemsComponen);var _super34 = _createSuper(ItemsQuestionModel);function ItemsQuestionModel() {_classCallCheck(this, ItemsQuestionModel);return _super34.apply(this, arguments);}_createClass(ItemsQuestionModel, [{ key: "init", value: function init()
      ...
      {var _this61 = this;
        ...
        itemModels.each(function (item) {_newArrowCheck(this, _this61);
      ...
      // This is important for returning or showing the users answer
      // This should preserve the state of the users answers
    }, { key: "storeUserAnswer", value: function storeUserAnswer() {var _this62 = this;
        var items = this.getChildren().slice(0);
        items.sort(function (a, b) {_newArrowCheck(this, _this62);return a.get('_index') - b.get('_index');}.bind(this));
        var userAnswer = items.map(function (itemModel) {_newArrowCheck(this, _this62);return itemModel.get('_isActive');}.bind(this));
      ...
      {var _this63 = this;
        ...
        this.getChildren().each(function (itemModel) {_newArrowCheck(this, _this63);
      ...
      {var _this64 = this;
        ...
        interactions.choices = this.getChildren().map(function (itemModel) {_newArrowCheck(this, _this64);
          return {
        ...
        var correctItems = this.getChildren().filter(function (itemModel) {_newArrowCheck(this, _this64);
          return itemModel.get('_shouldBeSelected');
        }.bind(this));

        interactions.correctResponsesPattern = [
        correctItems.map(function (itemModel) {_newArrowCheck(this, _this64);
      ...
      {var _this65 = this;
        var activeItems = this.getActiveItems();
        var activeIndexes = activeItems.map(function (itemModel) {_newArrowCheck(this, _this65);
          // indexes are 0-based, we need them to be 1-based for cmi.interactions
...
function (Adapt, QuestionBank) {
  ...
  var AssessmentModel = {
    ...
    setRestoreState: function setRestoreState(restoreState) {
      var id;
...
function (Adapt, PageLevelProgressItemView) {
  ...
  var PageLevelProgressView = Backbone.View.extend({
    ...
    scrollToPageElement: function scrollToPageElement(event) {
...
(function (_) {
  ...
  function Base64() {
    switch (arguments.length) {
      case 1:
        var firstArgumentType = _typeof(arguments[0]);
  ...
  DataType.getVariableType = function DataTypeGetVariableType(variable) {
    var variableNativeType = variable instanceof Array ? "array" : _typeof(variable);
...
define('extensions/adapt-pageTransition/js/adapt-pageTransition', [
'core/js/adapt'],
function (Adapt) {var

  PageTransition = /*#__PURE__*/function (_Backbone$Controller5) {"use strict";_inherits(PageTransition, _Backbone$Controller5);var _super35 = _createSuper(PageTransition);function PageTransition() {_classCallCheck(this, PageTransition);return _super35.apply(this, arguments);}_createClass(PageTransition, [{ key: "initialize", value: function initialize()
      ...
      {
        var config = Adapt.course.get('_pageTransition');
        if (!config || !config._isEnabled) return;
        this.setupOverrides();
        this.setupEventListeners();
      ...
      contentObjectView) {var _this66 = this;
        ...
        var previousIndex = models.findIndex(function (model) {_newArrowCheck(this, _this66);return model === previousModel;}.bind(this));
        var currentIndex = models.findIndex(function (model) {_newArrowCheck(this, _this66);return model === currentModel;}.bind(this));
      ...
      contentObjectView) {var _this67 = this;
        if (this.views.length < 2) return;
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this67);return view === contentObjectView;}.bind(this));
        if (index === -1) return;
      ...
      event) {var _this68 = this;
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this68);return view.$el[0] === event.srcElement;}.bind(this));
        if (index === -1) return;
        ...
        window.requestAnimationFrame(function () {_newArrowCheck(this, _this68);
      ...
      contentObjectView) {var _this69 = this;
        // Remove contentObject views from list
        var index = this.views.findIndex(function (view) {_newArrowCheck(this, _this69);return view === contentObjectView;}.bind(this));
        this.views.splice(index, 2);
        if (this.views.length) return;
      } }]);return PageTransition;}(Backbone.Controller);
...
function (AdaptView) {var
  ...
  MenuItemView = /*#__PURE__*/function (_AdaptView5) {"use strict";_inherits(MenuItemView, _AdaptView5);var _super36 = _createSuper(MenuItemView);function MenuItemView() {_classCallCheck(this, MenuItemView);return _super36.apply(this, arguments);}_createClass(MenuItemView, [{ key: "attributes", value: function attributes()
...
function (ContentObjectView, MenuItemView) {var
  ...
  MenuView = /*#__PURE__*/function (_ContentObjectView2) {"use strict";_inherits(MenuView, _ContentObjectView2);var _super37 = _createSuper(MenuView);function MenuView() {_classCallCheck(this, MenuView);return _super37.apply(this, arguments);}return MenuView;}(ContentObjectView);
