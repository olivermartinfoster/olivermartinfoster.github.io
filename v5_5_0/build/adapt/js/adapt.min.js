  ...
  Adapt.offlineStorage.initialize({
    ...
    get: function get(name) {
      ...
      switch (name.toLowerCase()) {
        ...
        case "completion":
          var courseState = this.getCustomState('c');
...
function (Adapt, ComponentView) {
  ...
  var TrickleButtonView = ComponentView.extend({
    ...
    calculateViewState: function calculateViewState() {
    ...
    onStepUnlocked: function onStepUnlocked(event) {return new Promise(function ($return, $error) {
        ...
        _.defer(this.beforeButtonClick.bind(this));return $return();}.bind(this));},


    beforeButtonClick: function beforeButtonClick() {
      this.updateDOM();
    },
    ...
    onButtonComplete: function onButtonComplete(model, value) {return new Promise(function ($return, $error) {
        if (!value) {
          return $return();
        }
        this.afterButtonClick();
        return Promise.resolve(Adapt.trickle.continue()).then(function ($await_53) {try {
            Adapt.trickle.scroll(this.model);return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));},


    afterButtonClick: function afterButtonClick() {
      this.updateDOM();
    },
...
function (Adapt, ComponentModel) {var
  ...
  TrickleButtonModel = /*#__PURE__*/function (_ComponentModel3) {"use strict";_inherits(TrickleButtonModel, _ComponentModel3);var _super46 = _createSuper(TrickleButtonModel);function TrickleButtonModel() {_classCallCheck(this, TrickleButtonModel);return _super46.apply(this, arguments);}_createClass(TrickleButtonModel, [{ key: "init", value: function init()
...
function (Adapt, ContentObjectModel) {
  ...
  var Trickle = Backbone.Controller.extend({
    ...
    addTrickleComponents: function addTrickleComponents() {var _this110 = this;
    ...
    setupTrickleDefaults: function setupTrickleDefaults(model) {
    ...
    setupLocking: function setupLocking() {var _this112 = this;
      var models = Adapt.course.getAllDescendantModels(true);
    ...
    fetchLockingModels: function fetchLockingModels(child) {var _this117 = this;
    ...
    continue: function _continue() {return new Promise(function ($return, $error) {
        this.setupLocking();
        return Promise.resolve(Adapt.parentView.addChildren()).then(function ($await_54) {try {
            return Promise.resolve(Adapt.parentView.whenReady()).then(function ($await_55) {try {return $return();} catch ($boundEx) {return $error($boundEx);}}, $error);} catch ($boundEx) {return $error($boundEx);}}, $error);}.bind(this));},


    scroll: function scroll(fromModel) {return new Promise(function ($return, $error) {var
        trickle,
        scrollTo,
        ...
        duration;trickle = Adapt.trickle.getModelConfig(fromModel);scrollTo = trickle._scrollTo;if (scrollTo === undefined) scrollTo = "@block +1";scrollToId = "";switch (scrollTo.substr(0, 1)) {case "@":relativeModel = fromModel.findRelativeModel(scrollTo, { filter: function filter(model) {return model.get("_isAvailable");} });if (relativeModel === undefined) return $return();scrollToId = relativeModel.get("_id");break;case ".": // NAVIGATE BY CLASS
            scrollToId = scrollTo.substr(1, scrollTo.length - 1);break;default:scrollToId = scrollTo;}if (scrollToId == "") return $return();return Promise.resolve(Adapt.parentView.renderTo(scrollToId)).then(function ($await_56) {try {$("." + scrollToId).focusOrNext();isAutoScrollOff = !trickle._autoScroll;if (isAutoScrollOff) {return $return(false);}duration = this.getModelConfig(fromModel)._scrollDuration || 500;Adapt.scrollTo("." + scrollToId, { duration: duration });return $return();} catch ($boundEx) {return $error($boundEx);}}.bind(this), $error);}.bind(this));} });
...
function (Adapt, MenuModel) {var
  ...
  InfiniteScroll = /*#__PURE__*/function (_Backbone$Controller8) {"use strict";_inherits(InfiniteScroll, _Backbone$Controller8);var _super47 = _createSuper(InfiniteScroll);function InfiniteScroll() {_classCallCheck(this, InfiniteScroll);return _super47.apply(this, arguments);}_createClass(InfiniteScroll, [{ key: "initialize", value: function initialize()
      ...
      event) {var _this119 = this;
        // Never infinite scroll menus
        if (this.isMenu()) {
          return;
        }

        var expectedNextModel = Adapt.parentView.model.getAllDescendantModels(true).find(function (model) {_newArrowCheck(this, _this119);
        ...
        if (hasNoChildren || !event.model.hasManagedChildren) {
          ...
          this.listenToOnce(event, 'closed', function () {_newArrowCheck(this, _this119);
